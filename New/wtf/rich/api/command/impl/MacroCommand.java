                    ...
                    if (arguments[0].equals("macro")) {
                         ...
                         if (arguments[1].equals("list")) {
                              ...
                              Main.instance.macroManager.getMacros().forEach((macro) -> {
                                   Main.msg(ChatFormatting.GREEN + "Macros list: " + ChatFormatting.WHITE + "Macros Name: " + ChatFormatting.RED + macro.getValue() + ChatFormatting.WHITE + ", Macro Bind: " + ChatFormatting.RED + Keyboard.getKeyName(macro.getKey()), true);
                              });
                         }
                    }
               } else {
