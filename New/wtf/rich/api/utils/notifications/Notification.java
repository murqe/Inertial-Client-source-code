...
import wtf.rich.api.utils.font.CFont;
import wtf.rich.api.utils.render.Shifting;
import wtf.rich.api.utils.render.StopWatch;
...
public final class Notification {
     ...
     public Notification(String title, String content, NotificationType type, CFont font) {
          ...
          this.translate = new Shifting((float)(sr.getScaledWidth() - this.getWidth()), (float)(sr.getScaledHeight() - 30));
     }
