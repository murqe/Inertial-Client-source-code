...
public class FontRenderer extends CFont {
     ...
     public static float drawCenteredStringWithShadow(net.minecraft.client.gui.FontRenderer fontRenderer, String text, float x, float y, int color) {
          return (float)fontRenderer.drawString(text, x - (float)(fontRenderer.getStringWidth(text) / 2), y, color);
     }

     public void drawCenteredStringWithOutline(FontRenderer fontRenderer, String text, float x, float y, int color) {
     ...
     public void drawStringWithOutline(String text, double x, double y, int color) {
          this.drawString(text, x - 0.5D, y, Color.BLACK.getRGB(), false);
          this.drawString(text, x + 0.5D, y, Color.BLACK.getRGB(), false);
          this.drawString(text, x, y - 0.5D, Color.BLACK.getRGB(), false);
          this.drawString(text, x, y + 0.5D, Color.BLACK.getRGB(), false);
