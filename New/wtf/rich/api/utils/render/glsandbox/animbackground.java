package wtf.rich.api.utils.render.glsandbox;
...
public class animbackground {
     ...
     public animbackground(String fragmentShaderLocation) throws IOException {
          int program = GL20.glCreateProgram();
          GL20.glAttachShader(program, this.createShader(animbackground.class.getResourceAsStream("/passthrough.vsh"), 35633));
