     ...
     public void drawTextBox() {
          if (this.getVisible()) {
               if (this.getEnableBackgroundDrawing()) {
                    DrawHelper.drawRect((double)this.xPosition, (double)this.yPosition, (double)(this.xPosition + this.width), (double)(this.yPosition + this.height), (new Color(30, 30, 30, 185)).getRGB());
                    DrawHelper.drawGradientRect((double)this.xPosition, (double)this.yPosition, (double)(this.xPosition + this.width), (double)(this.yPosition + this.height), (new Color(30, 30, 30, 190)).getRGB(), (new Color(30, 30, 30, 190)).getRGB());
               }
               ...
               if (!s.isEmpty()) {
                    ...
                    if (Main.instance.featureDirector.getFeatureByClass(NameProtect.class).isToggled() && s1.startsWith("/warp")) {
                         s1 = "/warp ";
                    }

                    if (Main.instance.featureDirector.getFeatureByClass(NameProtect.class).isToggled() && s1.startsWith("/l")) {
                         s1 = "/l ";
                    }
