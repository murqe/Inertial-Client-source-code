     ...
     public void drawTextBox() {
          if (this.func_73778_q()) {
               if (this.getEnableBackgroundDrawing()) {
                    DrawHelper.drawNewRect((double)this.xPos - 1.5D, (double)(this.yPos - 1), (double)(this.xPos + this.width) + 1.5D, (double)(this.yPos + this.height) - 1.5D, (new Color(0, 0, 0, 95)).getRGB());
               }
               ...
               if (var6) {
                    if (var10) {
                         Gui.drawRect((double)var11, (double)(var8 - 1), (double)(var11 + 1), (double)(var8 + 1 + Minecraft.getMinecraft().neverlose500_16.getFontHeight()), -3092272);
                    } else {
                         Minecraft.getMinecraft();
