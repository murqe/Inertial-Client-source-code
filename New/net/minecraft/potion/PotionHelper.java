...
public class PotionHelper {
     ...
     private static final Predicate IS_POTION_ITEM = new Predicate() {
          public boolean apply(ItemStack p_apply_1_) {
               Iterator var2 = PotionHelper.POTION_ITEMS.iterator();
     ...
     public static ItemStack doReaction(ItemStack reagent, ItemStack potionIn) {
          if (!potionIn.func_190926_b()) {
               ...
               int k;
               PotionHelper.MixPredicate mixpredicate1;
               for(k = POTION_ITEM_CONVERSIONS.size(); i < k; ++i) {
                    mixpredicate1 = (PotionHelper.MixPredicate)POTION_ITEM_CONVERSIONS.get(i);
                    if (mixpredicate1.input == item && mixpredicate1.reagent.apply(reagent)) {
                         return PotionUtils.addPotionToItemStack(new ItemStack((Item)mixpredicate1.output), potiontype);
                    }
               }
               ...
               for(k = POTION_TYPE_CONVERSIONS.size(); i < k; ++i) {
                    mixpredicate1 = (PotionHelper.MixPredicate)POTION_TYPE_CONVERSIONS.get(i);
     ...
     static class MixPredicate {
          ...
          public MixPredicate(Object p_i47570_1_, Ingredient p_i47570_2_, Object p_i47570_3_) {
