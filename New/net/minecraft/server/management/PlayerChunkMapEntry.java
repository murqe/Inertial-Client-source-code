...
public class PlayerChunkMapEntry {
     ...
     public void addPlayer(EntityPlayerMP player) {
          if (this.players.contains(player)) {
               LOGGER.debug("Failed to add player. {} already is in chunk {}, {}", player, this.pos.chunkXPos, this.pos.chunkZPos);
          } else {
     ...
     public void update() {
          if (this.sentToPlayers && this.chunk != null && this.changes != 0) {
               ...
               int j1;
               if (this.changes == 1) {
                    l = (this.changedBlocks[0] >> 12 & 15) + this.pos.chunkXPos * 16;
                    i1 = this.changedBlocks[0] & 255;
                    j1 = (this.changedBlocks[0] >> 8 & 15) + this.pos.chunkZPos * 16;
                    ...
                    for(l = 0; l < this.changes; ++l) {
                         i1 = (this.changedBlocks[l] >> 12 & 15) + this.pos.chunkXPos * 16;
