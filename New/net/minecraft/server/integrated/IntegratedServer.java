...
public class IntegratedServer extends MinecraftServer {
     ...
     public boolean startServer() throws IOException {
          ...
          if (Reflector.FMLCommonHandler_handleServerAboutToStart.exists()) {
               object1 = Reflector.call(Reflector.FMLCommonHandler_instance, new Object[0]);
               if (!Reflector.callBoolean(object1, Reflector.FMLCommonHandler_handleServerAboutToStart, new Object[]{this})) {
                    return false;
               }
          }
