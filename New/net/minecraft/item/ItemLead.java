...
public class ItemLead extends Item {
     ...
     public static boolean attachToFence(EntityPlayer player, World worldIn, BlockPos fence) {
          ...
          int j = fence.getY();
          int k = fence.getZ();
          Iterator var10 = worldIn.getEntitiesWithinAABB(EntityLiving.class, new AxisAlignedBB((double)i - 7.0D, (double)j - 7.0D, (double)k - 7.0D, (double)i + 7.0D, (double)j + 7.0D, (double)k + 7.0D)).iterator();
