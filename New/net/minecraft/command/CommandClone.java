                         ...
                         if (structureboundingbox.minY >= 0 && structureboundingbox.maxY < 256 && structureboundingbox1.minY >= 0 && structureboundingbox1.maxY < 256) {
                              ...
                              if (world.isAreaLoaded(structureboundingbox) && world.isAreaLoaded(structureboundingbox1)) {
                                   ...
                                   if (flag) {
                                        Iterator var28;
                                        BlockPos blockpos7;
                                        for(var28 = deque.iterator(); var28.hasNext(); world.setBlockState(blockpos7, Blocks.BARRIER.getDefaultState(), 2)) {
                                   ...
                                   List list5 = world.getPendingBlockUpdates(structureboundingbox, false);
                                   if (list5 != null) {
