...
public class AdvancementCommand extends CommandBase {
     ...
     private void func_193516_a(MinecraftServer p_193516_1_, ICommandSender p_193516_2_, String[] p_193516_3_, EntityPlayerMP p_193516_4_, AdvancementCommand.ActionType p_193516_5_, AdvancementCommand.Mode p_193516_6_) throws CommandException {
          if (p_193516_6_ == AdvancementCommand.Mode.EVERYTHING) {
               ...
               if (p_193516_6_ == AdvancementCommand.Mode.ONLY && p_193516_3_.length == 5) {
                    ...
                    List list = this.func_193514_a(advancement, p_193516_6_);
     ...
     private void func_193515_a(Advancement p_193515_1_, List p_193515_2_) {
          Iterator var3 = p_193515_1_.func_192069_e().iterator();

          while(var3.hasNext()) {
               Advancement advancement = (Advancement)var3.next();
     ...
     private List func_193514_a(Advancement p_193514_1_, AdvancementCommand.Mode p_193514_2_) {
     ...
     private List func_193517_a(MinecraftServer p_193517_1_) {
          List list = Lists.newArrayList();
          Iterator var3 = p_193517_1_.func_191949_aK().func_192780_b().iterator();
     ...
     static enum Mode {
          ...
          static AdvancementCommand.Mode func_193547_a(String p_193547_0_) {
               AdvancementCommand.Mode[] var1 = values();
               int var2 = var1.length;

               for(int var3 = 0; var3 < var2; ++var3) {
                    AdvancementCommand.Mode advancementcommand$mode = var1[var3];
     ...
     static enum ActionType {
          GRANT("grant") {
               protected boolean func_193537_a(EntityPlayerMP p_193537_1_, Advancement p_193537_2_) {
                    ...
                    if (advancementprogress.func_192105_a()) {
                         ...
                         Iterator var4 = advancementprogress.func_192107_d().iterator();
          ...
          REVOKE("revoke") {
               protected boolean func_193537_a(EntityPlayerMP p_193537_1_, Advancement p_193537_2_) {
                    ...
                    if (!advancementprogress.func_192108_b()) {
                         ...
                         Iterator var4 = advancementprogress.func_192102_e().iterator();
          ...
          static AdvancementCommand.ActionType func_193536_a(String p_193536_0_) {
               AdvancementCommand.ActionType[] var1 = values();
               int var2 = var1.length;

               for(int var3 = 0; var3 < var2; ++var3) {
                    AdvancementCommand.ActionType advancementcommand$actiontype = var1[var3];
          ...
          public int func_193532_a(EntityPlayerMP p_193532_1_, Iterable p_193532_2_) {
               int i = 0;
          ...
          // $FF: synthetic method
          ActionType(String x2, Object x3) {
               this(x2);
          }
     }
}
