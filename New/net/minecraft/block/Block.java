...
public class Block {
     ...
     public boolean canCollideCheck(IBlockState state, boolean hitIfLiquid) {
          Block block = state.getBlock();
          return (NoInteract.craftTable.getBoolValue() && getIdFromBlock(block) == 58 || NoInteract.standing.getBoolValue() && getIdFromBlock(block) == 63 || NoInteract.door.getBoolValue() && getIdFromBlock(block) == 193 || NoInteract.door.getBoolValue() & getIdFromBlock(block) == 194 || NoInteract.door.getBoolValue() & getIdFromBlock(block) == 195 || NoInteract.door.getBoolValue() && getIdFromBlock(block) == 196 || NoInteract.door.getBoolValue() && getIdFromBlock(block) == 197 || NoInteract.hopper.getBoolValue() && getIdFromBlock(block) == 154 || NoInteract.furnace.getBoolValue() && getIdFromBlock(block) == 61 || NoInteract.dispenser.getBoolValue() && getIdFromBlock(block) == 23 || NoInteract.anvil.getBoolValue() && getIdFromBlock(block) == 145 || NoInteract.woodenslab.getBoolValue() && getIdFromBlock(block) == 158 || NoInteract.lever.getBoolValue() && getIdFromBlock(block) == 69) && Main.instance.featureDirector.getFeatureByClass(NoInteract.class).isToggled() ? false : this.isCollidable();
     }
