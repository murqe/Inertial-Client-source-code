...
public interface ICriterionTrigger {
     ResourceLocation func_192163_a();

     void func_192165_a(PlayerAdvancements var1, ICriterionTrigger.Listener var2);

     void func_192164_b(PlayerAdvancements var1, ICriterionTrigger.Listener var2);

     void func_192167_a(PlayerAdvancements var1);

     ICriterionInstance func_192166_a(JsonObject var1, JsonDeserializationContext var2);

     public static class Listener {
          private final ICriterionInstance field_192160_a;
          private final Advancement field_192161_b;
          private final String field_192162_c;

          public Listener(ICriterionInstance p_i47405_1_, Advancement p_i47405_2_, String p_i47405_3_) {
               this.field_192160_a = p_i47405_1_;
               this.field_192161_b = p_i47405_2_;
               this.field_192162_c = p_i47405_3_;
          }

          public ICriterionInstance func_192158_a() {
