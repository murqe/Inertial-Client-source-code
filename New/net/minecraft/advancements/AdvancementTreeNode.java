...
public class AdvancementTreeNode {
     ...
     private final List field_192332_e = Lists.newArrayList();
     ...
     public AdvancementTreeNode(Advancement p_i47466_1_, @Nullable AdvancementTreeNode p_i47466_2_, @Nullable AdvancementTreeNode p_i47466_3_, int p_i47466_4_, int p_i47466_5_) {
          if (p_i47466_1_.func_192068_c() == null) {
               ...
               for(Iterator var7 = p_i47466_1_.func_192069_e().iterator(); var7.hasNext(); advancementtreenode = this.func_192322_a(advancement, advancementtreenode)) {
     ...
     private AdvancementTreeNode func_192322_a(Advancement p_192322_1_, @Nullable AdvancementTreeNode p_192322_2_) {
          ...
          if (p_192322_1_.func_192068_c() != null) {
               ...
               for(Iterator var3 = p_192322_1_.func_192069_e().iterator(); var3.hasNext(); p_192322_2_ = this.func_192322_a(advancement, p_192322_2_)) {
     ...
     private void func_192320_a() {
          if (this.field_192332_e.isEmpty()) {
               ...
               for(Iterator var2 = this.field_192332_e.iterator(); var2.hasNext(); advancementtreenode = advancementtreenode1.func_192324_a(advancementtreenode == null ? advancementtreenode1 : advancementtreenode)) {
                    advancementtreenode1 = (AdvancementTreeNode)var2.next();
     ...
     private float func_192319_a(float p_192319_1_, int p_192319_2_, float p_192319_3_) {
          ...
          for(Iterator var4 = this.field_192332_e.iterator(); var4.hasNext(); p_192319_3_ = advancementtreenode.func_192319_a(p_192319_1_ + this.field_192337_j, p_192319_2_ + 1, p_192319_3_)) {
               advancementtreenode = (AdvancementTreeNode)var4.next();
          }
     ...
     private void func_192318_a(float p_192318_1_) {
          ...
          while(var2.hasNext()) {
               AdvancementTreeNode advancementtreenode = (AdvancementTreeNode)var2.next();
     ...
     private void func_192327_e() {
          ...
          if (!this.field_192332_e.isEmpty()) {
               ...
               while(var1.hasNext()) {
                    AdvancementTreeNode advancementtreenode = (AdvancementTreeNode)var1.next();
