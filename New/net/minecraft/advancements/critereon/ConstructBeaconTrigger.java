...
public class ConstructBeaconTrigger implements ICriterionTrigger {
     private static final ResourceLocation field_192181_a = new ResourceLocation("construct_beacon");
     private final Map field_192182_b = Maps.newHashMap();
     ...
     static class Listeners {
          ...
          private final Set field_192357_b = Sets.newHashSet();
          ...
          public void func_192355_a(ICriterionTrigger.Listener p_192355_1_) {
               this.field_192357_b.add(p_192355_1_);
          }

          public void func_192353_b(ICriterionTrigger.Listener p_192353_1_) {
          ...
          public void func_192352_a(TileEntityBeacon p_192352_1_) {
               ...
               while(var3.hasNext()) {
                    ...
                    if (((ConstructBeaconTrigger.Instance)listener1.func_192158_a()).func_192252_a(p_192352_1_)) {
                         if (list == null) {
