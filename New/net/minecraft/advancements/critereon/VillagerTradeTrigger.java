...
public class VillagerTradeTrigger implements ICriterionTrigger {
     private static final ResourceLocation field_192237_a = new ResourceLocation("villager_trade");
     private final Map field_192238_b = Maps.newHashMap();
     ...
     static class Listeners {
          ...
          private final Set field_192542_b = Sets.newHashSet();
          ...
          public void func_192540_a(ICriterionTrigger.Listener p_192540_1_) {
               this.field_192542_b.add(p_192540_1_);
          }

          public void func_192538_b(ICriterionTrigger.Listener p_192538_1_) {
          ...
          public void func_192537_a(EntityPlayerMP p_192537_1_, EntityVillager p_192537_2_, ItemStack p_192537_3_) {
               ...
               while(var5.hasNext()) {
                    ...
                    if (((VillagerTradeTrigger.Instance)listener1.func_192158_a()).func_192285_a(p_192537_1_, p_192537_2_, p_192537_3_)) {
                         if (list == null) {
     ...
     public static class Instance extends AbstractCriterionInstance {
          ...
          public boolean func_192285_a(EntityPlayerMP p_192285_1_, EntityVillager p_192285_2_, ItemStack p_192285_3_) {
               return !this.field_192286_a.func_192482_a(p_192285_1_, p_192285_2_) ? false : this.field_192287_b.func_192493_a(p_192285_3_);
          }
     }
}
