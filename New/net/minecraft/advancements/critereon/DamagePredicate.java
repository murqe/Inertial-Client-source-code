...
public class DamagePredicate {
     ...
     public boolean func_192365_a(EntityPlayerMP p_192365_1_, DamageSource p_192365_2_, float p_192365_3_, float p_192365_4_, boolean p_192365_5_) {
          if (this == field_192366_a) {
               ...
               return false;
          } else if (!this.field_192369_d.func_192482_a(p_192365_1_, p_192365_2_.getEntity())) {
               return false;
          } else {
               return this.field_192370_e != null && this.field_192370_e != p_192365_5_ ? false : this.field_192371_f.func_193418_a(p_192365_1_, p_192365_2_);
          }
     }
