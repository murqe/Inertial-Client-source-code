...
public class EnchantmentPredicate {
     ...
     public boolean func_192463_a(Map p_192463_1_) {
          if (this.field_192467_b != null) {
               if (!p_192463_1_.containsKey(this.field_192467_b)) {
                    return false;
               }

               int i = (Integer)p_192463_1_.get(this.field_192467_b);
               ...
               } while(!this.field_192468_c.func_192514_a((float)integer));
     ...
     public static EnchantmentPredicate func_192464_a(@Nullable JsonElement p_192464_0_) {
          if (p_192464_0_ != null && !p_192464_0_.isJsonNull()) {
               ...
               if (jsonobject.has("enchantment")) {
                    ...
                    enchantment = (Enchantment)Enchantment.REGISTRY.getObject(resourcelocation);
                    if (enchantment == null) {
