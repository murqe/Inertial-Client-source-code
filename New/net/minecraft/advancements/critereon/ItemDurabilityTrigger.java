...
public class ItemDurabilityTrigger implements ICriterionTrigger {
     private static final ResourceLocation field_193159_a = new ResourceLocation("item_durability_changed");
     private final Map field_193160_b = Maps.newHashMap();
     ...
     static class Listeners {
          ...
          private final Set field_193443_b = Sets.newHashSet();
          ...
          public void func_193440_a(ICriterionTrigger.Listener p_193440_1_) {
               this.field_193443_b.add(p_193440_1_);
          }

          public void func_193438_b(ICriterionTrigger.Listener p_193438_1_) {
          ...
          public void func_193441_a(ItemStack p_193441_1_, int p_193441_2_) {
               ...
               while(var4.hasNext()) {
                    ...
                    if (((ItemDurabilityTrigger.Instance)listener1.func_192158_a()).func_193197_a(p_193441_1_, p_193441_2_)) {
                         if (list == null) {
     ...
     public static class Instance extends AbstractCriterionInstance {
          ...
          public boolean func_193197_a(ItemStack p_193197_1_, int p_193197_2_) {
               if (!this.field_193198_a.func_192493_a(p_193197_1_)) {
                    ...
                    return !this.field_193199_b.func_192514_a((float)(p_193197_1_.getMaxDamage() - p_193197_2_)) ? false : this.field_193200_c.func_192514_a((float)(p_193197_1_.getItemDamage() - p_193197_2_));
               }
          }
     }
}
