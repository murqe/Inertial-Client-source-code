...
public class PositionTrigger implements ICriterionTrigger {
     private final ResourceLocation field_192217_a;
     private final Map field_192218_b = Maps.newHashMap();
     ...
     static class Listeners {
          ...
          private final Set field_192512_b = Sets.newHashSet();
          ...
          public void func_192510_a(ICriterionTrigger.Listener p_192510_1_) {
               this.field_192512_b.add(p_192510_1_);
          }

          public void func_192507_b(ICriterionTrigger.Listener p_192507_1_) {
          ...
          public void func_193462_a(WorldServer p_193462_1_, double p_193462_2_, double p_193462_4_, double p_193462_6_) {
               ...
               while(var9.hasNext()) {
                    listener1 = (ICriterionTrigger.Listener)var9.next();
                    if (((PositionTrigger.Instance)listener1.func_192158_a()).func_193204_a(p_193462_1_, p_193462_2_, p_193462_4_, p_193462_6_)) {
                         if (list == null) {
