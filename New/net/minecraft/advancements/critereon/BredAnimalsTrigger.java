...
public class BredAnimalsTrigger implements ICriterionTrigger {
     private static final ResourceLocation field_192171_a = new ResourceLocation("bred_animals");
     private final Map field_192172_b = Maps.newHashMap();
     ...
     static class Listeners {
          ...
          private final Set field_192345_b = Sets.newHashSet();
          ...
          public void func_192343_a(ICriterionTrigger.Listener p_192343_1_) {
               this.field_192345_b.add(p_192343_1_);
          }

          public void func_192340_b(ICriterionTrigger.Listener p_192340_1_) {
          ...
          public void func_192342_a(EntityPlayerMP p_192342_1_, EntityAnimal p_192342_2_, EntityAnimal p_192342_3_, EntityAgeable p_192342_4_) {
               ...
               while(var6.hasNext()) {
                    ...
                    if (((BredAnimalsTrigger.Instance)listener1.func_192158_a()).func_192246_a(p_192342_1_, p_192342_2_, p_192342_3_, p_192342_4_)) {
                         if (list == null) {
