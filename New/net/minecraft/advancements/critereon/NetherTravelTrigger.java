...
public class NetherTravelTrigger implements ICriterionTrigger {
     private static final ResourceLocation field_193169_a = new ResourceLocation("nether_travel");
     private final Map field_193170_b = Maps.newHashMap();
     ...
     static class Listeners {
          ...
          private final Set field_193486_b = Sets.newHashSet();
          ...
          public void func_193484_a(ICriterionTrigger.Listener p_193484_1_) {
               this.field_193486_b.add(p_193484_1_);
          }

          public void func_193481_b(ICriterionTrigger.Listener p_193481_1_) {
          ...
          public void func_193483_a(WorldServer p_193483_1_, Vec3d p_193483_2_, double p_193483_3_, double p_193483_5_, double p_193483_7_) {
               ...
               while(var10.hasNext()) {
                    listener1 = (ICriterionTrigger.Listener)var10.next();
                    if (((NetherTravelTrigger.Instance)listener1.func_192158_a()).func_193206_a(p_193483_1_, p_193483_2_, p_193483_3_, p_193483_5_, p_193483_7_)) {
                         if (list == null) {
     ...
     public static class Instance extends AbstractCriterionInstance {
          ...
          public boolean func_193206_a(WorldServer p_193206_1_, Vec3d p_193206_2_, double p_193206_3_, double p_193206_5_, double p_193206_7_) {
               if (!this.field_193207_a.func_193452_a(p_193206_1_, p_193206_2_.xCoord, p_193206_2_.yCoord, p_193206_2_.zCoord)) {
                    ...
                    return !this.field_193208_b.func_193452_a(p_193206_1_, p_193206_3_, p_193206_5_, p_193206_7_) ? false : this.field_193209_c.func_193422_a(p_193206_2_.xCoord, p_193206_2_.yCoord, p_193206_2_.zCoord, p_193206_3_, p_193206_5_, p_193206_7_);
               }
          }
     }
}
