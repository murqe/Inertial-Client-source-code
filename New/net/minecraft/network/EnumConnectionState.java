...
public enum EnumConnectionState {
     ...
     // $FF: synthetic method
     EnumConnectionState(int x2, Object x3) {
          this(x2);
     }
     ...
     static {
          ...
          for(int var2 = 0; var2 < var1; ++var2) {
               EnumConnectionState enumconnectionstate = var0[var2];
               ...
               while(var5.hasNext()) {
                    EnumPacketDirection enumpacketdirection = (EnumPacketDirection)var5.next();
