...
public class GameSettings {
     ...
     public void loadOptions() {
          try {
               ...
               List list = IOUtils.readLines(new FileInputStream(this.optionsFile), StandardCharsets.UTF_8);
               ...
               while(var3.hasNext()) {
                    ...
                    try {
                         Iterator iterator = COLON_SPLITTER.omitEmptyStrings().limit(2).split(s1).iterator();
               ...
               var3 = nbttagcompound.getKeySet().iterator();
               ...
               while(var3.hasNext()) {
                    ...
                    try {
                              ...
                              if (s1.equals("key_" + keybinding.getKeyDescription())) {
                                   if (Reflector.KeyModifier_valueFromString.exists()) {
                                        if (s2.indexOf(58) != -1) {
                                             ...
                                             Reflector.call(keybinding, Reflector.ForgeKeyBinding_setKeyModifierAndCode, new Object[]{object, Integer.parseInt(astring[0])});
                                        } else {
                                             Object object1 = Reflector.getFieldValue(Reflector.KeyModifier_NONE);
                                             Reflector.call(keybinding, Reflector.ForgeKeyBinding_setKeyModifierAndCode, new Object[]{object1, Integer.parseInt(s2)});
                                        }
                                   } else {
                         ...
                         for(var8 = 0; var8 < var7; ++var8) {
                              SoundCategory soundcategory = var16[var8];
                              if (s1.equals("soundCategory_" + soundcategory.getName())) {
                                   this.soundLevels.put(soundcategory, this.parseFloat(s2));
                              }
                         }

                         EnumPlayerModelParts[] var17 = EnumPlayerModelParts.values();
                         var7 = var17.length;

                         for(var8 = 0; var8 < var7; ++var8) {
                              EnumPlayerModelParts enumplayermodelparts = var17[var8];
     ...
     public void saveOptions() {
          ...
          try {
               ...
               SoundCategory[] var15 = SoundCategory.values();
               var3 = var15.length;

               for(var4 = 0; var4 < var3; ++var4) {
                    SoundCategory soundcategory = var15[var4];
                    printwriter.println("soundCategory_" + soundcategory.getName() + ":" + this.getSoundLevel(soundcategory));
               }

               EnumPlayerModelParts[] var16 = EnumPlayerModelParts.values();
               var3 = var16.length;

               for(var4 = 0; var4 < var3; ++var4) {
                    EnumPlayerModelParts enumplayermodelparts = var16[var4];
     ...
     private void setOptionFloatValueOF(GameSettings.Options p_setOptionFloatValueOF_1_, float p_setOptionFloatValueOF_2_) {
          ...
          if (p_setOptionFloatValueOF_1_ == GameSettings.Options.MIPMAP_TYPE) {
               i1 = (int)p_setOptionFloatValueOF_2_;
               this.ofMipmapType = Config.limit(i1, 0, 3);
               this.mc.refreshResources();
          }
     ...
     private float getOptionFloatValueOF(GameSettings.Options p_getOptionFloatValueOF_1_) {
          if (p_getOptionFloatValueOF_1_ == GameSettings.Options.CLOUD_HEIGHT) {
               ...
               if (p_getOptionFloatValueOF_1_ == GameSettings.Options.FULLSCREEN_MODE) {
     ...
     private void setForgeKeybindProperties() {
          if (Reflector.KeyConflictContext_IN_GAME.exists() && Reflector.ForgeKeyBinding_setKeyConflictContext.exists()) {
               ...
               Reflector.call(this.keyBindForward, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindLeft, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindBack, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindRight, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindJump, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindSneak, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindSprint, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindAttack, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindChat, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindPlayerList, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindCommand, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindTogglePerspective, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindSmoothCamera, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
               Reflector.call(this.keyBindSwapHands, Reflector.ForgeKeyBinding_setKeyConflictContext, new Object[]{object});
          }
     ...
     public static enum Options {
          ...
          public static GameSettings.Options getEnumOptions(int ordinal) {
               ...
               for(int var3 = 0; var3 < var2; ++var3) {
                    GameSettings.Options gamesettings$options = var1[var3];
