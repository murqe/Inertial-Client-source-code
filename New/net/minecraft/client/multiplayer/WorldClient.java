...
public class WorldClient extends World {
     ...
     private static WorldProvider makeWorldProvider(int p_makeWorldProvider_0_) {
          return Reflector.DimensionManager_createProviderFor.exists() ? (WorldProvider)Reflector.call(Reflector.DimensionManager_createProviderFor, new Object[]{p_makeWorldProvider_0_}) : DimensionType.getById(p_makeWorldProvider_0_).createDimension();
     }
