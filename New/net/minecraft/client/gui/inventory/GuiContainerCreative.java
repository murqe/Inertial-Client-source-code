...
public class GuiContainerCreative extends InventoryEffectRenderer {
     ...
     protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
          ...
          if (creativetabs.drawInForegroundOfTab()) {
               ...
               this.fontRendererObj.drawString(I18n.format(creativetabs.getTranslatedTabLabel()), 8.0F, 6.0F, 4210752);
          }
     ...
     protected void renderToolTip(ItemStack stack, int x, int y) {
          if (selectedTabIndex == CreativeTabs.SEARCH.getTabIndex()) {
               List list = stack.getTooltip(this.mc.player, this.mc.gameSettings.advancedItemTooltips ? ITooltipFlag.TooltipFlags.ADVANCED : ITooltipFlag.TooltipFlags.NORMAL);
