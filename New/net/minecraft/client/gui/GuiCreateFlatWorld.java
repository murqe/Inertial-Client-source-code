     ...
     class Details extends GuiSlot {
          ...
          private void drawItem(int x, int z, ItemStack itemToDraw) {
               ...
               if (!itemToDraw.func_190926_b()) {
                    ...
                    GuiCreateFlatWorld.this.itemRender.renderItemIntoGUI(itemToDraw, (float)(x + 2), (float)(z + 2));
          ...
          protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
               ...
               GuiCreateFlatWorld.this.fontRendererObj.drawString(s1, (float)(p_192637_2_ + 2 + 213 - GuiCreateFlatWorld.this.fontRendererObj.getStringWidth(s1)), (float)(p_192637_3_ + 3), 16777215);
          }
