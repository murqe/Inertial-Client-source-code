...
public class RecipeList {
     private List field_192713_b = Lists.newArrayList();
     ...
     public List func_192711_b() {
          return this.field_192713_b;
     }

     public List func_194208_a(boolean p_194208_1_) {
     ...
     public List func_194207_b(boolean p_194207_1_) {
          List list = Lists.newArrayList();
