...
import wtf.rich.api.changelogs.ChangeLog;
...
import wtf.rich.client.ui.alt.GuiAlt;
...
public class GuiMainMenu extends GuiScreen {
     ...
     private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
          ...
          if (Reflector.GuiModList_Constructor.exists()) {
               ...
               this.realmsButton = this.addButton(new GuiButton(14, this.width / 2 - 45, p_73969_1_ + p_73969_2_ * 2 + 7, 100, 17, I18n.format("Alt Manager")));
          }
     ...
     public void drawScreen(int mouseX, int mouseY, float partialTicks) {
          ...
          if (MainMenu.mainMenu.currentMode.equals("Sky")) {
               this.backgroundShaders.useShader(sr.getScaledWidth(), sr.getScaledHeight(), (float)mouseX, (float)mouseY, (float)(System.currentTimeMillis() - this.initTime) / 1000.0F);
          }

          if (MainMenu.mainMenu.currentMode.equals("Ukraine")) {
               this.backgroundShaderd.useShader(sr.getScaledWidth(), sr.getScaledHeight(), (float)mouseX, (float)mouseY, (float)(System.currentTimeMillis() - this.initTime) / 1000.0F);
          }

          if (MainMenu.mainMenu.currentMode.equals("Cocks")) {
               this.backgroundShaderh.useShader(sr.getScaledWidth(), sr.getScaledHeight(), (float)mouseX, (float)mouseY, (float)(System.currentTimeMillis() - this.initTime) / 1000.0F);
          }

          if (MainMenu.mainMenu.currentMode.equals("Svaston")) {
               this.backgroundShaderj.useShader(sr.getScaledWidth() + 1000, sr.getScaledHeight() + 400, (float)mouseX, (float)mouseY, (float)(System.currentTimeMillis() - this.initTime) / 1000.0F);
          }

          if (MainMenu.mainMenu.currentMode.equals("SkyDrag")) {
               this.backgroundShaderk.useShader(sr.getScaledWidth() + 1000, sr.getScaledHeight() + 400, (float)mouseX, (float)mouseY, (float)(System.currentTimeMillis() - this.initTime) / 1000.0F);
          }

          if (MainMenu.mainMenu.currentMode.equals("Rainbow")) {
               this.backgroundShaderl.useShader(sr.getScaledWidth() + 1000, sr.getScaledHeight() + 400, (float)mouseX, (float)mouseY, (float)(System.currentTimeMillis() - this.initTime) / 1000.0F);
          }
          ...
          engine.render();
          this.mc.neverlose500_40.drawCenteredString("WELCOME TO INERTIAL FREE", (float)(sr.getScaledWidth() / 2 + 5), (float)(sr.getScaledHeight() / 4), -1);
          DrawHelper.drawRectWithGlow(4.0D, 5.0D, 145.0D, 250.0D, 4.0D, 5.0D, new Color(0, 0, 0, 36));
          super.drawScreen(mouseX, mouseY, partialTicks);
          int y = 10;
          int x = 3;
          Iterator var8 = Main.instance.changeManager.getChangeLogs().iterator();

          while(var8.hasNext()) {
               ChangeLog log = (ChangeLog)var8.next();
               GlStateManager.pushMatrix();
               if (log != null) {
                    DrawHelper.scissorRect(0.0F, 2.0F, (float)(this.width / 2 - 20), (double)(this.height - 10));
                    this.mc.sfui16.drawStringWithShadow(log.getLogName(), (double)x, (double)((float)y - 0.1F), -1);
               }
