...
public class GuiAdvancementTab extends Gui {
     ...
     private final Map field_191810_m = Maps.newLinkedHashMap();
     ...
     public void func_191799_a() {
          ...
          drawRect(0.0D, 0.0D, 234.0D, 113.0D, -16777216);
          ...
          for(int k = -1; k <= 15; ++k) {
               for(int l = -1; l <= 8; ++l) {
                    drawModalRectWithCustomSizedTexture((float)(i + 16 * k), (float)(j + 16 * l), 0.0F, 0.0F, 16.0F, 16.0F, 16.0F, 16.0F);
               }
          }
     ...
     public void func_192991_a(int p_192991_1_, int p_192991_2_, int p_192991_3_, int p_192991_4_) {
          ...
          drawRect(0.0D, 0.0D, 234.0D, 113.0D, MathHelper.floor(this.field_191815_r * 255.0F) << 24);
          boolean flag = false;
          if (p_192991_1_ > 0 && p_192991_1_ < 234 && p_192991_2_ > 0 && p_192991_2_ < 113) {
               Iterator var6 = this.field_191810_m.values().iterator();

               while(var6.hasNext()) {
                    GuiAdvancement guiadvancement = (GuiAdvancement)var6.next();
     ...
     private void func_193937_a(GuiAdvancement p_193937_1_, Advancement p_193937_2_) {
          ...
          while(var7.hasNext()) {
               GuiAdvancement guiadvancement = (GuiAdvancement)var7.next();
