...
public class GuiScreenAdvancements extends GuiScreen implements ClientAdvancementManager.IListener {
     ...
     private final Map field_191947_i = Maps.newLinkedHashMap();
     ...
     protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
          if (mouseButton == 0) {
               ...
               Iterator var6 = this.field_191947_i.values().iterator();

               while(var6.hasNext()) {
                    GuiAdvancementTab guiadvancementtab = (GuiAdvancementTab)var6.next();
     ...
     private void func_191936_c(int p_191936_1_, int p_191936_2_, int p_191936_3_, int p_191936_4_) {
          ...
          if (guiadvancementtab == null) {
               drawRect((double)(p_191936_3_ + 9), (double)(p_191936_4_ + 18), (double)(p_191936_3_ + 9 + 234), (double)(p_191936_4_ + 18 + 113), -16777216);
               String s = I18n.format("advancements.empty");
               int i = this.fontRendererObj.getStringWidth(s);
               this.fontRendererObj.drawString(s, (float)(p_191936_3_ + 9 + 117 - i / 2), (float)(p_191936_4_ + 18 + 56 - this.fontRendererObj.FONT_HEIGHT / 2), -1);
               this.fontRendererObj.drawString(":(", (float)(p_191936_3_ + 9 + 117 - this.fontRendererObj.getStringWidth(":(") / 2), (float)(p_191936_4_ + 18 + 113 - this.fontRendererObj.FONT_HEIGHT), -1);
          } else {
     ...
     public void func_191934_b(int p_191934_1_, int p_191934_2_) {
          ...
          if (this.field_191947_i.size() > 1) {
               ...
               GuiAdvancementTab guiadvancementtab1;
               while(var3.hasNext()) {
                    guiadvancementtab1 = (GuiAdvancementTab)var3.next();
                    guiadvancementtab1.func_191798_a(p_191934_1_, p_191934_2_, guiadvancementtab1 == this.field_191940_s);
               }
          ...
          this.fontRendererObj.drawString(I18n.format("gui.advancements"), (float)(p_191934_1_ + 8), (float)(p_191934_2_ + 6), 4210752);
     }
     ...
     private void func_191937_d(int p_191937_1_, int p_191937_2_, int p_191937_3_, int p_191937_4_) {
          ...
          if (this.field_191947_i.size() > 1) {
               ...
               while(var5.hasNext()) {
                    GuiAdvancementTab guiadvancementtab = (GuiAdvancementTab)var5.next();
