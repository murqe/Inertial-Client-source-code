...
public class RecipeToast implements IToast {
     private final List field_193666_c = Lists.newArrayList();
     ...
     public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
          ...
          if (this.field_193666_c.isEmpty()) {
               ...
               Minecraft.fontRendererObj.drawString(I18n.format("recipe.toast.title"), 30.0F, 7.0F, -11534256);
               p_193653_1_.func_192989_b();
               Minecraft.fontRendererObj.drawString(I18n.format("recipe.toast.description"), 30.0F, 18.0F, -16777216);
               RenderHelper.enableGUIStandardItemLighting();
               p_193653_1_.func_192989_b().getRenderItem().renderItemAndEffectIntoGUI((EntityLivingBase)null, (ItemStack)this.field_193666_c.get((int)(p_193653_2_ / (5000L / (long)this.field_193666_c.size()) % (long)this.field_193666_c.size())), 8, 8);
