...
public class GuiFlatPresets extends GuiScreen {
     ...
     private static void registerPreset(String name, Item icon, Biome biome, List features, FlatLayerInfo... layers) {
          registerPreset(name, icon, 0, biome, features, layers);
     }

     private static void registerPreset(String name, Item icon, int iconMetadata, Biome biome, List features, FlatLayerInfo... layers) {
     ...
     class ListSlot extends GuiSlot {
          ...
          private void renderIcon(int p_178054_1_, int p_178054_2_, Item icon, int iconMetadata) {
               ...
               GuiFlatPresets.this.itemRender.renderItemIntoGUI(new ItemStack(icon, 1, icon.getHasSubtypes() ? iconMetadata : 0), (float)(p_178054_1_ + 2), (float)(p_178054_2_ + 2));
