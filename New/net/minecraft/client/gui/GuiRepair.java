          ...
          if (this.anvil.maximumCost > 0) {
               ...
               if (flag) {
                    ...
                    if (this.fontRendererObj.getUnicodeFlag()) {
                         ...
                         this.fontRendererObj.drawString(s, (float)k, 68.0F, j);
                         this.fontRendererObj.drawString(s, (float)(k + 1), 67.0F, j);
                         this.fontRendererObj.drawString(s, (float)(k + 1), 68.0F, j);
                    }

                    this.fontRendererObj.drawString(s, (float)k, 67.0F, i);
               }
          }
