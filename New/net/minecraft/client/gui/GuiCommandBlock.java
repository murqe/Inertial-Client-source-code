...
public class GuiCommandBlock extends GuiScreen implements ITabCompleter {
     ...
     public void drawScreen(int mouseX, int mouseY, float partialTicks) {
          ...
          int var10003 = this.width / 2 - 140;
          int j = j + 1;
          this.drawString(var10001, var10002, var10003, i + j * this.fontRendererObj.FONT_HEIGHT, 10526880);
          ...
          if (!this.previousOutputTextField.getText().isEmpty()) {
               ...
               this.drawString(this.fontRendererObj, I18n.format("advMode.previousOutput"), this.width / 2 - 150, i + 4, 10526880);
