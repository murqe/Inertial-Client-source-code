...
public class GuiTextField extends Gui {
     ...
     public void drawTextBoxalt() {
          if (this.getVisible() && this.getEnableBackgroundDrawing()) {
               DrawHelper.drawNewRect((double)this.xPosition - 1.5D, (double)this.yPosition - 1.2D, (double)(this.xPosition + this.width) + 1.5D, (double)(this.yPosition + this.height) - 1.5D, (new Color(0, 0, 0, 95)).getRGB());
          }
          ...
          if (flag1) {
               if (flag2) {
                    ...
                    this.fontRendererInstance.drawStringWithShadow("_", (float)k1, (float)i1 - 1.0F, i);
               }
          }
     ...
     public void drawTextBox() {
          if (this.getVisible() && this.getEnableBackgroundDrawing()) {
               DrawHelper.drawNewRect((double)this.xPosition - 1.5D, (double)this.yPosition - 1.5D, (double)(this.xPosition + this.width) + 1.5D, (double)(this.yPosition + this.height) - 2.5D, (new Color(255, 255, 255, 95)).getRGB());
          }
     ...
     public void drawTextBox1() {
          if (this.getVisible()) {
               ...
               String s = Minecraft.fontRendererObj.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
               boolean flag = j >= 0 && j <= s.length();
               boolean flag1 = this.isFocused && this.cursorCounter / 6 % 2 == 0 && flag;
               int l = this.enableBackgroundDrawing ? this.xPosition + 4 : this.xPosition;
               int i1 = this.enableBackgroundDrawing ? this.yPosition + (this.height - 8) / 2 : this.yPosition;
               ...
               if (s.isEmpty()) {
                    Minecraft.getMinecraft().neverlose500_16.drawStringWithShadow(ChatFormatting.RED + "[RC] " + ChatFormatting.WHITE + "Send message...", (double)((float)l) - 0.5D, (double)this.xd + 11.5D, -1);
               }
               ...
               if (!s.isEmpty() && flag && j < s.length()) {
                    int var10000 = (int)Minecraft.getMinecraft().sfui16.drawStringWithShadow(s.substring(j), (double)((float)j1), (double)((float)i1), i);
               }

               if (flag1) {
                    if (flag2) {
                         Gui.drawRect((double)k1, (double)(i1 - 1), (double)(k1 + 1), (double)(i1 + 1 + Minecraft.getMinecraft().sfui16.getFontHeight()), -3092272);
                    } else if (s.isEmpty()) {
                         Minecraft.getMinecraft().neverlose500_15.drawStringWithShadow("", (double)((float)k1 + 1.0F), (double)((float)i1 + 2.0F), i);
                    } else {
                         Minecraft.getMinecraft().neverlose500_15.drawStringWithShadow("_", (double)((float)k1 + 1.0F), (double)((float)i1 + 2.0F), i);
                    }
               }

               if (k != j) {
                    int l1 = l + Minecraft.getMinecraft().sfui16.getStringWidth(s.substring(0, k));
                    this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + Minecraft.getMinecraft().sfui16.getFontHeight());
               }
          }
