...
public class RenderItem implements IResourceManagerReloadListener {
     ...
     private void renderEffect(IBakedModel p_191966_1_) {
          if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
               if (Main.instance.featureDirector.getFeatureByClass(NoRender.class).isToggled() && NoRender.glintEffect.getBoolValue()) {
                    return;
               }
               ...
               if (!Config.isShaders() || !Shaders.isShadowPass) {
                    ...
                    if (Main.instance.featureDirector.getFeatureByClass(EnchantmentColor.class).isToggled()) {
                         if (EnchantmentColor.colorMode.currentMode.equals("Rainbow")) {
                              this.func_191965_a(p_191966_1_, DrawHelper.rainbow((int)f, 1.0F, 1.0F).getRGB());
                         } else if (EnchantmentColor.colorMode.currentMode.equals("Custom")) {
                              this.func_191965_a(p_191966_1_, (new Color(EnchantmentColor.customColor.getColorValue())).getRGB());
                         } else if (EnchantmentColor.colorMode.currentMode.equals("Client")) {
                              this.func_191965_a(p_191966_1_, ClientHelper.getClientColor().getRGB());
                         }
                    }
     ...
     private void func_191969_a(BufferBuilder p_191969_1_, BakedQuad p_191969_2_, int p_191969_3_) {
          ...
          if (Reflector.ForgeHooksClient_putQuadColor.exists()) {
               Reflector.call(Reflector.ForgeHooksClient_putQuadColor, new Object[]{p_191969_1_, p_191969_2_, p_191969_3_});
          } else {
     ...
     private void func_191970_a(BufferBuilder p_191970_1_, List p_191970_2_, int p_191970_3_, ItemStack p_191970_4_) {
     ...
     public void renderItemAndEffectIntoGUI(@Nullable EntityLivingBase p_184391_1_, final ItemStack p_184391_2_, int p_184391_3_, int p_184391_4_) {
          if (!p_184391_2_.isEmpty()) {
               ...
               try {
                    this.func_191962_a(p_184391_2_, (float)p_184391_3_, (float)p_184391_4_, this.getItemModelWithOverrides(p_184391_2_, (World)null, p_184391_1_));
               } catch (Throwable var8) {
                    CrashReport crashreport = CrashReport.makeCrashReport(var8, "Rendering item");
                    CrashReportCategory crashreportcategory = crashreport.makeCategory("Item being rendered");
                    crashreportcategory.setDetail("Item Type", new ICrashReportDetail() {
                         public String call() throws Exception {
                              return String.valueOf(p_184391_2_.getItem());
                         }
                    });
                    crashreportcategory.setDetail("Item Aux", new ICrashReportDetail() {
                         public String call() throws Exception {
                              return String.valueOf(p_184391_2_.getMetadata());
                         }
                    });
                    crashreportcategory.setDetail("Item NBT", new ICrashReportDetail() {
                         public String call() throws Exception {
                              return String.valueOf(p_184391_2_.getTagCompound());
                         }
                    });
                    crashreportcategory.setDetail("Item Foil", new ICrashReportDetail() {
                         public String call() throws Exception {
     ...
     public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text) {
          if (!stack.isEmpty()) {
               if (stack.getCount() != 1 || text != null) {
                    ...
                    GlStateManager.disableBlend();
                    fr.drawStringWithShadow(s, (double)((float)(xPosition + 19 - 2 - fr.getStringWidth(s))), (double)((float)(yPosition + 6 + 3)), 16777215);
                    GlStateManager.enableLighting();
               ...
               if (ReflectorForge.isItemDamaged(stack)) {
                    ...
                    if (Reflector.ForgeItem_getDurabilityForDisplay.exists() && Reflector.ForgeItem_getRGBDurabilityForDisplay.exists()) {
                         d1 = Reflector.callDouble(stack.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, new Object[]{stack});
                         l = Reflector.callInt(stack.getItem(), Reflector.ForgeItem_getRGBDurabilityForDisplay, new Object[]{stack});
     ...
     public void renderItemOverlays(net.minecraft.client.gui.FontRenderer fr, ItemStack stack, int xPosition, int yPosition) {
          this.renderItemOverlayIntoGUI(fr, stack, xPosition, yPosition, (String)null);
     }

     public void renderItemOverlayIntoGUI(net.minecraft.client.gui.FontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text) {
          if (!stack.isEmpty()) {
               if (stack.getCount() != 1 || text != null) {
                    String s = text == null ? String.valueOf(stack.getCount()) : text;
                    GlStateManager.disableLighting();
