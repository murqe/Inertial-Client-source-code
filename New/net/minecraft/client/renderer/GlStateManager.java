...
public class GlStateManager {
     ...
     public static void deleteTexture(int texture) {
          if (texture != 0) {
               ...
               for(int var3 = 0; var3 < var2; ++var3) {
                    GlStateManager.TextureState glstatemanager$texturestate = var1[var3];
     ...
     public static void bindTexture(int texture) {
          GlStateManager.TextureState var10001 = textureState[activeTextureUnit];
          if (texture != GlStateManager.TextureState.textureName) {
               GlStateManager.TextureState var10000 = textureState[activeTextureUnit];
               GlStateManager.TextureState.textureName = texture;
     ...
     public static void bindCurrentTexture() {
          GlStateManager.TextureState var10001 = textureState[activeTextureUnit];
          GL11.glBindTexture(3553, GlStateManager.TextureState.textureName);
     }

     public static int getBoundTexture() {
          GlStateManager.TextureState var10000 = textureState[activeTextureUnit];
          return GlStateManager.TextureState.textureName;
     }
     ...
     static {
          int j;
          for(j = 0; j < 8; ++j) {
               lightState[j] = new GlStateManager.BooleanState(16384 + j);
          }
