...
public class ImageBufferDownload implements IImageBuffer {
     ...
     private void doTransparencyHack(int p_189559_1_, int p_189559_2_, int p_189559_3_, int p_189559_4_) {
          int l;
          int i1;
          for(l = p_189559_1_; l < p_189559_3_; ++l) {
               for(i1 = p_189559_2_; i1 < p_189559_4_; ++i1) {
                    int k = this.imageData[l + i1 * this.imageWidth];
                    if ((k >> 24 & 255) < 128) {
                         return;
                    }
               }
          ...
          for(l = p_189559_1_; l < p_189559_3_; ++l) {
               for(i1 = p_189559_2_; i1 < p_189559_4_; ++i1) {
                    ...
                    int var10001 = l + i1 * this.imageWidth;
     ...
     private void setAreaOpaque(int x, int y, int width, int height) {
          for(int i = x; i < width; ++i) {
               for(int j = y; j < height; ++j) {
                    int[] var10000 = this.imageData;
                    int var10001 = i + j * this.imageWidth;
