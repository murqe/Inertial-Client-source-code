...
public class ChunkRenderDispatcher {
     ...
     public boolean updateTransparencyLater(RenderChunk chunkRenderer) {
          ...
          try {
               ...
               flag2 = this.queueChunkUpdates.offer(chunkcompiletaskgenerator);
               var5 = flag2;
          } finally {
               chunkRenderer.getLockCompileTask().unlock();
          }
     ...
     public ListenableFuture uploadChunk(final BlockRenderLayer p_188245_1_, final BufferBuilder p_188245_2_, final RenderChunk p_188245_3_, final CompiledChunk p_188245_4_, final double p_188245_5_) {
     ...
     public void stopWorkerThreads() {
          ...
          while(var1.hasNext()) {
               ChunkRenderWorker chunkrenderworker = (ChunkRenderWorker)var1.next();
     ...
     class PendingUpload implements Comparable {
          ...
          public PendingUpload(ListenableFutureTask p_i46994_2_, double p_i46994_3_) {
