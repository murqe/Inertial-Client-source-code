...
public class RenderChunk {
     ...
     private final Set setTileEntities;
     ...
     public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
          ...
          if (this.world != null) {
               ...
               if (!chunkcacheof.isEmpty()) {
                    ...
                    Iterator var16 = BlockPosM.getAllInBoxMutable(blockpos, blockpos1).iterator();
     ...
     public ChunkCompileTaskGenerator makeCompileTaskTransparency() {
          ...
          try {
               ...
               if (this.compileTask == null || this.compileTask.getStatus() != ChunkCompileTaskGenerator.Status.PENDING) {
                    ...
                    chunkcompiletaskgenerator = this.compileTask;
                    ChunkCompileTaskGenerator chunkcompiletaskgenerator1 = chunkcompiletaskgenerator;
                    return chunkcompiletaskgenerator1;
               }

               chunkcompiletaskgenerator = null;
               var3 = chunkcompiletaskgenerator;
          } finally {
               this.lockCompileTask.unlock();
          }
