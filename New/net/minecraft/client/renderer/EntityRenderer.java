...
public class EntityRenderer implements IResourceManagerReloadListener {
          ...
          if (entity != null && this.mc.world != null) {
               ...
               while(true) {
                    while(var15.hasNext()) {
                         ...
                         if (entity1 instanceof EntityArmorStand && Main.instance.featureDirector.getFeatureByClass(NoInteract.class).isToggled() && NoInteract.armorStands.getBoolValue()) {
                              return;
                         }
                    ...
                    float reachDist = Main.instance.featureDirector.getFeatureByClass(Reach.class).isToggled() ? Reach.reachValue.getNumberValue() : 3.0F;
                    if (this.pointedEntity != null && flag && vec3d.distanceTo(vec3d3) > (double)reachDist) {
                         this.pointedEntity = null;
          ...
          if (this.debugView) {
               ...
               if (flag) {
                    ...
                    if (Config.zoomMode && this.scopeMath < 5.0F) {
                         this.scopeMath = (float)((double)this.scopeMath + 2.0D * Feature.deltaTime());
                    }
               } else {
                    if (this.scopeMath > 1.0F) {
                         this.scopeMath = (float)((double)this.scopeMath - 3.0D * Feature.deltaTime());
                    }
               ...
               return Reflector.ForgeHooksClient_getFOVModifier.exists() ? Reflector.callFloat(Reflector.ForgeHooksClient_getFOVModifier, new Object[]{this, entity, iblockstate, partialTicks, f}) : f;
          }
     }
     ...
     private void hurtCameraEffect(float partialTicks) {
          if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
               ...
               if (NoRender.hurtcam.getBoolValue() && Main.instance.featureDirector.getFeatureByClass(NoRender.class).isToggled()) {
                    GlStateManager.rotate(-f * 0.0F, 0.0F, 0.0F, 1.0F);
               } else {
     ...
     public void orientCamera(float partialTicks) {
          ...
          if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
               ...
               double d3 = (double)this.thirdPersonDistancePrev + -0.5D;
               if (this.mc.gameSettings.debugCamEnable) {
                    ...
                    for(int i = 0; i < 8; ++i) {
                         ...
                         if (raytraceresult != null) {
                              ...
                              if ((!NoRender.cameraClip.getBoolValue() || !Main.instance.featureDirector.getFeatureByClass(NoRender.class).isToggled()) && d7 < d3) {
                                   d3 = d7;
                              }
                         }
                    }
          ...
          if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists()) {
               if (!this.mc.gameSettings.debugCamEnable) {
                    ...
                    Object object = Reflector.newInstance(Reflector.EntityViewRenderEvent_CameraSetup_Constructor, new Object[]{this, entity, iblockstate1, partialTicks, f6, f7, f1});
                    Reflector.postForgeBusEvent(object);
                    f1 = Reflector.callFloat(object, Reflector.EntityViewRenderEvent_CameraSetup_getRoll, new Object[0]);
     ...
     private void updateLightmap(float partialTicks) {
          if (this.lightmapUpdateNeeded) {
               ...
               if (world != null) {
                    ...
                    int i;
                    if (Main.instance.featureDirector.getFeatureByClass(NightMode.class).isToggled()) {
                         i = NightMode.worldColor.getColorValue();
                         int r = i >> 16 & 255;
                         int g = i >> 8 & 255;
                         int b = i & 255;
                         int a = i >> 24 & 255;
                         ...
                         for(i = 0; i < 256; ++i) {
                              ...
                              if (Reflector.ForgeWorldProvider_getLightmapColors.exists()) {
                                   ...
                                   Reflector.call(world.provider, Reflector.ForgeWorldProvider_getLightmapColors, new Object[]{partialTicks, f, f2, f3, afloat});
                                   f8 = afloat[0];
                                   f9 = afloat[1];
                                   f10 = afloat[2];
                              }
                              ...
                              if (this.mc.player.isPotionActive(MobEffects.NIGHT_VISION)) {
                                   f16 = this.getNightVisionBrightness(this.mc.player, partialTicks);
                                   f17 = 1.0F / f8;
                                   if (f17 > 1.0F / f9) {
                                        f17 = 1.0F / f9;
                                   }
               ...
               if (this.mc.currentScreen != null) {
                    ...
                    try {
                         if (Reflector.ForgeHooksClient_drawScreen.exists()) {
                              Reflector.callVoid(Reflector.ForgeHooksClient_drawScreen, new Object[]{this.mc.currentScreen, k1, l1, this.mc.func_193989_ak()});
                         } else {
                         ...
                         crashreportcategory.setDetail("Screen name", new ICrashReportDetail() {
                              public String call() throws Exception {
                                   return EntityRenderer.this.mc.currentScreen.getClass().getCanonicalName();
                              }
                         });
                         crashreportcategory.setDetail("Mouse location", new ICrashReportDetail() {
                              public String call() throws Exception {
                                   return String.format("Scaled: (%d, %d). Absolute: (%d, %d)", k1, l1, Mouse.getX(), Mouse.getY());
                              }
                         });
                         crashreportcategory.setDetail("Screen size", new ICrashReportDetail() {
                              public String call() throws Exception {
                                   Object[] var10001 = new Object[]{scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight(), EntityRenderer.this.mc.displayWidth, EntityRenderer.this.mc.displayHeight, null};
                                   ScaledResolution var10004 = scaledresolution;
                                   var10001[4] = ScaledResolution.getScaleFactor();
     ...
     private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
          ...
          if (flag1 && this.mc.objectMouseOver != null && !entity.isInsideOfMaterial(Material.WATER)) {
               ...
               if (!Reflector.ForgeHooksClient_onDrawBlockHighlight.exists() || !Reflector.callBoolean(Reflector.ForgeHooksClient_onDrawBlockHighlight, new Object[]{renderglobal, entityplayer, this.mc.objectMouseOver, 0, partialTicks})) {
     ...
     protected void renderRainSnow(float partialTicks) {
          boolean snow = Main.instance.featureDirector.getFeatureByClass(Weather.class).isToggled();
          if (Reflector.ForgeWorldProvider_getWeatherRenderer.exists()) {
               ...
               if (object != null) {
                    Reflector.callVoid(object, Reflector.IRenderHandler_render, new Object[]{partialTicks, this.mc.world, this.mc});
                    return;
               }
          }

          float f5 = snow ? 1.0F : this.mc.world.getRainStrength(partialTicks);
          if (f5 > 0.0F) {
               if (Config.isRainOff()) {
                    return;
               }
               ...
               for(int k1 = k - i1; k1 <= k + i1; ++k1) {
                    for(int l1 = i - i1; l1 <= i + i1; ++l1) {
                         ...
                         if (biome.canRain() || biome.getEnableSnow() || snow) {
                              ...
                              if (k2 != l2) {
                                   ...
                                   double d9;
                                   double d10;
                                   if (world.getBiomeProvider().getTemperatureAtHeight(f1, j2) >= 0.15F && !snow) {
                                        if (j1 != 0) {
                                             if (j1 >= 0) {
                                                  tessellator.draw();
                                             }
                                        ...
                                        d8 = -((double)(this.rendererUpdateCount + l1 * l1 * 3121 + l1 * 45238971 + k1 * k1 * 418711 + k1 * 13761 & 31) + (double)partialTicks) / 32.0D * (3.0D + this.random.nextDouble());
                                        d9 = (double)((float)l1 + 0.5F) - entity.posX;
                                        d10 = (double)((float)k1 + 0.5F) - entity.posZ;
                                        float f2 = MathHelper.sqrt(d9 * d9 + d10 * d10) / (float)i1;
                                        float f3 = ((1.0F - f2 * f2) * 0.5F + 0.5F) * f5;
                                        blockpos$mutableblockpos.setPos(l1, i3, k1);
                                        int j3 = world.getCombinedLight(blockpos$mutableblockpos, 0);
                                        int k3 = j3 >> 16 & '\uffff';
                                        int l3 = j3 & '\uffff';
                                        bufferbuilder.pos((double)l1 - d3 + 0.5D, (double)l2, (double)k1 - d4 + 0.5D).tex(0.0D, (double)k2 * 0.25D + d8).color(1.0F, 1.0F, 1.0F, f3).lightmap(k3, l3).endVertex();
                                        bufferbuilder.pos((double)l1 + d3 + 0.5D, (double)l2, (double)k1 + d4 + 0.5D).tex(1.0D, (double)k2 * 0.25D + d8).color(1.0F, 1.0F, 1.0F, f3).lightmap(k3, l3).endVertex();
                                        bufferbuilder.pos((double)l1 + d3 + 0.5D, (double)k2, (double)k1 + d4 + 0.5D).tex(1.0D, (double)l2 * 0.25D + d8).color(1.0F, 1.0F, 1.0F, f3).lightmap(k3, l3).endVertex();
                                        bufferbuilder.pos((double)l1 - d3 + 0.5D, (double)k2, (double)k1 - d4 + 0.5D).tex(0.0D, (double)l2 * 0.25D + d8).color(1.0F, 1.0F, 1.0F, f3).lightmap(k3, l3).endVertex();
                                   } else {
                                        if (j1 != 1) {
                                             if (j1 >= 0) {
                                                  tessellator.draw();
                                        ...
                                        d8 = (double)(-((float)(this.rendererUpdateCount & 511) + partialTicks) / 512.0F);
                                        d9 = this.random.nextDouble() + (double)f * 0.01D * (double)((float)this.random.nextGaussian());
                                        d10 = this.random.nextDouble() + (double)(f * (float)this.random.nextGaussian()) * 0.001D;
                                        ...
                                        int j4 = i4 >> 16 & '\uffff';
                                        int k4 = i4 & '\uffff';
                                        int red = (int)((float)(Weather.weatherColor.getColorValue() >> 16 & 255) / 100.0F);
                                        int green = (int)((float)(Weather.weatherColor.getColorValue() >> 8 & 255) / 100.0F);
                                        int blue = (int)((float)(Weather.weatherColor.getColorValue() & 255) / 100.0F);
                                        bufferbuilder.pos((double)l1 - d3 + 0.5D, (double)l2, (double)k1 - d4 + 0.5D).tex(0.0D + d9, (double)k2 * 0.25D + d8 + d10).color((float)red, (float)green, (float)blue, f4).lightmap(j4, k4).endVertex();
                                        bufferbuilder.pos((double)l1 + d3 + 0.5D, (double)l2, (double)k1 + d4 + 0.5D).tex(1.0D + d9, (double)k2 * 0.25D + d8 + d10).color((float)red, (float)green, (float)blue, f4).lightmap(j4, k4).endVertex();
                                        bufferbuilder.pos((double)l1 + d3 + 0.5D, (double)k2, (double)k1 + d4 + 0.5D).tex(1.0D + d9, (double)l2 * 0.25D + d8 + d10).color((float)red, (float)green, (float)blue, f4).lightmap(j4, k4).endVertex();
                                        bufferbuilder.pos((double)l1 - d3 + 0.5D, (double)k2, (double)k1 - d4 + 0.5D).tex(0.0D + d9, (double)l2 * 0.25D + d8 + d10).color((float)red, (float)green, (float)blue, f4).lightmap(j4, k4).endVertex();
                                   }
                              }
                         }
                    }
     ...
     private void updateFogColor(float partialTicks) {
          ...
          Vec3d vec3d6;
          if (this.cloudFog) {
               vec3d6 = world.getCloudColour(partialTicks);
               ...
               vec3d6 = ActiveRenderInfo.projectViewFromEntity(entity, (double)partialTicks);
               BlockPos blockpos = new BlockPos(vec3d6);
               IBlockState iblockstate = this.mc.world.getBlockState(blockpos);
               Vec3d vec3d3 = (Vec3d)Reflector.call(iblockstate.getBlock(), Reflector.ForgeBlock_getFogColor, new Object[]{this.mc.world, blockpos, iblockstate, entity, new Vec3d((double)this.fogColorRed, (double)this.fogColorGreen, (double)this.fogColorBlue), partialTicks});
               ...
               vec3d6 = CustomColors.getUnderlavaColor(this.mc.world, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0D, this.mc.getRenderViewEntity().posZ);
               if (vec3d6 != null) {
                    this.fogColorRed = (float)vec3d6.xCoord;
                    this.fogColorGreen = (float)vec3d6.yCoord;
                    this.fogColorBlue = (float)vec3d6.zCoord;
          ...
          if (Reflector.EntityViewRenderEvent_FogColors_Constructor.exists()) {
               Object object = Reflector.newInstance(Reflector.EntityViewRenderEvent_FogColors_Constructor, new Object[]{this, entity, iblockstate1, partialTicks, this.fogColorRed, this.fogColorGreen, this.fogColorBlue});
               Reflector.postForgeBusEvent(object);
     ...
     private void setupFog(int startCoords, float partialTicks) {
          if (!Main.instance.featureDirector.getFeatureByClass(NoRender.class).isToggled() || !NoRender.fog.getBoolValue()) {
               ...
               if (Reflector.ForgeHooksClient_getFogDensity.exists()) {
                    f = Reflector.callFloat(Reflector.ForgeHooksClient_getFogDensity, new Object[]{this, entity, iblockstate, partialTicks, 0.1F});
               }
               ...
               if (f >= 0.0F) {
                    ...
                    if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPotionActive(MobEffects.BLINDNESS)) {
                         ...
                         if (startCoords == -1) {
                              ...
                              float dist = Main.instance.featureDirector.getFeatureByClass(FogColor.class).isToggled() ? -FogColor.distance.getNumberValue() : Config.getFogStart();
                              GlStateManager.setFogStart(f1 * dist);
                         }
                         ...
                         if (Reflector.ForgeHooksClient_onFogRender.exists()) {
                              Reflector.callVoid(Reflector.ForgeHooksClient_onFogRender, new Object[]{this, entity, iblockstate, partialTicks, startCoords, f1});
                         }
                    }
               }
