...
public class LayerHeldItem implements LayerRenderer {
     public static boolean jeffRender = true;
     ...
     public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
          boolean flag;
          ItemStack itemstack;
          if (Main.instance.featureDirector.getFeatureByClass(CustomModel.class).isToggled()) {
               flag = entitylivingbaseIn.getPrimaryHand() == EnumHandSide.LEFT;
               itemstack = flag ? entitylivingbaseIn.getHeldItemOffhand() : entitylivingbaseIn.getHeldItemMainhand();
               ...
               flag = entitylivingbaseIn.getPrimaryHand() == EnumHandSide.RIGHT;
               itemstack = flag ? entitylivingbaseIn.getHeldItemOffhand() : entitylivingbaseIn.getHeldItemMainhand();
