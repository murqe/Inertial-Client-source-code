...
public abstract class RenderLivingBase extends Render {
     ...
     public void doRender(EntityLivingBase entity, double x, double y, double z, float entityYaw, float partialTicks) {
          if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[]{entity, this, partialTicks, x, y, z})) {
               ...
               try {
                    ...
                    float f7 = entity instanceof EntityPlayer && entity == Minecraft.getMinecraft().player ? entity.prevRotationPitchHead + (entity.rotationPitchHead - entity.prevRotationPitchHead) * partialTicks : entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTicks;
     ...
     protected void renderModel(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
          ...
          boolean chamsCheck = Main.instance.featureDirector.getFeatureByClass(Chams.class).isToggled() && entitylivingbaseIn instanceof EntityPlayer;
          if (flag || flag1) {
     ...
     public void renderName(EntityLivingBase entity, double x, double y, double z) {
          if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, new Object[]{entity, this, x, y, z})) {
