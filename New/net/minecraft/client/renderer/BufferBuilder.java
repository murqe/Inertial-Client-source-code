...
public class BufferBuilder {
     ...
     public void sortVertexData(float p_181674_1_, float p_181674_2_, float p_181674_3_) {
          ...
          for(int i1 = bitset.nextClearBit(0); i1 < ainteger.length; i1 = bitset.nextClearBit(i1 + 1)) {
               ...
               if (j1 != i1) {
                    ...
                    for(l1 = ainteger[j1]; j2 != i1; l1 = ainteger[l1]) {
          ...
          if (this.quadSprites != null) {
               ...
               j1 = this.vertexFormat.getNextOffset() / 4 * 4;

               for(j2 = 0; j2 < ainteger.length; ++j2) {
                    l1 = ainteger[j2];
                    atextureatlassprite[j2] = this.quadSprites[l1];
               }
     ...
     public BufferBuilder color(int hex) {
          return this.color(hex >> 16 & 255, hex >> 8 & 255, hex & 255, hex >> 24 & 255);
     }
