...
public class ItemModelGenerator {
     ...
     private List getBlockParts(TextureAtlasSprite p_178397_1_, String p_178397_2_, int p_178397_3_) {
          ...
          while(var7.hasNext()) {
               ItemModelGenerator.Span itemmodelgenerator$span = (ItemModelGenerator.Span)var7.next();
               float f2 = 0.0F;
               float f3 = 0.0F;
               float f4 = 0.0F;
               float f5 = 0.0F;
     ...
     private void createOrExpandSpan(List p_178395_1_, ItemModelGenerator.SpanFacing p_178395_2_, int p_178395_3_, int p_178395_4_) {
          ...
          while(var6.hasNext()) {
               ItemModelGenerator.Span itemmodelgenerator$span1 = (ItemModelGenerator.Span)var6.next();
