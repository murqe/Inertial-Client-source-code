...
public class DebugRendererWater implements DebugRenderer.IDebugRenderer {
     ...
     public void render(float p_190060_1_, long p_190060_2_) {
          ...
          while(true) {
               ...
               do {
                    if (!var6.hasNext()) {
                         ...
                         while(true) {
                              ...
                              } while(iblockstate1.getBlock() != Blocks.WATER && iblockstate1.getBlock() != Blocks.FLOWING_WATER);
               ...
               double d0 = (double)BlockLiquid.func_190972_g(iblockstate1, world, blockpos2);
               RenderGlobal.renderFilledBox((new AxisAlignedBB((double)((float)blockpos2.getX() + 0.01F), (double)((float)blockpos2.getY() + 0.01F), (double)((float)blockpos2.getZ() + 0.01F), (double)((float)blockpos2.getX() + 0.99F), d0, (double)((float)blockpos2.getZ() + 0.99F))).offset(-this.xo, -this.yo, -this.zo), 1.0F, 1.0F, 1.0F, 0.2F);
          }
     }
}
