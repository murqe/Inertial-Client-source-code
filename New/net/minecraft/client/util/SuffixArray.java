...
public class SuffixArray {
     ...
     protected final List field_194061_a = Lists.newArrayList();
     ...
     public void func_194057_a(Object p_194057_1_, String p_194057_2_) {
     ...
     public void func_194058_a() {
          ...
          int k1;
          for(k1 = 0; k1 < i; ++k1) {
               aint[k1] = this.field_194065_e.getInt(k1);
          }
          ...
          for(int k = Math.min(i, this.field_194069_i); k1 * 2 < k; k1 *= 2) {
               int l1;
               for(l1 = 0; l1 < i; aint3[l1] = l1++) {
                    aint1[l1] = aint[l1];
                    aint2[l1] = l1 + k1 < i ? aint[l1 + k1] : -2;
               }
     ...
     private String func_194059_a(int p_194059_1_) {
          ...
          for(int k2 = 0; j2 + k2 < this.field_194065_e.size(); ++k2) {
               ...
               int l2 = (Integer)this.field_194065_e.get(j2 + k2);
               if (l2 == -1) {
                    break;
               }
     ...
     public List func_194055_a(String p_194055_1_) {
          ...
          while(j2 < k2) {
               i4 = j2 + (k2 - j2) / 2;
               j4 = this.func_194056_a(p_194055_1_, i4);
               if (field_194062_b) {
                    field_194064_d.debug("comparing lower \"{}\" with {} \"{}\": {}", p_194055_1_, i4, this.func_194059_a(i4), j4);
               }
