     ...
     public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_) {
          ...
          if (this.showHoverOverlay() && (this.mc.gameSettings.touchscreen || p_192634_8_)) {
               ...
               if (this.canMoveRight()) {
                    ...
                    if (this.canMoveLeft()) {
                         if (j < 16) {
                              Gui.drawModalRectWithCustomSizedTexture((float)p_192634_2_, (float)p_192634_3_, 32.0F, 32.0F, 32.0F, 32.0F, 256.0F, 256.0F);
                         } else {
                              Gui.drawModalRectWithCustomSizedTexture((float)p_192634_2_, (float)p_192634_3_, 32.0F, 0.0F, 32.0F, 32.0F, 256.0F, 256.0F);
                         }
                    }
