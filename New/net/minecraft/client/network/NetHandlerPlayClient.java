...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
     ...
     public void handleEntityStatus(SPacketEntityStatus packetIn) {
          ...
          if (entity != null) {
               if (packetIn.getOpCode() == 21) {
                    ...
                    if (entity == this.gameController.player && (!NoRender.antiTotem.getBoolValue() || !Main.instance.featureDirector.getFeatureByClass(NoRender.class).isToggled())) {
     ...
     public void handleExplosion(SPacketExplosion packetIn) {
          ...
          EntityPlayerSP var10000 = this.gameController.player;
          var10000.motionX += (double)packetIn.getMotionX();
          var10000 = this.gameController.player;
          var10000.motionY += (double)packetIn.getMotionY();
          var10000 = this.gameController.player;
          var10000.motionZ += (double)packetIn.getMotionZ();
     }
     ...
     public void handleCustomPayload(SPacketCustomPayload packetIn) {
          ...
          if ("MC|TrList".equals(packetIn.getChannelName())) {
               ...
               try {
                    l = packetbuffer3.readInt();
                    GuiScreen guiscreen = this.gameController.currentScreen;
                    if (guiscreen != null && guiscreen instanceof GuiMerchant && l == this.gameController.player.openContainer.windowId) {
