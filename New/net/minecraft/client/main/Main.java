...
public class Main {
     public static void main(String[] p_main_0_) {
          ...
          OptionSpec optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("InertialFree" + Minecraft.getSystemTime() % 1000L, new String[0]);
          ...
          OptionSpec optionspec19 = optionparser.accepts("versionType").withRequiredArg().defaultsTo("release", new String[0]);
          OptionSpec optionspec20 = optionparser.nonOptions();
          OptionSet optionset = optionparser.parse(p_main_0_);
          List list = optionset.valuesOf(optionspec20);
          if (!list.isEmpty()) {
