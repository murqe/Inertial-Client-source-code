...
public class Cartesian {
     ...
     private static Object[] toArray(Class clazz, Iterable it) {
          ...
          return (Object[])list.toArray(createArray(clazz, list.size()));
     }

     private static Object[] createArray(Class elementType, int length) {
          return (Object[])((Object[])((Object[])Array.newInstance(elementType, length)));
     }
     ...
     static class Product implements Iterable {
          ...
          // $FF: synthetic method
          Product(Class x0, Iterable[] x1, Object x2) {
               this(x0, x1);
          }
          ...
          static class ProductIterator extends UnmodifiableIterator {
               ...
               private ProductIterator(Class clazz, Iterable[] iterables) {
                    ...
                    this.results = (Object[])Cartesian.createArray(clazz, this.iterators.length);
               }
               ...
               // $FF: synthetic method
               ProductIterator(Class x0, Iterable[] x1, Object x2) {
                    this(x0, x1);
               }
          }
     }
