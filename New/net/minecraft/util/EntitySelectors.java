...
public final class EntitySelectors {
     ...
     public static Predicate withinRange(final double x, final double y, final double z, double range) {
     ...
     public static Predicate getTeamCollisionPredicate(final Entity entityIn) {
     ...
     public static Predicate func_191324_b(final Entity p_191324_0_) {
          return new Predicate() {
               public boolean apply(@Nullable Entity p_apply_1_) {
                    while(true) {
          ...
          public boolean apply(@Nullable Entity p_apply_1_) {
               if (!p_apply_1_.isEntityAlive()) {
                    ...
                    if (!entitylivingbase.getItemStackFromSlot(EntityLiving.getSlotForItemStack(this.armor)).func_190926_b()) {
                         ...
                         return entitylivingbase instanceof EntityArmorStand ? true : entitylivingbase instanceof EntityPlayer;
                    }
               }
          }
     }
