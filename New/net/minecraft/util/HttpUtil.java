...
public class HttpUtil {
     ...
     public static String postMap(URL url, Map data, boolean skipLoggingErrors, @Nullable Proxy p_151226_3_) {
     ...
     public static ListenableFuture downloadResourcePack(final File saveFile, final String packUrl, final Map p_180192_2_, final int maxSize, @Nullable final IProgressUpdate p_180192_4_, final Proxy p_180192_5_) {
