...
public class JsonUtils {
     ...
     public static Object deserializeClass(@Nullable JsonElement json, String memberName, JsonDeserializationContext context, Class adapter) {
          if (json != null) {
     ...
     public static Object deserializeClass(JsonObject json, String memberName, JsonDeserializationContext context, Class adapter) {
          if (json.has(memberName)) {
     ...
     public static Object deserializeClass(JsonObject json, String memberName, Object fallback, JsonDeserializationContext context, Class adapter) {
     ...
     @Nullable
     public static Object gsonDeserialize(Gson gsonIn, Reader readerIn, Class adapter, boolean lenient) {
          try {
     ...
     @Nullable
     public static Object func_193838_a(Gson p_193838_0_, Reader p_193838_1_, Type p_193838_2_, boolean p_193838_3_) {
          try {
     ...
     @Nullable
     public static Object func_193837_a(Gson p_193837_0_, String p_193837_1_, Type p_193837_2_, boolean p_193837_3_) {
          return func_193838_a(p_193837_0_, new StringReader(p_193837_1_), p_193837_2_, p_193837_3_);
     }

     @Nullable
     public static Object gsonDeserialize(Gson gsonIn, String json, Class adapter, boolean lenient) {
          return gsonDeserialize(gsonIn, (Reader)(new StringReader(json)), adapter, lenient);
     }

     @Nullable
     public static Object func_193841_a(Gson p_193841_0_, Reader p_193841_1_, Type p_193841_2_) {
          return func_193838_a(p_193841_0_, p_193841_1_, p_193841_2_, false);
     }

     @Nullable
     public static Object func_193840_a(Gson p_193840_0_, String p_193840_1_, Type p_193840_2_) {
          return func_193837_a(p_193840_0_, p_193840_1_, p_193840_2_, false);
     }

     @Nullable
     public static Object func_193839_a(Gson p_193839_0_, Reader p_193839_1_, Class p_193839_2_) {
          return gsonDeserialize(p_193839_0_, p_193839_1_, p_193839_2_, false);
     }

     @Nullable
     public static Object gsonDeserialize(Gson gsonIn, String json, Class adapter) {
