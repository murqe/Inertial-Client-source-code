...
public class Explosion {
     ...
     public Explosion(World worldIn, Entity entityIn, double x, double y, double z, float size, List affectedPositions) {
          this(worldIn, entityIn, x, y, z, size, false, true, affectedPositions);
     }

     public Explosion(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean smoking, List affectedPositions) {
     ...
     public void doExplosionA() {
          ...
          k = MathHelper.floor(this.explosionX - (double)f3 - 1.0D);
          l = MathHelper.floor(this.explosionX + (double)f3 + 1.0D);
          ...
          List list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder, new AxisAlignedBB((double)k, (double)i2, (double)j2, (double)l, (double)i1, (double)j1));
     ...
     public void doExplosionB(boolean spawnParticles) {
          ...
          if (this.isFlaming) {
               ...
               while(var2.hasNext()) {
                    blockpos = (BlockPos)var2.next();
                    if (this.worldObj.getBlockState(blockpos).getMaterial() == Material.AIR && this.worldObj.getBlockState(blockpos.down()).isFullBlock() && this.explosionRNG.nextInt(3) == 0) {
