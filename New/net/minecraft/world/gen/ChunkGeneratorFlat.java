...
public class ChunkGeneratorFlat implements IChunkGenerator {
     ...
     private final Map structureGenerators = new HashMap();
     ...
     public void populate(int x, int z) {
          ...
          while(var13.hasNext()) {
               MapGenStructure mapgenstructure = (MapGenStructure)var13.next();
     ...
     public boolean func_193414_a(World p_193414_1_, String p_193414_2_, BlockPos p_193414_3_) {
          MapGenStructure mapgenstructure = (MapGenStructure)this.structureGenerators.get(p_193414_2_);
