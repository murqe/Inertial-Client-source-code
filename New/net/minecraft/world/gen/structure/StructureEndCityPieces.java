...
public class StructureEndCityPieces {
     ...
     private static final StructureEndCityPieces.IGenerator HOUSE_TOWER_GENERATOR;
     private static final List TOWER_BRIDGES;
     private static final StructureEndCityPieces.IGenerator TOWER_GENERATOR;
     private static final StructureEndCityPieces.IGenerator TOWER_BRIDGE_GENERATOR;
     private static final List FAT_TOWER_BRIDGES;
     private static final StructureEndCityPieces.IGenerator FAT_TOWER_GENERATOR;
     ...
     public static void func_191087_a(TemplateManager p_191087_0_, BlockPos p_191087_1_, Rotation p_191087_2_, List p_191087_3_, Random p_191087_4_) {
     ...
     private static StructureEndCityPieces.CityTemplate func_189935_b(List p_189935_0_, StructureEndCityPieces.CityTemplate p_189935_1_) {
          p_189935_0_.add(p_189935_1_);
          return p_189935_1_;
     }

     private static boolean func_191088_b(TemplateManager p_191088_0_, StructureEndCityPieces.IGenerator p_191088_1_, int p_191088_2_, StructureEndCityPieces.CityTemplate p_191088_3_, BlockPos p_191088_4_, List p_191088_5_, Random p_191088_6_) {
          if (p_191088_2_ > 8) {
               return false;
          } else {
               ...
               if (p_191088_1_.func_191086_a(p_191088_0_, p_191088_2_, p_191088_3_, p_191088_4_, list, p_191088_6_)) {
                    ...
                    while(var10.hasNext()) {
                         StructureComponent structurecomponent = (StructureComponent)var10.next();
     ...
     static {
          ...
          HOUSE_TOWER_GENERATOR = new StructureEndCityPieces.IGenerator() {
               public void init() {
               }

               public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPieces.CityTemplate p_191086_3_, BlockPos p_191086_4_, List p_191086_5_, Random p_191086_6_) {
                    if (p_191086_2_ > 8) {
                         return false;
                    } else {
          ...
          TOWER_GENERATOR = new StructureEndCityPieces.IGenerator() {
               public void init() {
               }
               ...
               public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPieces.CityTemplate p_191086_3_, BlockPos p_191086_4_, List p_191086_5_, Random p_191086_6_) {
                    ...
                    if (structureendcitypieces$citytemplate1 != null) {
                         Iterator var14 = StructureEndCityPieces.TOWER_BRIDGES.iterator();
          ...
          TOWER_BRIDGE_GENERATOR = new StructureEndCityPieces.IGenerator() {
          ...
          FAT_TOWER_GENERATOR = new StructureEndCityPieces.IGenerator() {
               public void init() {
               }
               ...
               public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPieces.CityTemplate p_191086_3_, BlockPos p_191086_4_, List p_191086_5_, Random p_191086_6_) {
                    ...
                    for(int i = 0; i < 2 && p_191086_6_.nextInt(3) != 0; ++i) {
                         ...
                         Iterator var10 = StructureEndCityPieces.FAT_TOWER_BRIDGES.iterator();
     ...
     interface IGenerator {
          ...
          boolean func_191086_a(TemplateManager var1, int var2, StructureEndCityPieces.CityTemplate var3, BlockPos var4, List var5, Random var6);
     }
