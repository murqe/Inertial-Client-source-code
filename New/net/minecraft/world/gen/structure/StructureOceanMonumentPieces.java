...
public class StructureOceanMonumentPieces {
     ...
     static class ZDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
          ...
          // $FF: synthetic method
          ZDoubleRoomFitHelper(Object x0) {
               this();
          }
     }
     ...
     static class YZDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
          ...
          // $FF: synthetic method
          YZDoubleRoomFitHelper(Object x0) {
               this();
          }
     }
     ...
     static class YDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
          ...
          // $FF: synthetic method
          YDoubleRoomFitHelper(Object x0) {
               this();
          }
     }
     ...
     static class XYDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
          ...
          // $FF: synthetic method
          XYDoubleRoomFitHelper(Object x0) {
               this();
          }
     }
     ...
     static class XDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
          ...
          // $FF: synthetic method
          XDoubleRoomFitHelper(Object x0) {
               this();
          }
     }
     ...
     public static class WingRoom extends StructureOceanMonumentPieces.Piece {
          ...
          public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
               if (this.mainDesign == 0) {
                    int i1;
                    for(i1 = 0; i1 < 4; ++i1) {
                         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 10 - i1, 3 - i1, 20 - i1, 12 + i1, 3 - i1, 20, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    }
     ...
     public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece {
               ...
               while(true) {
                    while(true) {
                         ...
                         do {
                              do {
                                   if (!var8.hasNext()) {
                                        ...
                                        while(var18.hasNext()) {
                                             StructureOceanMonumentPieces.Piece structureoceanmonumentpieces$piece = (StructureOceanMonumentPieces.Piece)var18.next();
                                   ...
                                   structureoceanmonumentpieces$roomdefinition = (StructureOceanMonumentPieces.RoomDefinition)var8.next();
                         ...
                         while(lvt_10_1_.hasNext()) {
                              StructureOceanMonumentPieces.MonumentRoomFitHelper structureoceanmonumentpieces$monumentroomfithelper = (StructureOceanMonumentPieces.MonumentRoomFitHelper)lvt_10_1_.next();
          ...
          private List generateRoomGraph(Random p_175836_1_) {
               ...
               for(k2 = 0; k2 < 5; ++k2) {
                    for(j3 = 0; j3 < 4; ++j3) {
                         ...
                         astructureoceanmonumentpieces$roomdefinition[l4] = new StructureOceanMonumentPieces.RoomDefinition(l4);
                    }
               }
                         ...
                         for(int i4 = 0; i4 < 3; ++i4) {
                              ...
                              if (astructureoceanmonumentpieces$roomdefinition[l4] != null) {
                                   ...
                                   for(var9 = 0; var9 < var8; ++var9) {
                                        ...
                                        i1 = k2 + enumfacing.getFrontOffsetX();
                                        l5 = i4 + enumfacing.getFrontOffsetY();
                                        k1 = j3 + enumfacing.getFrontOffsetZ();
               ...
               StructureOceanMonumentPieces.RoomDefinition[] var20 = astructureoceanmonumentpieces$roomdefinition;
               var8 = astructureoceanmonumentpieces$roomdefinition.length;

               for(var9 = 0; var9 < var8; ++var9) {
                    StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition4 = var20[var9];
               ...
               label93:
               while(var22.hasNext()) {
                    StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition3 = (StructureOceanMonumentPieces.RoomDefinition)var22.next();
                    int j5 = 0;
                    i1 = 0;
                    ...
                    while(true) {
                         while(true) {
                              ...
                              k1 = EnumFacing.getFront(l5).getOpposite().getIndex();
          ...
          public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
               ...
               while(var11.hasNext()) {
                    StructureOceanMonumentPieces.Piece structureoceanmonumentpieces$piece = (StructureOceanMonumentPieces.Piece)var11.next();
     ...
     static class FitSimpleRoomTopHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
          ...
          // $FF: synthetic method
          FitSimpleRoomTopHelper(Object x0) {
               this();
          }
     }
