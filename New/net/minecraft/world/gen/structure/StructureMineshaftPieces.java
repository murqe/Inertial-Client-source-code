...
public class StructureMineshaftPieces {
     ...
     private static StructureMineshaftPieces.Peice func_189940_a(List p_189940_0_, Random p_189940_1_, int p_189940_2_, int p_189940_3_, int p_189940_4_, @Nullable EnumFacing p_189940_5_, int p_189940_6_, MapGenMineshaft.Type p_189940_7_) {
          int i = p_189940_1_.nextInt(100);
          StructureBoundingBox structureboundingbox1;
          if (i >= 80) {
               structureboundingbox1 = StructureMineshaftPieces.Cross.findCrossing(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
               if (structureboundingbox1 != null) {
                    return new StructureMineshaftPieces.Cross(p_189940_6_, p_189940_1_, structureboundingbox1, p_189940_5_, p_189940_7_);
               }
          } else if (i >= 70) {
               structureboundingbox1 = StructureMineshaftPieces.Stairs.findStairs(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
               if (structureboundingbox1 != null) {
                    return new StructureMineshaftPieces.Stairs(p_189940_6_, p_189940_1_, structureboundingbox1, p_189940_5_, p_189940_7_);
               }
          } else {
               structureboundingbox1 = StructureMineshaftPieces.Corridor.findCorridorSize(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
               if (structureboundingbox1 != null) {
                    return new StructureMineshaftPieces.Corridor(p_189940_6_, p_189940_1_, structureboundingbox1, p_189940_5_, p_189940_7_);
               }
          }
     ...
     private static StructureMineshaftPieces.Peice func_189938_b(StructureComponent p_189938_0_, List p_189938_1_, Random p_189938_2_, int p_189938_3_, int p_189938_4_, int p_189938_5_, EnumFacing p_189938_6_, int p_189938_7_) {
          if (p_189938_7_ > 8) {
               return null;
     ...
     public static class Stairs extends StructureMineshaftPieces.Peice {
          ...
          public static StructureBoundingBox findStairs(List listIn, Random rand, int x, int y, int z, EnumFacing facing) {
     ...
     public static class Room extends StructureMineshaftPieces.Peice {
          ...
          public void buildComponent(StructureComponent componentIn, List listIn, Random rand) {
               ...
               int k;
               StructureMineshaftPieces.Peice structurecomponent;
               ...
               for(k = 0; k < this.boundingBox.getXSize(); k += 4) {
                    ...
                    structurecomponent = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                    if (structurecomponent != null) {
                         structureboundingbox3 = structurecomponent.getBoundingBox();
                         this.roomsLinkedToTheRoom.add(new StructureBoundingBox(structureboundingbox3.minX, structureboundingbox3.minY, this.boundingBox.minZ, structureboundingbox3.maxX, structureboundingbox3.maxY, this.boundingBox.minZ + 1));
                    }
               }
               ...
               for(k = 0; k < this.boundingBox.getXSize(); k += 4) {
                    ...
                    structurecomponent = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                    if (structurecomponent != null) {
                         structureboundingbox3 = structurecomponent.getBoundingBox();
                         this.roomsLinkedToTheRoom.add(new StructureBoundingBox(structureboundingbox3.minX, structureboundingbox3.minY, this.boundingBox.maxZ - 1, structureboundingbox3.maxX, structureboundingbox3.maxY, this.boundingBox.maxZ));
                    }
               }
               ...
               for(k = 0; k < this.boundingBox.getZSize(); k += 4) {
                    ...
                    structurecomponent = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.WEST, i);
                    if (structurecomponent != null) {
                         structureboundingbox3 = structurecomponent.getBoundingBox();
               ...
               for(k = 0; k < this.boundingBox.getZSize(); k += 4) {
                    ...
                    structurecomponent = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.EAST, i);
                    if (structurecomponent != null) {
                         structureboundingbox3 = structurecomponent.getBoundingBox();
          ...
          public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
               if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
                    ...
                    while(var4.hasNext()) {
                         StructureBoundingBox structureboundingbox = (StructureBoundingBox)var4.next();
          ...
          protected void writeStructureToNBT(NBTTagCompound tagCompound) {
               ...
               while(var3.hasNext()) {
                    StructureBoundingBox structureboundingbox = (StructureBoundingBox)var3.next();
     ...
     public static class Cross extends StructureMineshaftPieces.Peice {
          ...
          public static StructureBoundingBox findCrossing(List listIn, Random rand, int x, int y, int z, EnumFacing facing) {
     ...
     public static class Corridor extends StructureMineshaftPieces.Peice {
          ...
          public static StructureBoundingBox findCorridorSize(List p_175814_0_, Random rand, int x, int y, int z, EnumFacing facing) {
               StructureBoundingBox structureboundingbox = new StructureBoundingBox(x, y, z, x, y + 2, z);
               ...
               if (i < 8) {
                    ...
                    if (enumfacing != EnumFacing.NORTH && enumfacing != EnumFacing.SOUTH) {
                         for(k = this.boundingBox.minX + 3; k + 3 <= this.boundingBox.maxX; k += 5) {
                              l = rand.nextInt(5);
                              if (l == 0) {
                                   StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, k, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i + 1);
                              } else if (l == 1) {
                                   StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, k, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i + 1);
                              }
                         }
                    } else {
          ...
          public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
               if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
                    ...
                    for(l2 = 0; l2 < this.sectionCount; ++l2) {
                         j3 = 2 + l2 * 5;
                         this.func_189921_a(worldIn, structureBoundingBoxIn, 0, 0, j3, 2, 2, randomIn);
                         this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1F, 0, 2, j3 - 1);
                         this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1F, 2, 2, j3 - 1);
                         this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1F, 0, 2, j3 + 1);
                         this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1F, 2, 2, j3 + 1);
                         this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05F, 0, 2, j3 - 2);
                         this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05F, 2, 2, j3 - 2);
                         this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05F, 0, 2, j3 + 2);
                         this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05F, 2, 2, j3 + 2);
                         if (randomIn.nextInt(100) == 0) {
                              this.generateChest(worldIn, structureBoundingBoxIn, randomIn, 2, 0, j3 - 1, LootTableList.CHESTS_ABANDONED_MINESHAFT);
                         }

                         if (randomIn.nextInt(100) == 0) {
                              this.generateChest(worldIn, structureBoundingBoxIn, randomIn, 0, 0, j3 + 1, LootTableList.CHESTS_ABANDONED_MINESHAFT);
                         }
                    ...
                    for(l2 = 0; l2 <= 2; ++l2) {
                         for(j3 = 0; j3 <= i1; ++j3) {
                              int k3 = true;
                              IBlockState iblockstate3 = this.getBlockStateFromPos(worldIn, l2, -1, j3, structureBoundingBoxIn);
                              if (iblockstate3.getMaterial() == Material.AIR && this.func_189916_b(worldIn, l2, -1, j3, structureBoundingBoxIn) < 8) {
                                   int l3 = true;
