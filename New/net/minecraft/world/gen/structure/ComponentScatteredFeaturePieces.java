...
public class ComponentScatteredFeaturePieces {
     ...
     public static class SwampHut extends ComponentScatteredFeaturePieces.Feature {
          ...
          public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
               if (!this.offsetToAverageGroundLevel(worldIn, structureBoundingBoxIn, 0)) {
                    ...
                    for(l = 2; l <= 7; l += 5) {
                         for(i1 = 1; i1 <= 5; i1 += 4) {
                              this.replaceAirAndLiquidDownwards(worldIn, Blocks.LOG.getDefaultState(), i1, -1, l, structureBoundingBoxIn);
                         }
                    }
     ...
     public static class JunglePyramid extends ComponentScatteredFeaturePieces.Feature {
          ...
          public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
               if (!this.offsetToAverageGroundLevel(worldIn, structureBoundingBoxIn, 0)) {
                    ...
                    int l;
                    for(l = 0; l <= 14; l += 14) {
                         this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 4, l, 2, 5, l, false, randomIn, junglePyramidsRandomScatteredStones);
                         this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 4, l, 4, 5, l, false, randomIn, junglePyramidsRandomScatteredStones);
                         this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 7, 4, l, 7, 5, l, false, randomIn, junglePyramidsRandomScatteredStones);
                         this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, 4, l, 9, 5, l, false, randomIn, junglePyramidsRandomScatteredStones);
                    }
                    ...
                    for(j1 = 1; j1 <= 13; j1 += 2) {
                         this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, -3, j1, 1, -2, j1, false, randomIn, junglePyramidsRandomScatteredStones);
                    }
     ...
     public static class DesertPyramid extends ComponentScatteredFeaturePieces.Feature {
          ...
          public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
               ...
               int i2;
               for(i2 = 1; i2 <= 9; ++i2) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, i2, i2, i2, this.scatteredFeatureSizeX - 1 - i2, i2, this.scatteredFeatureSizeZ - 1 - i2, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, i2 + 1, i2, i2 + 1, this.scatteredFeatureSizeX - 2 - i2, i2, this.scatteredFeatureSizeZ - 2 - i2, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
               }

               for(i2 = 0; i2 < this.scatteredFeatureSizeX; ++i2) {
               ...
               int k2;
               for(k2 = 5; k2 <= 17; k2 += 2) {
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 4, 1, k2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), 4, 2, k2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), this.scatteredFeatureSizeX - 5, 1, k2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), this.scatteredFeatureSizeX - 5, 2, k2, structureBoundingBoxIn);
               }
               ...
               for(k2 = 0; k2 <= this.scatteredFeatureSizeX - 1; k2 += this.scatteredFeatureSizeX - 1) {
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2, 2, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l), k2, 2, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2, 2, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2, 3, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l), k2, 3, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2, 3, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l), k2, 4, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), k2, 4, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l), k2, 4, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2, 5, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l), k2, 5, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2, 5, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l), k2, 6, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), k2, 6, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l), k2, 6, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l), k2, 7, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l), k2, 7, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l), k2, 7, 3, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2, 8, 1, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2, 8, 2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2, 8, 3, structureBoundingBoxIn);
               }

               for(k2 = 2; k2 <= this.scatteredFeatureSizeX - 3; k2 += this.scatteredFeatureSizeX - 3 - 2) {
