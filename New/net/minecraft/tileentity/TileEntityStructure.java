...
public class TileEntityStructure extends TileEntity {
     ...
     public boolean detectSize() {
          if (this.mode != TileEntityStructure.Mode.SAVE) {
               ...
               List list = this.getNearbyCornerBlocks(blockpos1, blockpos2);
     ...
     private List filterRelatedCornerBlocks(List p_184415_1_) {
          Iterable iterable = Iterables.filter(p_184415_1_, new Predicate() {
     ...
     private List getNearbyCornerBlocks(BlockPos p_184418_1_, BlockPos p_184418_2_) {
     ...
     private StructureBoundingBox calculateEnclosingBoundingBox(BlockPos p_184416_1_, List p_184416_2_) {
          ...
          while(var7.hasNext()) {
               TileEntityStructure tileentitystructure = (TileEntityStructure)var7.next();
     ...
     public static enum Mode implements IStringSerializable {
          ...
          static {
               TileEntityStructure.Mode[] var0 = values();
               int var1 = var0.length;

               for(int var2 = 0; var2 < var1; ++var2) {
                    TileEntityStructure.Mode tileentitystructure$mode = var0[var2];
