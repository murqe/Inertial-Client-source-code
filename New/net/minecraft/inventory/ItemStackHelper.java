...
public class ItemStackHelper {
     public static ItemStack getAndSplit(List stacks, int index, int amount) {
     ...
     public static ItemStack getAndRemove(List stacks, int index) {
          return index >= 0 && index < stacks.size() ? (ItemStack)stacks.set(index, ItemStack.field_190927_a) : ItemStack.field_190927_a;
     }

     public static NBTTagCompound func_191282_a(NBTTagCompound p_191282_0_, NonNullList p_191282_1_) {
          return func_191281_a(p_191282_0_, p_191282_1_, true);
     }

     public static NBTTagCompound func_191281_a(NBTTagCompound p_191281_0_, NonNullList p_191281_1_, boolean p_191281_2_) {
     ...
     public static void func_191283_b(NBTTagCompound p_191283_0_, NonNullList p_191283_1_) {
