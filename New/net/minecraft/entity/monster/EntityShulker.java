...
public class EntityShulker extends EntityGolem implements IMob {
     ...
     protected static final DataParameter ATTACHED_FACE;
     protected static final DataParameter ATTACHED_BLOCK_POS;
     protected static final DataParameter PEEK_TICK;
     protected static final DataParameter field_190770_bw;
     ...
     public void writeEntityToNBT(NBTTagCompound compound) {
          ...
          compound.setByte("Color", (Byte)this.dataManager.get(field_190770_bw));
     ...
     public void onUpdate() {
          ...
          if (this.isRiding()) {
               ...
               if (iblockstate.getMaterial() != Material.AIR) {
                    ...
                    if (iblockstate.getBlock() == Blocks.PISTON_EXTENSION) {
                         enumfacing3 = (EnumFacing)iblockstate.getValue(BlockPistonBase.FACING);
                         ...
                         enumfacing3 = (EnumFacing)iblockstate.getValue(BlockPistonExtension.FACING);
                         if (this.world.isAirBlock(blockpos.offset(enumfacing3))) {
                              blockpos = blockpos.offset(enumfacing3);
                              this.dataManager.set(ATTACHED_BLOCK_POS, Optional.of(blockpos));
                         } else {
          ...
          if (blockpos != null) {
               ...
               double d3 = 0.5D - (double)MathHelper.sin((0.5F + this.peekAmount) * 3.1415927F) * 0.5D;
               double d4 = 0.5D - (double)MathHelper.sin((0.5F + this.prevPeekAmount) * 3.1415927F) * 0.5D;
               double d5 = d3 - d4;
               double d0 = 0.0D;
               double d1 = 0.0D;
               double d2 = 0.0D;
     ...
     public void setPosition(double x, double y, double z) {
          ...
          if (this.dataManager != null && this.ticksExisted != 0) {
               ...
               Optional optional1 = Optional.of(new BlockPos(x, y, z));
     ...
     public EnumDyeColor func_190769_dn() {
          return EnumDyeColor.byMetadata((Byte)this.dataManager.get(field_190770_bw));
     }

     static {
          COVERED_ARMOR_BONUS_MODIFIER = (new AttributeModifier(COVERED_ARMOR_BONUS_ID, "Covered armor bonus", 20.0D, 0)).setSaved(false);
     ...
     static class AIDefenseAttack extends EntityAINearestAttackableTarget {
          public AIDefenseAttack(EntityShulker shulker) {
               super(shulker, EntityLivingBase.class, 10, true, false, new Predicate() {
