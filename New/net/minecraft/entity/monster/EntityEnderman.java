...
public class EntityEnderman extends EntityMob {
     ...
     private static final Set CARRIABLE_BLOCKS;
     private static final DataParameter CARRIED_BLOCK;
     private static final DataParameter SCREAMING;
     ...
     public void readEntityFromNBT(NBTTagCompound compound) {
          ...
          if (compound.hasKey("carried", 8)) {
               iblockstate = Block.getBlockFromName(compound.getString("carried")).getStateFromMeta(compound.getShort("carriedData") & '\uffff');
          } else {
               iblockstate = Block.getBlockById(compound.getShort("carried")).getStateFromMeta(compound.getShort("carriedData") & '\uffff');
          }
     ...
     static {
          ATTACKING_SPEED_BOOST = (new AttributeModifier(ATTACKING_SPEED_BOOST_ID, "Attacking speed boost", 0.15000000596046448D, 0)).setSaved(false);
