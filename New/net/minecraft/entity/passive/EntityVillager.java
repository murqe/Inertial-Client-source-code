...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant {
     ...
     private static final DataParameter PROFESSION;
     ...
     private void populateBuyingList() {
          ...
          if (i >= 0 && i < aentityvillager$itradelist.length) {
               ...
               if (j >= 0 && j < aentityvillager$itradelist1.length) {
                    ...
                    EntityVillager.ITradeList[] var6 = aentityvillager$itradelist2;
                    int var7 = aentityvillager$itradelist2.length;

                    for(int var8 = 0; var8 < var7; ++var8) {
                         EntityVillager.ITradeList entityvillager$itradelist = var6[var8];
     ...
     static class PriceInfo extends Tuple {
          public PriceInfo(int p_i45810_1_, int p_i45810_2_) {
               ...
               if (p_i45810_2_ < p_i45810_1_) {
                    EntityVillager.field_190674_bx.warn("PriceRange({}, {}) invalid, {} smaller than {}", p_i45810_1_, p_i45810_2_, p_i45810_2_, p_i45810_1_);
               }
