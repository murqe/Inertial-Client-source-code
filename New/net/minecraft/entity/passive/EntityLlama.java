...
public class EntityLlama extends AbstractChestHorse implements IRangedAttackMob {
     private static final DataParameter field_190720_bG;
     private static final DataParameter field_190721_bH;
     private static final DataParameter field_190722_bI;
     ...
     public int func_190707_dL() {
          return (Integer)this.dataManager.get(field_190720_bG);
     }
     ...
     public int func_190719_dM() {
          return MathHelper.clamp((Integer)this.dataManager.get(field_190722_bI), 0, 3);
     }
     ...
     public EnumDyeColor func_190704_dO() {
          int i = (Integer)this.dataManager.get(field_190721_bH);
     ...
     static class AIDefendTarget extends EntityAINearestAttackableTarget {
