...
public abstract class AbstractHorse extends EntityAnimal implements IInventoryChangedListener, IJumpingMount {
     ...
     private static final DataParameter STATUS;
     private static final DataParameter OWNER_UNIQUE_ID;
     ...
     protected AbstractHorse getClosestHorse(Entity entityIn, double distance) {
          ...
          Entity entity = null;
          Iterator var7 = this.world.getEntitiesInAABBexcluding(entityIn, entityIn.getEntityBoundingBox().addCoord(distance, distance, distance), IS_HORSE_BREEDING).iterator();
