...
public class EntityParrot extends EntityShoulderRiding implements EntityFlying {
     private static final DataParameter field_192013_bG;
     private static final Predicate field_192014_bH;
     private static final Item field_192015_bI;
     private static final Set field_192016_bJ;
     private static final Int2ObjectMap field_192017_bK;
     ...
     private static boolean func_192006_b(World p_192006_0_, Entity p_192006_1_) {
          if (!p_192006_1_.isSilent() && p_192006_0_.rand.nextInt(50) == 0) {
               List list = p_192006_0_.getEntitiesWithinAABB(EntityLiving.class, p_192006_1_.getEntityBoundingBox().expandXyz(20.0D), field_192014_bH);
               if (!list.isEmpty()) {
                    EntityLiving entityliving = (EntityLiving)list.get(p_192006_0_.rand.nextInt(list.size()));
     ...
     private static SoundEvent func_192003_a(Random p_192003_0_) {
          if (p_192003_0_.nextInt(1000) == 0) {
               ...
               return func_191999_g((Integer)list.get(p_192003_0_.nextInt(list.size())));
          } else {
     ...
     public int func_191998_ds() {
          return MathHelper.clamp((Integer)this.dataManager.get(field_192013_bG), 0, 4);
     }
     ...
     static {
          ...
          field_192016_bJ = Sets.newHashSet(new Item[]{Items.WHEAT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.BEETROOT_SEEDS});
          field_192017_bK = new Int2ObjectOpenHashMap(32);
