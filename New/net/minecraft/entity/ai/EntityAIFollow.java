...
public class EntityAIFollow extends EntityAIBase {
     ...
     private final Predicate field_192373_b;
     ...
     public boolean shouldExecute() {
          List list = this.field_192372_a.world.getEntitiesWithinAABB(EntityLiving.class, this.field_192372_a.getEntityBoundingBox().expandXyz((double)this.field_192380_i), this.field_192373_b);
          if (!list.isEmpty()) {
               Iterator var2 = list.iterator();

               while(var2.hasNext()) {
                    EntityLiving entityliving = (EntityLiving)var2.next();
