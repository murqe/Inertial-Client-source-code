...
public class EntityFallingBlock extends Entity {
     ...
     protected static final DataParameter ORIGIN;
               ...
               if (!this.world.isRemote) {
                    ...
                    if (!this.onGround && !flag1) {
                         ...
                         if (iblockstate.getBlock() != Blocks.PISTON_EXTENSION) {
                              ...
                              } else if (this.world.func_190527_a(block, blockpos1, true, EnumFacing.UP, (Entity)null) && (flag1 || !BlockFalling.canFallThrough(this.world.getBlockState(blockpos1.down()))) && this.world.setBlockState(blockpos1, this.fallTile, 3)) {
                                   if (block instanceof BlockFalling) {
     ...
     public void fall(float distance, float damageMultiplier) {
          ...
          if (this.hurtEntities) {
               ...
               if (i > 0) {
                    List list = Lists.newArrayList(this.world.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox()));
