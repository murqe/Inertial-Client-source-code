...
public class EntityBoat extends Entity {
     private static final DataParameter TIME_SINCE_HIT;
     private static final DataParameter FORWARD_DIRECTION;
     private static final DataParameter DAMAGE_TAKEN;
     private static final DataParameter BOAT_TYPE;
     private static final DataParameter[] DATA_ID_PADDLE;
     ...
     protected void entityInit() {
          ...
          DataParameter[] var1 = DATA_ID_PADDLE;
          int var2 = var1.length;

          for(int var3 = 0; var3 < var2; ++var3) {
               DataParameter dataparameter = var1[var3];
     ...
     public void onUpdate() {
          ...
          for(int i = 0; i <= 1; ++i) {
               if (this.getPaddleState(i)) {
                    if (!this.isSilent() && (double)(this.paddlePositions[i] % 6.2831855F) <= 0.7853981633974483D && ((double)this.paddlePositions[i] + 0.39269909262657166D) % 6.283185307179586D >= 0.7853981633974483D) {
     ...
     public boolean getPaddleState(int p_184457_1_) {
          return (Boolean)this.dataManager.get(DATA_ID_PADDLE[p_184457_1_]) && this.getControllingPassenger() != null;
     }
     ...
     public EntityBoat.Type getBoatType() {
          return EntityBoat.Type.byId((Integer)this.dataManager.get(BOAT_TYPE));
     }
