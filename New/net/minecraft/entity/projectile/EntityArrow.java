...
public abstract class EntityArrow extends Entity implements IProjectile {
     private static final Predicate ARROW_TARGETS;
     private static final DataParameter CRITICAL;
     private int xTile;
     private int yTile;
     private int zTile;
     ...
     public void onUpdate() {
          ...
          if (this.inGround) {
               ...
               for(this.rotationPitch = (float)(MathHelper.atan2(this.motionY, (double)f4) * 57.29577951308232D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
               }
     ...
     static {
          ARROW_TARGETS = Predicates.and(new Predicate[]{EntitySelectors.NOT_SPECTATING, EntitySelectors.IS_ALIVE, new Predicate() {
