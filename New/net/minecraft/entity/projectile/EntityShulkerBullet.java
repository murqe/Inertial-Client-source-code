...
public class EntityShulkerBullet extends Entity {
     ...
     protected void readEntityFromNBT(NBTTagCompound compound) {
          ...
          if (compound.hasKey("Owner", 10)) {
               nbttagcompound1 = compound.getCompoundTag("Owner");
          ...
          if (compound.hasKey("Target", 10)) {
               nbttagcompound1 = compound.getCompoundTag("Target");
          ...
          if (!this.world.isRemote && this.world.getDifficulty() == EnumDifficulty.PEACEFUL) {
               ...
               if (!this.world.isRemote) {
                    ...
                    if (this.target == null && this.targetUniqueId != null) {
                         var1 = this.world.getEntitiesWithinAABB(EntityLivingBase.class, new AxisAlignedBB(this.targetBlockPos.add(-2, -2, -2), this.targetBlockPos.add(2, 2, 2))).iterator();

                         while(var1.hasNext()) {
                              entitylivingbase1 = (EntityLivingBase)var1.next();
                              if (entitylivingbase1.getUniqueID().equals(this.targetUniqueId)) {
                                   this.target = entitylivingbase1;
                                   break;
                              }
                         }
                    ...
                    if (this.owner == null && this.ownerUniqueId != null) {
                         var1 = this.world.getEntitiesWithinAABB(EntityLivingBase.class, new AxisAlignedBB(this.ownerBlockPos.add(-2, -2, -2), this.ownerBlockPos.add(2, 2, 2))).iterator();
