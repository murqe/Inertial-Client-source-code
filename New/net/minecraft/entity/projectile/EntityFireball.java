...
public abstract class EntityFireball extends Entity {
     ...
     public void readEntityFromNBT(NBTTagCompound compound) {
          ...
          if (compound.hasKey("power", 9)) {
               nbttaglist1 = compound.getTagList("power", 6);
               if (nbttaglist1.tagCount() == 3) {
                    this.accelerationX = nbttaglist1.getDoubleAt(0);
                    this.accelerationY = nbttaglist1.getDoubleAt(1);
                    this.accelerationZ = nbttaglist1.getDoubleAt(2);
               }
          }

          this.ticksAlive = compound.getInteger("life");
          if (compound.hasKey("direction", 9) && compound.getTagList("direction", 6).tagCount() == 3) {
               nbttaglist1 = compound.getTagList("direction", 6);
