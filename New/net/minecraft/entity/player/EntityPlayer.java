...
import wtf.rich.api.event.event.EventUpdateLiving;
...
public abstract class EntityPlayer extends EntityLivingBase {
     private static final DataParameter ABSORPTION;
     private static final DataParameter PLAYER_SCORE;
     protected static final DataParameter PLAYER_MODEL_FLAG;
     protected static final DataParameter MAIN_HAND;
     protected static final DataParameter field_192032_bt;
     protected static final DataParameter field_192033_bu;
     ...
     public void onUpdate() {
          this.noClip = Main.instance.featureDirector.getFeatureByClass(FreeCam.class).isToggled() || Main.instance.featureDirector.getFeatureByClass(NoClip.class).isToggled() || this.isSpectator();
     ...
     public float getArmorVisibility() {
          int i = 0;
          Iterator var2 = this.inventory.armorInventory.iterator();
               ...
               if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                         if (i > 0) {
                              ...
                              if (Main.instance.featureDirector.getFeatureByClass(KeepSprint.class).isToggled()) {
                         ...
                         if (flag3) {
                              ...
                              Iterator var23 = this.world.getEntitiesWithinAABB(EntityLivingBase.class, targetEntity.getEntityBoundingBox().expand(1.0D, 0.25D, 1.0D)).iterator();

                              while(var23.hasNext()) {
                                   EntityLivingBase entitylivingbase = (EntityLivingBase)var23.next();
     ...
     public EntityPlayer.SleepResult trySleep(BlockPos bedLocation) {
          ...
          if (!this.world.isRemote) {
               ...
               double d0 = 8.0D;
               double d1 = 5.0D;
               List list = this.world.getEntitiesWithinAABB(EntityMob.class, new AxisAlignedBB((double)bedLocation.getX() - 8.0D, (double)bedLocation.getY() - 5.0D, (double)bedLocation.getZ() - 8.0D, (double)bedLocation.getX() + 8.0D, (double)bedLocation.getY() + 5.0D, (double)bedLocation.getZ() + 8.0D), new EntityPlayer.SleepEnemyPredicate(this));
               if (!list.isEmpty()) {
     ...
     public ItemStack getEquipmentInSlot(int p_71124_1_) {
          return p_71124_1_ == 0 ? this.inventory.getCurrentItem() : (ItemStack)this.inventory.armorInventory.get(p_71124_1_ - 1);
     }
     ...
     public void func_192021_a(List p_192021_1_) {
     }
     ...
     public void addMovementStat(double p_71000_1_, double p_71000_3_, double p_71000_5_) {
          if (!this.isRiding()) {
               ...
               if (this.isInsideOfMaterial(Material.WATER)) {
                    k = Math.round(MathHelper.sqrt(p_71000_1_ * p_71000_1_ + p_71000_3_ * p_71000_3_ + p_71000_5_ * p_71000_5_) * 100.0F);
                    if (k > 0) {
                         this.addStat(StatList.DIVE_ONE_CM, k);
                         this.addExhaustion(0.01F * (float)k * 0.01F);
                    }
               } else if (this.isInWater()) {
                    k = Math.round(MathHelper.sqrt(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0F);
                    if (k > 0) {
                         this.addStat(StatList.SWIM_ONE_CM, k);
                         this.addExhaustion(0.01F * (float)k * 0.01F);
                    }
                    ...
                    k = Math.round(MathHelper.sqrt(p_71000_1_ * p_71000_1_ + p_71000_3_ * p_71000_3_ + p_71000_5_ * p_71000_5_) * 100.0F);
                    this.addStat(StatList.AVIATE_ONE_CM, k);
               } else {
                    k = Math.round(MathHelper.sqrt(p_71000_1_ * p_71000_1_ + p_71000_5_ * p_71000_5_) * 100.0F);
                    if (k > 25) {
                         this.addStat(StatList.FLY_ONE_CM, k);
                    }
               }
          }
     ...
     static class SleepEnemyPredicate implements Predicate {
          ...
          // $FF: synthetic method
          SleepEnemyPredicate(EntityPlayer x0, Object x1) {
               this(x0);
          }
     }
