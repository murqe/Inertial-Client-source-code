...
public class EntityPlayerMP extends EntityPlayer implements IContainerListener {
     ...
     public void onDeath(DamageSource cause) {
          ...
          Iterator var6 = this.world.getScoreboard().getObjectivesFromCriteria(IScoreCriteria.DEATH_COUNT).iterator();
     ...
     private Collection func_192038_E(Entity p_192038_1_) {
          ...
          if (scoreplayerteam != null) {
               ...
               if (i >= 0 && i < IScoreCriteria.KILLED_BY_TEAM.length) {
                    Iterator var5 = this.getWorldScoreboard().getObjectivesFromCriteria(IScoreCriteria.KILLED_BY_TEAM[i]).iterator();
