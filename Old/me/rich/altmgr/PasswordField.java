...
public class PasswordField extends Gui {
      ...
      public void drawTextBox() {
            if (this.func_73778_q()) {
                  if (this.getEnableBackgroundDrawing()) {
                        RenderUtil.drawRoundedRect1((double)this.xPos - 1.5D, (double)this.yPos - 1.5D, (double)(this.xPos + this.width), (double)(this.yPos + this.height) + 1.5D, 0, (new Color(180, 74, 74)).getRGB());
                        RenderUtil.drawRoundedRect1((double)(this.xPos - 1), (double)(this.yPos - 1), (double)(this.xPos + this.width) - 0.5D, (double)(this.yPos + this.height + 1), 0, (new Color(15, 15, 15, 255)).getRGB());
                  }
                  ...
                  if (var6) {
                        if (var10) {
                              Gui.drawRect((double)var11, (double)(var8 - 1), (double)(var11 + 1), (double)(var8 + 1 + Fonts.roboto_16.getHeight()), -3092272);
                        } else {
                              Minecraft.getMinecraft();
                  ...
                  if (var3 != var2) {
                        ...
                        this.drawCursorVertical(var11, var8 - 1, var12 - 1, var8 + 1 + Fonts.roboto_16.getHeight());
                  }
            }
      ...
      private void drawCursorVertical(int par1, int par2, int par3, int par4) {
            ...
            var7.pos((double)par1, (double)par4, 0.0D);
            var7.pos((double)par3, (double)par4, 0.0D);
            var7.pos((double)par3, (double)par2, 0.0D);
            var7.pos((double)par1, (double)par2, 0.0D);
            var7.finishDrawing();
            GL11.glDisable(3058);
            GL11.glEnable(3553);
      }
