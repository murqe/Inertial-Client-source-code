...
public class InventoryHelper {
                  ...
                  if (Minecraft.player.inventoryContainer.getSlot(i).getHasStack()) {
                        ...
                        if (item instanceof ItemPotion) {
                              ...
                              if (PotionUtils.getEffectsFromStack(is) != null) {
                                    Iterator var6 = PotionUtils.getEffectsFromStack(is).iterator();

                                    while(var6.hasNext()) {
                                          PotionEffect o = (PotionEffect)var6.next();
      ...
      private int getArmorDurability() {
            ...
            ItemStack itemStack;
            for(Iterator var2 = Minecraft.player.inventory.armorInventory.iterator(); var2.hasNext(); TotalDurability += itemStack.getItemDamage()) {
