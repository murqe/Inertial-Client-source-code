...
public class RedundantChanceTags implements IFixableData {
      ...
      public NBTTagCompound fixTagCompound(NBTTagCompound compound) {
            ...
            if (compound.hasKey("HandDropChances", 9)) {
                  nbttaglist1 = compound.getTagList("HandDropChances", 5);
                  if (nbttaglist1.tagCount() == 2 && nbttaglist1.getFloatAt(0) == 0.0F && nbttaglist1.getFloatAt(1) == 0.0F) {
                        compound.removeTag("HandDropChances");
                  }
            }

            if (compound.hasKey("ArmorDropChances", 9)) {
                  nbttaglist1 = compound.getTagList("ArmorDropChances", 5);
