...
public class PlayerChunkMap {
      ...
      private final Long2ObjectMap playerInstances = new Long2ObjectOpenHashMap(4096);
      private final Set playerInstancesToUpdate = Sets.newHashSet();
      private final List pendingSendToPlayers = Lists.newLinkedList();
      private final List playersNeedingChunks = Lists.newLinkedList();
      ...
      public Iterator getChunkIterator() {
            final Iterator iterator = this.playerInstanceList.iterator();
      ...
      public void tick() {
            ...
            if (this.sortMissingChunks && i % 4L == 0L) {
                  ...
                  Collections.sort(this.playersNeedingChunks, new Comparator() {
