...
public abstract class UserListEntryBan extends UserListEntry {
      ...
      public UserListEntryBan(Object valueIn, Date startDate, String banner, Date endDate, String banReason) {
            super(valueIn);
      ...
      protected UserListEntryBan(Object valueIn, JsonObject json) {
            super(valueIn, json);
