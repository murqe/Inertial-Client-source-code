      ...
      public void updateBlockRemoving() {
            ...
            if (this.receivedFinishDiggingPacket) {
                  ...
                  if (iblockstate.getMaterial() == Material.AIR) {
                        ...
                        f = iblockstate.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.world, this.delayedDestroyPos) * (float)(i + 1);
                        l = (int)(f * 10.0F);
                        if (l != this.durabilityRemainingOnBlock) {
                              this.theWorld.sendBlockBreakProgress(this.thisPlayerMP.getEntityId(), this.delayedDestroyPos, l);
                  ...
                  if (iblockstate1.getMaterial() == Material.AIR) {
                        ...
                        f = iblockstate1.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.world, this.delayedDestroyPos) * (float)(k + 1);
                        l = (int)(f * 10.0F);
                        if (l != this.durabilityRemainingOnBlock) {
