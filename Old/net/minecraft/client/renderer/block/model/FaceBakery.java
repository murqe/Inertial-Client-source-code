...
public class FaceBakery {
      ...
      public static EnumFacing getFacingFromVertexData(int[] faceData) {
            ...
            for(int var14 = 0; var14 < var13; ++var14) {
                  EnumFacing enumfacing1 = var12[var14];
      ...
      private void applyFacing(int[] p_178408_1_, EnumFacing p_178408_2_) {
            ...
            for(int j = 0; j < 4; ++j) {
                  j1 = i * j;
                  float f = Float.intBitsToFloat(aint[j1]);
                  float f1 = Float.intBitsToFloat(aint[j1 + 1]);
                  f2 = Float.intBitsToFloat(aint[j1 + 2]);
            ...
            for(j1 = 0; j1 < 4; ++j1) {
                  ...
                  for(int l = 0; l < 4; ++l) {
                        ...
                        if (MathHelper.epsilonEquals(f2, f5) && MathHelper.epsilonEquals(f3, f6) && MathHelper.epsilonEquals(f4, f7)) {
