...
public class DebugRendererCollisionBox implements DebugRenderer.IDebugRenderer {
      ...
      public void render(float p_190060_1_, long p_190060_2_) {
            Minecraft var10001 = this.field_191312_a;
            this.field_191313_b = Minecraft.player;
            ...
            Minecraft var10000 = this.field_191312_a;
            World world = Minecraft.player.world;
            List list = world.getCollisionBoxes(this.field_191313_b, this.field_191313_b.getEntityBoundingBox().expandXyz(6.0D));
