...
public class ItemRenderer {
      ...
      private void renderArm(EnumHandSide p_187455_1_) {
            TextureManager var10000 = this.mc.getTextureManager();
            Minecraft var10001 = this.mc;
            var10000.bindTexture(Minecraft.player.getLocationSkin());
            var10001 = this.mc;
      ...
      private void transformFirstPerson(EnumHandSide p_187453_1_, float p_187453_2_) {
            ...
            float g = (float)Main.settingsManager.getSettingByName("ItemSize").getValDouble();
            if (Main.moduleManager.getModule(Animations.class).isToggled()) {
                  GlStateManager.translate(Main.settingsManager.getSettingByName("ItemDistance").getValDouble(), -0.3700000047683716D, -0.41999995708465576D);
                  ...
                  if (Main.settingsManager.getSettingByName(Main.moduleManager.getModule(Animations.class), "RotateItem").getValBoolean()) {
                  }

                  GlStateManager.rotate(this.rotate, this.rotate, 0.0F, 0.0F);
                  ++this.rotate;
            } else {
                  GlStateManager.rotate((float)i * f1 * -20.0F, 0.0F, 0.0F, 1.0F);
                  GlStateManager.rotate(f1 * -80.0F, 1.0F, 0.0F, 0.0F);
      ...
      private void transformSideFirstPerson(EnumHandSide p_187459_1_, float p_187459_2_) {
            ...
            if (Main.moduleManager.getModule(ViewModel.class).isToggled()) {
                  boolean var4 = p_187459_1_ == EnumHandSide.RIGHT ? true : true;
            }
      ...
      public void renderItemInFirstPerson(float partialTicks) {
            ...
            if (flag) {
                  ...
                  if (!Reflector.ForgeHooksClient_renderSpecificFirstPersonHand.exists() || !Reflector.callBoolean(Reflector.ForgeHooksClient_renderSpecificFirstPersonHand, EnumHand.MAIN_HAND, partialTicks, f1, f4, f6, this.itemStackMainHand)) {
                  ...
                  if (p_187457_6_.func_190926_b()) {
                        ...
                        if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                              ...
                              case BOW:
                                    ...
                                    float var10000 = (float)p_187457_6_.getMaxItemUseDuration();
                                    Minecraft var10001 = this.mc;
                                    f5 = var10000 - ((float)Minecraft.player.getItemInUseCount() - p_187457_2_ + 1.0F);
                                    f6 = f5 / 20.0F;
      ...
      public void renderOverlays(float partialTicks) {
            ...
            if (Minecraft.player.isEntityInsideOpaqueBlock()) {
                  ...
                  if (iblockstate.getRenderType() != EnumBlockRenderType.INVISIBLE) {
                        ...
                        var15 = Reflector.ForgeEventFactory_renderBlockOverlay;
                        var10001 = new Object[5];
                        var10004 = this.mc;
                        var10001[0] = Minecraft.player;
                        var10001[1] = partialTicks;
                        var10001[2] = object;
                        var10001[3] = iblockstate;
                        var10001[4] = blockpos;
                        if (!Reflector.callBoolean(var15, var10001)) {
            ...
            if (!Minecraft.player.isSpectator()) {
                  ...
                  if (Minecraft.player.isInsideOfMaterial(Material.WATER)) {
                        var15 = Reflector.ForgeEventFactory_renderWaterOverlay;
                  ...
                  if (Minecraft.player.isBurning()) {
                        var15 = Reflector.ForgeEventFactory_renderFireOverlay;
                        var10001 = new Object[2];
                        var10004 = this.mc;
                        var10001[0] = Minecraft.player;
                        var10001[1] = partialTicks;
