...
public abstract class Render implements IEntityRenderer {
      ...
      protected void renderEntityName(Entity entityIn, double x, double y, double z, String name, double distanceSq) {
