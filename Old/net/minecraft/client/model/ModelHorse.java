...
public class ModelHorse extends ModelBase {
      ...
      public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
            ...
            float f10 = MathHelper.cos(p_78086_2_ * 0.6662F + 3.1415927F);
            ...
            this.frontLeftShin.rotateAngleX = (this.frontLeftLeg.rotateAngleX + 3.1415927F * Math.max(0.0F, 0.2F + f13 * 0.2F)) * f6 + (f11 + Math.max(0.0F, f10 * 0.5F * p_78086_3_)) * f7;
            this.frontLeftHoof.rotateAngleX = this.frontLeftShin.rotateAngleX;
            this.frontRightLeg.rotateAngleX = f15;
            this.frontRightShin.rotateAngleX = (this.frontRightLeg.rotateAngleX + 3.1415927F * Math.max(0.0F, 0.2F - f13 * 0.2F)) * f6 + (-f11 + Math.max(0.0F, -f10 * 0.5F * p_78086_3_)) * f7;
