...
public class Minecraft implements IThreadListener, ISnooperInfo {
      ...
      private void createDisplay() throws LWJGLException {
            ...
            StringBuilder var10000 = (new StringBuilder()).append("Loading ");
            Main var10001 = Main.instance;
            var10000 = var10000.append(Main.name).append(" ");
            var10001 = Main.instance;
            Display.setTitle(var10000.append(Main.version).toString());
      ...
      private void runGameLoop() throws IOException {
            ...
            this.mcSoundHandler.setListener(player, this.timer.elapsedPartialTicks);
            this.mcProfiler.endSection();
      ...
      public void clickMouse() {
            ...
            if (this.leftClickCounter <= 0) {
                  EventAttack mouseAttackEvent = new EventAttack(this.objectMouseOver.entityHit, true);
                  ...
                  if (this.objectMouseOver == null) {
                        ...
                        case ENTITY:
                              ...
                              if (Main.moduleManager.getModule(AntiBot.class).isToggled() && mode.equalsIgnoreCase("HitBefore")) {
                                    AntiBot.entete.add(this.objectMouseOver.entityHit);
                              }
                              break;
                        case BLOCK:
                              BlockPos blockpos = this.objectMouseOver.getBlockPos();
