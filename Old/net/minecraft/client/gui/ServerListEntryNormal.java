...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
      ...
      public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_) {
            ...
            Minecraft.fontRendererObj.drawString(this.server.serverName, p_192634_2_ + 32 + 3, p_192634_3_ + 1, 16777215);
            var10000 = this.mc;
            List list = Minecraft.fontRendererObj.listFormattedStringToWidth(this.server.serverMOTD, p_192634_4_ - 32 - 2);

            for(int i = 0; i < Math.min(list.size(), 2); ++i) {
                  var10000 = this.mc;
                  FontRenderer var25 = Minecraft.fontRendererObj;
                  String var10001 = (String)list.get(i);
                  int var10002 = p_192634_2_ + 32 + 3;
                  int var10003 = p_192634_3_ + 12;
                  Minecraft var10004 = this.mc;
                  var25.drawString(var10001, var10002, var10003 + Minecraft.fontRendererObj.FONT_HEIGHT * i, 8421504);
            }
            ...
            var10000 = this.mc;
            Minecraft.fontRendererObj.drawString(s2, p_192634_2_ + p_192634_4_ - j - 15 - 2, p_192634_3_ + 1, 8421504);
            int k = 0;
            String s = null;
            int l;
            String s1;
            ...
            Gui.drawModalRectWithCustomSizedTexture((float)(p_192634_2_ + p_192634_4_ - 15), (float)p_192634_3_, (float)(k * 10), (float)(176 + l * 8), 10, 8, 256.0F, 256.0F);
      ...
      protected void drawTextureAt(int p_178012_1_, int p_178012_2_, ResourceLocation p_178012_3_) {
            ...
            Gui.drawModalRectWithCustomSizedTexture((float)p_178012_1_, (float)p_178012_2_, 0.0F, 0.0F, 32, 32, 32.0F, 32.0F);
