      ...
      protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
            ...
            for(int k = 0; k < 3; ++k) {
                  ...
                  if (l >= 0 && i1 >= 0 && l < 108 && i1 < 19) {
                        ...
                        if (this.container.enchantItem(Minecraft.player, k)) {
            ...
            for(int l = 0; l < 3; ++l) {
                  ...
                  if (k1 == 0) {
                        ...
                        label66: {
                              ...
                              label54: {
                                    s = "" + k1;
                                    l1 = 86 - this.fontRendererObj.getStringWidth(s);
                                    s1 = EnchantmentNameParts.getInstance().generateNewRandomName(this.fontRendererObj, l1);
                                    fontrenderer = this.mc.standardGalacticFontRenderer;
                                    i2 = 6839882;
                                    if (k >= l + 1) {
                                          var10000 = this.mc;
                                          if (Minecraft.player.experienceLevel >= k1) {
                                                break label54;
                                          }
                                    }
