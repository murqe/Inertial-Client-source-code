...
public class GuiWorldEdit extends GuiScreen {
      ...
      public void drawScreen(int mouseX, int mouseY, float partialTicks) {
            ...
            drawCenteredString(this.fontRendererObj, I18n.format("selectWorld.edit.title"), this.width / 2, 20, 16777215);
            drawString(this.fontRendererObj, I18n.format("selectWorld.enterName"), this.width / 2 - 100, 47, 10526880);
