...
public class GuiSpectator extends Gui implements ISpectatorMenuRecipient {
      ...
      private void renderSlot(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_, ISpectatorMenuObject p_175266_5_) {
            ...
            if (p_175266_5_ != SpectatorMenu.EMPTY_SLOT) {
                  ...
                  if (i > 3 && p_175266_5_.isEnabled()) {
                        ...
                        int var10002 = p_175266_2_ + 19 - 2;
                        Minecraft var10003 = this.mc;
                        Minecraft.fontRendererObj.drawStringWithShadow(s, (float)(var10002 - Minecraft.fontRendererObj.getStringWidth(s)), p_175266_3_ + 6.0F + 3.0F, 16777215 + (i << 24));
                  }
            }
      ...
      public void renderSelectedItem(ScaledResolution p_175263_1_) {
            ...
            if (i > 3 && this.menu != null) {
                  ...
                  if (s != null) {
                        int var10000 = p_175263_1_.getScaledWidth();
                        Minecraft var10001 = this.mc;
                        int j = (var10000 - Minecraft.fontRendererObj.getStringWidth(s)) / 2;
                        int k = p_175263_1_.getScaledHeight() - 35;
                        GlStateManager.pushMatrix();
                        GlStateManager.enableBlend();
                        GlStateManager.tryBlendFuncSeparate(GlStateManager.SourceFactor.SRC_ALPHA, GlStateManager.DestFactor.ONE_MINUS_SRC_ALPHA, GlStateManager.SourceFactor.ONE, GlStateManager.DestFactor.ZERO);
                        Minecraft var7 = this.mc;
                        Minecraft.fontRendererObj.drawStringWithShadow(s, (float)j, (float)k, 16777215 + (i << 24));
                        GlStateManager.disableBlend();
                        GlStateManager.popMatrix();
                  }
            }
