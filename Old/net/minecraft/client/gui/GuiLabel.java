...
public class GuiLabel extends Gui {
      ...
      public void drawLabel(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                  ...
                  for(int k = 0; k < this.labels.size(); ++k) {
                        if (this.centered) {
                              drawCenteredString(this.fontRenderer, (String)this.labels.get(k), this.x + this.width / 2, j + k * 10, this.textColor);
                        } else {
                              drawString(this.fontRenderer, (String)this.labels.get(k), this.x, j + k * 10, this.textColor);
                        }
                  }
            }
      ...
      protected void drawLabelBackground(Minecraft mcIn, int p_146160_2_, int p_146160_3_) {
            if (this.labelBgEnabled) {
                  ...
                  drawRect((double)k, (double)l, (double)(k + i), (double)(l + j), this.backColor);
