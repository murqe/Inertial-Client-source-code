...
public class RecipeBookPage {
      private List field_193743_h = Lists.newArrayListWithCapacity(20);
      ...
      private List field_193757_v = Lists.newArrayList();
      private List field_194203_f;
      ...
      public void func_194194_a(Minecraft p_194194_1_, int p_194194_2_, int p_194194_3_) {
            ...
            this.field_194204_k = Minecraft.player.func_192035_E();
      ...
      public void func_194192_a(List p_194192_1_, boolean p_194192_2_) {
      ...
      public void func_194191_a(int p_194191_1_, int p_194191_2_, int p_194191_3_, int p_194191_4_, float p_194191_5_) {
            if (this.field_193737_b > 1) {
                  ...
                  Minecraft var10000 = this.field_193754_s;
                  int i = Minecraft.fontRendererObj.getStringWidth(s);
                  var10000 = this.field_193754_s;
                  Minecraft.fontRendererObj.drawString(s, p_194191_1_ - i / 2 + 73, p_194191_2_ + 141, -1);
            }
            ...
            while(var8.hasNext()) {
                  GuiButtonRecipe guibuttonrecipe = (GuiButtonRecipe)var8.next();
      ...
      public boolean func_194196_a(int p_194196_1_, int p_194196_2_, int p_194196_3_, int p_194196_4_, int p_194196_5_, int p_194196_6_, int p_194196_7_) {
            ...
            if (this.field_194202_c.func_191839_a()) {
                  ...
                  do {
                        ...
                        guibuttonrecipe = (GuiButtonRecipe)var8.next();
                  } while(!guibuttonrecipe.mousePressed(this.field_193754_s, p_194196_1_, p_194196_2_));
      ...
      public void func_194195_a(List p_194195_1_) {
