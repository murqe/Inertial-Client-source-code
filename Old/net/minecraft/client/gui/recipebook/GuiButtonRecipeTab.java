...
public class GuiButtonRecipeTab extends GuiButtonToggle {
      ...
      public void func_193918_a(Minecraft p_193918_1_) {
            ...
            Iterator var3 = ((List)RecipeBookClient.field_194086_e.get(this.field_193921_u)).iterator();

            while(var3.hasNext()) {
                  RecipeList recipelist = (RecipeList)var3.next();
      ...
      public boolean func_193919_e() {
            List list = (List)RecipeBookClient.field_194086_e.get(this.field_193921_u);
            this.visible = false;
            Iterator var2 = list.iterator();

            while(var2.hasNext()) {
                  RecipeList recipelist = (RecipeList)var2.next();
