...
public class GuiStats extends GuiScreen implements IProgressMeter {
      ...
      public void drawScreen(int mouseX, int mouseY, float partialTicks) {
            if (this.doesGuiPauseGame) {
                  ...
                  drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats"), this.width / 2, this.height / 2, 16777215);
                  drawCenteredString(this.fontRendererObj, LOADING_STRINGS[(int)(Minecraft.getSystemTime() / 150L % (long)LOADING_STRINGS.length)], this.width / 2, this.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
            } else {
      ...
      class StatsMobsList extends GuiSlot {
            ...
            public StatsMobsList(Minecraft p_i47551_2_) {
                  ...
                  while(true) {
                        ...
                        } while(GuiStats.this.stats.readStat(entitylist$entityegginfo.killEntityStat) <= 0 && GuiStats.this.stats.readStat(entitylist$entityegginfo.entityKilledByStat) <= 0);
            ...
            protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
                  EntityList.EntityEggInfo entitylist$entityegginfo = (EntityList.EntityEggInfo)this.mobs.get(p_192637_1_);
                  ...
                  GuiStats.drawString(GuiStats.this.fontRendererObj, s, p_192637_2_ + 2 - 10, p_192637_3_ + 1, 16777215);
                  var10000 = GuiStats.this;
                  GuiStats.drawString(GuiStats.this.fontRendererObj, s1, p_192637_2_ + 2, p_192637_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT, i == 0 ? 6316128 : 9474192);
                  var10000 = GuiStats.this;
                  GuiStats.drawString(GuiStats.this.fontRendererObj, s2, p_192637_2_ + 2, p_192637_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT * 2, j == 0 ? 6316128 : 9474192);
            }
      }
      ...
      class StatsItem extends GuiStats.Stats {
            public StatsItem(Minecraft p_i47552_2_) {
                  ...
                  Iterator var3 = StatList.USE_ITEM_STATS.iterator();
      ...
      class StatsGeneral extends GuiSlot {
            ...
            protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
                  StatBase statbase = (StatBase)StatList.BASIC_STATS.get(p_192637_1_);
                  GuiStats var10000 = GuiStats.this;
                  GuiStats.drawString(GuiStats.this.fontRendererObj, statbase.getStatName().getUnformattedText(), p_192637_2_ + 2, p_192637_3_ + 1, p_192637_1_ % 2 == 0 ? 16777215 : 9474192);
                  String s = statbase.format(GuiStats.this.stats.readStat(statbase));
                  var10000 = GuiStats.this;
                  GuiStats.drawString(GuiStats.this.fontRendererObj, s, p_192637_2_ + 2 + 213 - GuiStats.this.fontRendererObj.getStringWidth(s), p_192637_3_ + 1, p_192637_1_ % 2 == 0 ? 16777215 : 9474192);
            }
      }
      ...
      class StatsBlock extends GuiStats.Stats {
            public StatsBlock(Minecraft p_i47554_2_) {
                  super(p_i47554_2_);
                  this.statsHolder = Lists.newArrayList();
                  Iterator var3 = StatList.MINE_BLOCK_STATS.iterator();
      ...
      abstract class Stats extends GuiSlot {
            ...
            protected void renderStat(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
                  ...
                  String s;
                  if (p_148209_1_ != null) {
                        s = p_148209_1_.format(GuiStats.this.stats.readStat(p_148209_1_));
                        var10000 = GuiStats.this;
                        GuiStats.drawString(GuiStats.this.fontRendererObj, s, p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth(s), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
                  } else {
                        s = "-";
                        var10000 = GuiStats.this;
                        GuiStats.drawString(GuiStats.this.fontRendererObj, "-", p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth("-"), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
                  }
