...
public class GuiPlayerTabOverlay extends Gui {
      ...
      public void renderPlayerlist(int width, Scoreboard scoreboardIn, @Nullable ScoreObjective scoreObjectiveIn) {
            ...
            while(var8.hasNext()) {
                  ...
                  var10000 = this.mc;
                  j4 = Minecraft.fontRendererObj.getStringWidth(this.getPlayerName(networkplayerinfo));
                  i = Math.max(i, j4);
            ...
            if (this.footer != null) {
                  ...
                  for(var37 = list2.iterator(); var37.hasNext(); l1 = Math.max(l1, Minecraft.fontRendererObj.getStringWidth(s3))) {
                        s3 = (String)var37.next();
                        var10001 = this.mc;
                  }
            }
            ...
            double var35;
            if (list1 != null) {
                  var34 = (double)(width / 2 - l1 / 2 - 1);
                  var35 = (double)(k1 - 1);
                  var10002 = (double)(width / 2 + l1 / 2 + 1);
                  var10004 = list1.size();
                  var10005 = this.mc;
                  drawRect(var34, var35, var10002, (double)(k1 + var10004 * Minecraft.fontRendererObj.FONT_HEIGHT), Integer.MIN_VALUE);

                  for(var37 = list1.iterator(); var37.hasNext(); k1 += Minecraft.fontRendererObj.FONT_HEIGHT) {
                        s3 = (String)var37.next();
                        var10000 = this.mc;
            ...
            if (list2 != null) {
                  ...
                  for(var37 = list2.iterator(); var37.hasNext(); k1 += Minecraft.fontRendererObj.FONT_HEIGHT) {
                        s3 = (String)var37.next();
                        var10000 = this.mc;
                        j5 = Minecraft.fontRendererObj.getStringWidth(s3);
                        var10000 = this.mc;
