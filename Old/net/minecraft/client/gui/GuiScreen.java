...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
      ...
      public List func_191927_a(ItemStack p_191927_1_) {
            ...
            List list = p_191927_1_.getTooltip(Minecraft.player, this.mc.gameSettings.advancedItemTooltips ? ITooltipFlag.TooltipFlags.ADVANCED : ITooltipFlag.TooltipFlags.NORMAL);
      ...
      protected void handleComponentHover(ITextComponent component, int x, int y) {
            if (component != null && component.getStyle().getHoverEvent() != null) {
                  ...
                  if (hoverevent.getAction() == HoverEvent.Action.SHOW_ITEM) {
                        ...
                        Minecraft var10001 = this.mc;
                        this.drawHoveringText(Minecraft.fontRendererObj.listFormattedStringToWidth(hoverevent.getValue().getFormattedText(), Math.max(this.width / 2, 200)), x, y);
                  }
