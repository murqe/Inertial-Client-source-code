...
public class GuiEditStructure extends GuiScreen {
      ...
      public void drawScreen(int mouseX, int mouseY, float partialTicks) {
            ...
            drawCenteredString(this.fontRendererObj, I18n.format("tile.structureBlock.name"), this.width / 2, 10, 16777215);
            if (tileentitystructure$mode != TileEntityStructure.Mode.DATA) {
                  drawString(this.fontRendererObj, I18n.format("structure_block.structure_name"), this.width / 2 - 153, 30, 10526880);
            ...
            if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD || tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
                  drawString(this.fontRendererObj, I18n.format("structure_block.position"), this.width / 2 - 153, 70, 10526880);
                  ...
                  drawString(this.fontRendererObj, s4, this.width / 2 + 154 - l, 150, 10526880);
            }

            if (tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
                  drawString(this.fontRendererObj, I18n.format("structure_block.size"), this.width / 2 - 153, 110, 10526880);
                  this.sizeXEdit.drawTextBox();
                  this.sizeYEdit.drawTextBox();
                  this.sizeZEdit.drawTextBox();
                  s4 = I18n.format("structure_block.detect_size");
                  l = this.fontRendererObj.getStringWidth(s4);
                  drawString(this.fontRendererObj, s4, this.width / 2 + 154 - l, 110, 10526880);
                  String s1 = I18n.format("structure_block.show_air");
                  int j = this.fontRendererObj.getStringWidth(s1);
                  drawString(this.fontRendererObj, s1, this.width / 2 + 154 - j, 70, 10526880);
            }

            if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD) {
                  drawString(this.fontRendererObj, I18n.format("structure_block.integrity"), this.width / 2 - 153, 110, 10526880);
                  this.integrityEdit.drawTextBox();
                  this.seedEdit.drawTextBox();
                  s4 = I18n.format("structure_block.show_boundingbox");
                  l = this.fontRendererObj.getStringWidth(s4);
                  drawString(this.fontRendererObj, s4, this.width / 2 + 154 - l, 70, 10526880);
            }

            if (tileentitystructure$mode == TileEntityStructure.Mode.DATA) {
                  drawString(this.fontRendererObj, I18n.format("structure_block.custom_data"), this.width / 2 - 153, 110, 10526880);
                  this.dataEdit.drawTextBox();
            }

            s4 = "structure_block.mode_info." + tileentitystructure$mode.getName();
            drawString(this.fontRendererObj, I18n.format(s4), this.width / 2 - 153, 174, 10526880);
