...
public class GuiNewChat extends Gui {
                              ...
                              if (chatline != null) {
                                    ...
                                    if (j1 < 200 || flag) {
                                          ...
                                          if (l1 > 3) {
                                                ...
                                                var10000 = this.mc;
                                                Minecraft.fontRendererObj.drawStringWithShadow(s, 0.0F, (float)(j2 - 8), 16777215 + (l1 << 24));
      ...
      public void printChatMessage(ITextComponent chatComponent) {
            if (!chatComponent.getUnformattedText().contains(".vclip") && !chatComponent.getUnformattedText().contains(".hclip") && !chatComponent.getUnformattedText().contains(".config")) {
                  this.printChatMessageWithOptionalDeletion(chatComponent, 0);
                  EventChatMessage event = new EventChatMessage(chatComponent.getUnformattedText());
                  event.call();
            }
      }
