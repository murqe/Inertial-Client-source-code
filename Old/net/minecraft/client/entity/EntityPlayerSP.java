...
import me.rich.event.events.EventPostMotionUpdate;
...
public class EntityPlayerSP extends AbstractClientPlayer {
      ...
      public void onUpdate() {
            ...
            if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
                  ...
                  if (this.isRiding()) {
                        ...
                        if (!Main.moduleManager.getModule(FreeCam.class).isToggled()) {
      ...
      public void sendChatMessage(String message) {
            ...
            if (args[0].equalsIgnoreCase(".hclip")) {
                  try {
                        if (args[1].equals("+")) {
                              Minecraft.player.setPosition(x - Math.sin(yaw) * Double.parseDouble(args[2]), y, z + Math.cos(yaw) * Double.parseDouble(args[2]));
                        }
            ...
            if (args[0].equalsIgnoreCase(".config")) {
                  try {
                        if (args[1].equals("save")) {
                              Main.config.save();
                              Main.msg("config succesfully saved.");
                        }

                        if (args[1].equals("load")) {
                              Main.config.load();
                              Main.msg("config succesfully loaded.");
                        }
                  } catch (Exception var12) {
                        Main.msg("incorrect text.");
                  }
            }
      ...
      public LPositionHelper getLocation() {
            if (this.location == null) {
                  this.location = new LPositionHelper(this.posX, this.posY, this.posZ, this.onGround);
            }

            this.location.setX(this.posX);
            this.location.setY(this.posY);
            this.location.setZ(this.posZ);
            this.location.setOnGround(this.onGround);
      ...
      protected boolean pushOutOfBlocks(double x, double y, double z) {
            if (!Main.moduleManager.getModule(NoPush.class).isToggled() && !Main.settingsManager.getSettingByName("Blocks").getValBoolean()) {
                  Main var10000 = Main.instance;
                  if (!Main.moduleManager.getModule(FreeCam.class).isToggled()) {
      ...
      public void onLivingUpdate() {
            ...
            if (this.isHandActive() && !this.isRiding()) {
                  ...
                  MovementInput.moveStrafe = (float)((double)MovementInput.moveStrafe * (Main.moduleManager.getModule(NoSlowDown.class).isToggled() ? Main.settingsManager.getSettingByName("CustomSpeed").getValDouble() / 100.0D : 0.20000000298023224D));
                  var10000 = this.movementInput;
                  MovementInput.field_192832_b = (float)((double)MovementInput.field_192832_b * (Main.moduleManager.getModule(NoSlowDown.class).isToggled() ? Main.settingsManager.getSettingByName("CustomSpeed").getValDouble() / 100.0D : 0.20000000298023224D));
            ...
            if (this.onGround && !flag1 && !flag2) {
                  var10000 = this.movementInput;
                  if (MovementInput.field_192832_b >= 0.8F && !this.isSprinting() && flag4 && !this.isHandActive() && !this.isPotionActive(MobEffects.BLINDNESS)) {
            ...
            if (!this.isSprinting()) {
                  var10000 = this.movementInput;
                  if (MovementInput.field_192832_b >= 0.8F && flag4 && !this.isHandActive() && !this.isPotionActive(MobEffects.BLINDNESS) && this.mc.gameSettings.keyBindSprint.isKeyDown()) {
                        this.setSprinting(true);
                  }
            }
            ...
            if (this.isSprinting()) {
                  var10000 = this.movementInput;
                  if (MovementInput.field_192832_b < 0.8F || this.isCollidedHorizontally || !flag4) {
            ...
            if (this.capabilities.isFlying && this.isCurrentViewEntity()) {
                  if (this.movementInput.sneak) {
                        ...
                        var10000 = this.movementInput;
                        var10000 = this.movementInput;
                        MovementInput.field_192832_b = (float)((double)MovementInput.field_192832_b / 0.3D);
      ...
      public boolean killaurachecks() {
            return this.isInLava() || this.isInWater() || this.isOnLadder() || this.isInWeb;
      }
}
