...
public class Particle {
      ...
      public void moveEntity(double x, double y, double z) {
            double d0 = y;
            if (this.canCollide) {
                  List list = this.worldObj.getCollisionBoxes((Entity)null, this.getEntityBoundingBox().addCoord(x, y, z));

                  Iterator var10;
                  AxisAlignedBB axisalignedbb2;
                  for(var10 = list.iterator(); var10.hasNext(); y = axisalignedbb2.calculateYOffset(this.getEntityBoundingBox(), y)) {
                        axisalignedbb2 = (AxisAlignedBB)var10.next();
                  }

                  this.setEntityBoundingBox(this.getEntityBoundingBox().offset(0.0D, y, 0.0D));

                  for(var10 = list.iterator(); var10.hasNext(); x = axisalignedbb2.calculateXOffset(this.getEntityBoundingBox(), x)) {
                        axisalignedbb2 = (AxisAlignedBB)var10.next();
                  }

                  this.setEntityBoundingBox(this.getEntityBoundingBox().offset(x, 0.0D, 0.0D));

                  for(var10 = list.iterator(); var10.hasNext(); z = axisalignedbb2.calculateZOffset(this.getEntityBoundingBox(), z)) {
                        axisalignedbb2 = (AxisAlignedBB)var10.next();
                  }
