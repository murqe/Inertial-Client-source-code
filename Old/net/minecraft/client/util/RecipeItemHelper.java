...
public class RecipeItemHelper {
      ...
      public static ItemStack func_194115_b(int p_194115_0_) {
            return p_194115_0_ == 0 ? ItemStack.field_190927_a : new ItemStack(Item.getItemById(p_194115_0_ >> 16 & '\uffff'), 1, p_194115_0_ & '\uffff');
      }
      ...
      class RecipePicker {
            ...
            private final List field_194106_c = Lists.newArrayList();
                  ...
                  for(int l = 0; l < k; ++l) {
                        if (RecipeItemHelper.this.field_194124_a.get(this.field_194108_e[l]) >= p_194098_1_) {
                              ...
                              while(!this.field_194111_h.isEmpty()) {
                                    ...
                                    int i2;
                                    for(i2 = 0; i2 < k1; ++i2) {
                                          if (!this.func_194101_b(flag, i2) && this.func_194093_a(flag, j1, i2) && this.func_194100_b(flag, j1, i2)) {
                                                this.func_194088_a(flag, i2);
                                                break;
                                          }
                                    }

                                    i2 = this.field_194111_h.size();
                                    if (i2 == i1) {
