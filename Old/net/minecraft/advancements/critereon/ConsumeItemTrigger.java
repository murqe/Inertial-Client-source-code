...
public class ConsumeItemTrigger implements ICriterionTrigger {
      private static final ResourceLocation field_193149_a = new ResourceLocation("consume_item");
      private final Map field_193150_b = Maps.newHashMap();
      ...
      static class Listeners {
            ...
            private final Set field_193242_b = Sets.newHashSet();
            ...
            public void func_193239_a(ICriterionTrigger.Listener p_193239_1_) {
            ...
            public void func_193240_a(ItemStack p_193240_1_) {
                  ...
                  while(var3.hasNext()) {
                        ...
                        if (((ConsumeItemTrigger.Instance)listener1.func_192158_a()).func_193193_a(p_193240_1_)) {
                              if (list == null) {
