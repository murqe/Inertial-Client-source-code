...
public class EnchantedItemTrigger implements ICriterionTrigger {
      private static final ResourceLocation field_192191_a = new ResourceLocation("enchanted_item");
      private final Map field_192192_b = Maps.newHashMap();
      ...
      static class Listeners {
            ...
            private final Set field_192462_b = Sets.newHashSet();
            ...
            public void func_192460_a(ICriterionTrigger.Listener p_192460_1_) {
                  this.field_192462_b.add(p_192460_1_);
            }

            public void func_192457_b(ICriterionTrigger.Listener p_192457_1_) {
            ...
            public void func_192459_a(ItemStack p_192459_1_, int p_192459_2_) {
                  ...
                  while(var4.hasNext()) {
                        ...
                        if (((EnchantedItemTrigger.Instance)listener1.func_192158_a()).func_192257_a(p_192459_1_, p_192459_2_)) {
                              if (list == null) {
      ...
      public static class Instance extends AbstractCriterionInstance {
            ...
            public boolean func_192257_a(ItemStack p_192257_1_, int p_192257_2_) {
                  return !this.field_192258_a.func_192493_a(p_192257_1_) ? false : this.field_192259_b.func_192514_a((float)p_192257_2_);
            }
      }
}
