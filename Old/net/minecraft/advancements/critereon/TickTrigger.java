...
public class TickTrigger implements ICriterionTrigger {
      public static final ResourceLocation field_193183_a = new ResourceLocation("tick");
      private final Map field_193184_b = Maps.newHashMap();
      ...
      static class Listeners {
            ...
            private final Set field_193505_b = Sets.newHashSet();
            ...
            public void func_193502_a(ICriterionTrigger.Listener p_193502_1_) {
                  this.field_193505_b.add(p_193502_1_);
            }

            public void func_193500_b(ICriterionTrigger.Listener p_193500_1_) {
            ...
            public void func_193503_b() {
                  ...
                  while(var1.hasNext()) {
                        ICriterionTrigger.Listener listener = (ICriterionTrigger.Listener)var1.next();
