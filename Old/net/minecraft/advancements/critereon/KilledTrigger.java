...
public class KilledTrigger implements ICriterionTrigger {
      private final Map field_192213_a = Maps.newHashMap();
      ...
      static class Listeners {
            ...
            private final Set field_192506_b = Sets.newHashSet();
            ...
            public void func_192504_a(ICriterionTrigger.Listener p_192504_1_) {
                  this.field_192506_b.add(p_192504_1_);
            }

            public void func_192501_b(ICriterionTrigger.Listener p_192501_1_) {
            ...
            public void func_192503_a(EntityPlayerMP p_192503_1_, Entity p_192503_2_, DamageSource p_192503_3_) {
                  ...
                  while(var5.hasNext()) {
                        ...
                        if (((KilledTrigger.Instance)listener1.func_192158_a()).func_192270_a(p_192503_1_, p_192503_2_, p_192503_3_)) {
                              if (list == null) {
