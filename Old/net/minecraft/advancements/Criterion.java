...
public class Criterion {
      ...
      public static Map func_192144_b(JsonObject p_192144_0_, JsonDeserializationContext p_192144_1_) {
            Map map = Maps.newHashMap();
            Iterator var3 = p_192144_0_.entrySet().iterator();

            while(var3.hasNext()) {
                  Entry entry = (Entry)var3.next();
                  map.put(entry.getKey(), func_192145_a(JsonUtils.getJsonObject((JsonElement)entry.getValue(), "criterion"), p_192144_1_));
            }

            return map;
      }

      public static Map func_192142_c(PacketBuffer p_192142_0_) {
            Map map = Maps.newHashMap();
      ...
      public static void func_192141_a(Map p_192141_0_, PacketBuffer p_192141_1_) {
            p_192141_1_.writeVarIntToBuffer(p_192141_0_.size());
            Iterator var2 = p_192141_0_.entrySet().iterator();

            while(var2.hasNext()) {
                  Entry entry = (Entry)var2.next();
                  p_192141_1_.writeString((String)entry.getKey());
