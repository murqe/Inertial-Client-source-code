...
public class SPacketChunkData implements Packet {
      ...
      public SPacketChunkData(Chunk p_i47124_1_, int p_i47124_2_) {
            ...
            Iterator var4 = p_i47124_1_.getTileEntityMap().entrySet().iterator();
            ...
            while(true) {
                  ...
                  do {
                        ...
                        i = blockpos.getY() >> 4;
                  } while(!this.doChunkLoad() && (p_i47124_2_ & 1 << i) == 0);
      ...
      public void writePacketData(PacketBuffer buf) throws IOException {
            ...
            while(var2.hasNext()) {
                  NBTTagCompound nbttagcompound = (NBTTagCompound)var2.next();
