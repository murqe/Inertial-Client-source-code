...
public class SPacketMaps implements Packet {
      ...
      public SPacketMaps(int mapIdIn, byte mapScaleIn, boolean trackingPositionIn, Collection iconsIn, byte[] p_i46937_5_, int minXIn, int minZIn, int columnsIn, int rowsIn) {
            this.mapId = mapIdIn;
