      ...
      public void onUpdateNavigation() {
            ...
            if (!this.noPath()) {
                  ...
                  if (this.canNavigate()) {
                        ...
                        vec3d1 = this.currentPath.getVectorFromIndex(this.theEntity, this.currentPath.getCurrentPathIndex());
                        if (MathHelper.floor(this.theEntity.posX) == MathHelper.floor(vec3d1.xCoord) && MathHelper.floor(this.theEntity.posY) == MathHelper.floor(vec3d1.yCoord) && MathHelper.floor(this.theEntity.posZ) == MathHelper.floor(vec3d1.zCoord)) {
                  ...
                  this.func_192876_m();
                  if (!this.noPath()) {
                        vec3d1 = this.currentPath.getPosition(this.theEntity);
