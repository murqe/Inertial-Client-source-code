...
public class StructureStrongholdPieces {
      ...
      public static void prepareStructurePieces() {
            ...
            StructureStrongholdPieces.PieceWeight[] var0 = PIECE_WEIGHTS;
            int var1 = var0.length;

            for(int var2 = 0; var2 < var1; ++var2) {
                  StructureStrongholdPieces.PieceWeight structurestrongholdpieces$pieceweight = var0[var2];
      ...
      private static boolean canAddStructurePieces() {
            ...
            StructureStrongholdPieces.PieceWeight structurestrongholdpieces$pieceweight;
            for(Iterator var1 = structurePieceList.iterator(); var1.hasNext(); totalWeight += structurestrongholdpieces$pieceweight.pieceWeight) {
                  structurestrongholdpieces$pieceweight = (StructureStrongholdPieces.PieceWeight)var1.next();
      ...
      private static StructureStrongholdPieces.Stronghold findAndCreatePieceFactory(Class clazz, List p_175954_1_, Random p_175954_2_, int p_175954_3_, int p_175954_4_, int p_175954_5_, @Nullable EnumFacing p_175954_6_, int p_175954_7_) {
            ...
            return (StructureStrongholdPieces.Stronghold)structurestrongholdpieces$stronghold;
      }

      private static StructureStrongholdPieces.Stronghold generatePieceFromSmallDoor(StructureStrongholdPieces.Stairs2 p_175955_0_, List p_175955_1_, Random p_175955_2_, int p_175955_3_, int p_175955_4_, int p_175955_5_, EnumFacing p_175955_6_, int p_175955_7_) {
            if (!canAddStructurePieces()) {
                  ...
                  while(j < 5) {
                        ...
                        while(var10.hasNext()) {
                              StructureStrongholdPieces.PieceWeight structurestrongholdpieces$pieceweight = (StructureStrongholdPieces.PieceWeight)var10.next();
      ...
      private static StructureComponent generateAndAddPiece(StructureStrongholdPieces.Stairs2 p_175953_0_, List p_175953_1_, Random p_175953_2_, int p_175953_3_, int p_175953_4_, int p_175953_5_, @Nullable EnumFacing p_175953_6_, int p_175953_7_) {
            if (p_175953_7_ > 50) {
                  return null;
      ...
      public static class Straight extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureStrongholdPieces.Straight createPiece(List p_175862_0_, Random p_175862_1_, int p_175862_2_, int p_175862_3_, int p_175862_4_, EnumFacing p_175862_5_, int p_175862_6_) {
      ...
      public static class StairsStraight extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureStrongholdPieces.StairsStraight createPiece(List p_175861_0_, Random p_175861_1_, int p_175861_2_, int p_175861_3_, int p_175861_4_, EnumFacing p_175861_5_, int p_175861_6_) {
      ...
      public static class Stairs extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureStrongholdPieces.Stairs createPiece(List p_175863_0_, Random p_175863_1_, int p_175863_2_, int p_175863_3_, int p_175863_4_, EnumFacing p_175863_5_, int p_175863_6_) {
      ...
      public static class RoomCrossing extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureStrongholdPieces.RoomCrossing createPiece(List p_175859_0_, Random p_175859_1_, int p_175859_2_, int p_175859_3_, int p_175859_4_, EnumFacing p_175859_5_, int p_175859_6_) {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
                  if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
                        ...
                        case 1:
                              for(l = 0; l < 5; ++l) {
                                    this.setBlockState(worldIn, Blocks.STONEBRICK.getDefaultState(), 3, 1, 3 + l, structureBoundingBoxIn);
                                    this.setBlockState(worldIn, Blocks.STONEBRICK.getDefaultState(), 7, 1, 3 + l, structureBoundingBoxIn);
                                    this.setBlockState(worldIn, Blocks.STONEBRICK.getDefaultState(), 3 + l, 1, 3, structureBoundingBoxIn);
                                    this.setBlockState(worldIn, Blocks.STONEBRICK.getDefaultState(), 3 + l, 1, 7, structureBoundingBoxIn);
                              }
                        ...
                        case 2:
                              for(l = 1; l <= 9; ++l) {
                                    this.setBlockState(worldIn, Blocks.COBBLESTONE.getDefaultState(), 1, 3, l, structureBoundingBoxIn);
                                    this.setBlockState(worldIn, Blocks.COBBLESTONE.getDefaultState(), 9, 3, l, structureBoundingBoxIn);
                              }

                              for(l = 1; l <= 9; ++l) {
                                    this.setBlockState(worldIn, Blocks.COBBLESTONE.getDefaultState(), l, 3, 1, structureBoundingBoxIn);
                                    this.setBlockState(worldIn, Blocks.COBBLESTONE.getDefaultState(), l, 3, 9, structureBoundingBoxIn);
                              }
      ...
      public static class Prison extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureStrongholdPieces.Prison createPiece(List p_175860_0_, Random p_175860_1_, int p_175860_2_, int p_175860_3_, int p_175860_4_, EnumFacing p_175860_5_, int p_175860_6_) {
      ...
      public static class PortalRoom extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureStrongholdPieces.PortalRoom createPiece(List p_175865_0_, Random p_175865_1_, int p_175865_2_, int p_175865_3_, int p_175865_4_, EnumFacing p_175865_5_, int p_175865_6_) {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
                  ...
                  int i1;
                  for(i1 = 3; i1 < 14; i1 += 2) {
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, i1, 0, 4, i1, Blocks.IRON_BARS.getDefaultState(), Blocks.IRON_BARS.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 10, 3, i1, 10, 4, i1, Blocks.IRON_BARS.getDefaultState(), Blocks.IRON_BARS.getDefaultState(), false);
                  }
      ...
      public static class Library extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureStrongholdPieces.Library createPiece(List p_175864_0_, Random p_175864_1_, int p_175864_2_, int p_175864_3_, int p_175864_4_, EnumFacing p_175864_5_, int p_175864_6_) {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
                  if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
                        ...
                        for(l = 3; l < 12; l += 2) {
                              this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, 1, l, 4, 3, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                              this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, 1, l, 7, 3, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                              this.fillWithBlocks(worldIn, structureBoundingBoxIn, 9, 1, l, 10, 3, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                        }
      ...
      public static class LeftTurn extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureStrongholdPieces.LeftTurn createPiece(List p_175867_0_, Random p_175867_1_, int p_175867_2_, int p_175867_3_, int p_175867_4_, EnumFacing p_175867_5_, int p_175867_6_) {
      ...
      public static class Crossing extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureStrongholdPieces.Crossing createPiece(List p_175866_0_, Random p_175866_1_, int p_175866_2_, int p_175866_3_, int p_175866_4_, EnumFacing p_175866_5_, int p_175866_6_) {
      ...
      public static class Corridor extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureBoundingBox findPieceBox(List p_175869_0_, Random p_175869_1_, int p_175869_2_, int p_175869_3_, int p_175869_4_, EnumFacing p_175869_5_) {
                  int i = true;
      ...
      public static class ChestCorridor extends StructureStrongholdPieces.Stronghold {
            ...
            public static StructureStrongholdPieces.ChestCorridor createPiece(List p_175868_0_, Random p_175868_1_, int p_175868_2_, int p_175868_3_, int p_175868_4_, EnumFacing p_175868_5_, int p_175868_6_) {
