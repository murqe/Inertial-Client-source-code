...
public class StructureVillagePieces {
      ...
      public static List getStructureVillageWeightedPieceList(Random random, int size) {
            ...
            list.add(new StructureVillagePieces.PieceWeight(StructureVillagePieces.House2.class, 15, MathHelper.getInt((Random)random, 0, 1 + size)));
      ...
      private static int updatePieceWeight(List p_75079_0_) {
            boolean flag = false;
            int i = 0;
            ...
            for(Iterator var3 = p_75079_0_.iterator(); var3.hasNext(); i += structurevillagepieces$pieceweight.villagePieceWeight) {
                  structurevillagepieces$pieceweight = (StructureVillagePieces.PieceWeight)var3.next();
      ...
      private static StructureVillagePieces.Village findAndCreateComponentFactory(StructureVillagePieces.Start start, StructureVillagePieces.PieceWeight weight, List structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType) {
            ...
            return (StructureVillagePieces.Village)structurevillagepieces$village;
      }

      private static StructureVillagePieces.Village generateComponent(StructureVillagePieces.Start start, List structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType) {
            ...
            if (i <= 0) {
                  ...
                  while(j < 5) {
                        ...
                        while(var11.hasNext()) {
                              StructureVillagePieces.PieceWeight structurevillagepieces$pieceweight = (StructureVillagePieces.PieceWeight)var11.next();
      ...
      private static StructureComponent generateAndAddComponent(StructureVillagePieces.Start start, List structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType) {
            if (componentType > 50) {
                  return null;
      ...
      private static StructureComponent generateAndAddRoadPiece(StructureVillagePieces.Start start, List p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_) {
      ...
      public static class WoodHut extends StructureVillagePieces.Village {
            ...
            public static StructureVillagePieces.WoodHut createPiece(StructureVillagePieces.Start start, List p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_) {
      ...
      abstract static class Village extends StructureComponent {
            ...
            @Nullable
            protected StructureComponent getNextComponentNN(StructureVillagePieces.Start start, List structureComponents, Random rand, int p_74891_4_, int p_74891_5_) {
            ...
            @Nullable
            protected StructureComponent getNextComponentPP(StructureVillagePieces.Start start, List structureComponents, Random rand, int p_74894_4_, int p_74894_5_) {
                  EnumFacing enumfacing = this.getCoordBaseMode();
                  if (enumfacing != null) {
                        switch(enumfacing) {
                        case NORTH:
      ...
      public static class Torch extends StructureVillagePieces.Village {
            ...
            public static StructureBoundingBox findPieceBox(StructureVillagePieces.Start start, List p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing) {
      ...
      public static class Start extends StructureVillagePieces.Well {
            ...
            public Start(BiomeProvider chunkManagerIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_, List p_i2104_6_, int p_i2104_7_) {
      ...
      public static class Path extends StructureVillagePieces.Road {
            ...
            public void buildComponent(StructureComponent componentIn, List listIn, Random rand) {
                  ...
                  for(j = rand.nextInt(5); j < this.length - 8; j += 2 + rand.nextInt(5)) {
                        structurecomponent1 = this.getNextComponentNN((StructureVillagePieces.Start)componentIn, listIn, rand, 0, j);
                  ...
                  for(j = rand.nextInt(5); j < this.length - 8; j += 2 + rand.nextInt(5)) {
                        structurecomponent1 = this.getNextComponentPP((StructureVillagePieces.Start)componentIn, listIn, rand, 0, j);
                        if (structurecomponent1 != null) {
                              j += Math.max(structurecomponent1.boundingBox.getXSize(), structurecomponent1.boundingBox.getZSize());
                              flag = true;
                        }
            ...
            public static StructureBoundingBox findPieceBox(StructureVillagePieces.Start start, List p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing) {
      ...
      public static class House4Garden extends StructureVillagePieces.Village {
            ...
            public static StructureVillagePieces.House4Garden createPiece(StructureVillagePieces.Start start, List p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_) {
      ...
      public static class House3 extends StructureVillagePieces.Village {
            ...
            public static StructureVillagePieces.House3 createPiece(StructureVillagePieces.Start start, List p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_) {
      ...
      public static class House2 extends StructureVillagePieces.Village {
            ...
            public static StructureVillagePieces.House2 createPiece(StructureVillagePieces.Start start, List p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_) {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
                  ...
                  int k;
                  for(k = 6; k <= 8; ++k) {
                        if (this.getBlockStateFromPos(worldIn, k, 0, -1, structureBoundingBoxIn).getMaterial() == Material.AIR && this.getBlockStateFromPos(worldIn, k, -1, -1, structureBoundingBoxIn).getMaterial() != Material.AIR) {
                              this.setBlockState(worldIn, iblockstate4, k, 0, -1, structureBoundingBoxIn);
                              if (this.getBlockStateFromPos(worldIn, k, -1, -1, structureBoundingBoxIn).getBlock() == Blocks.GRASS_PATH) {
                                    this.setBlockState(worldIn, Blocks.GRASS.getDefaultState(), k, -1, -1, structureBoundingBoxIn);
                              }
                        }
                  }
      ...
      public static class House1 extends StructureVillagePieces.Village {
            ...
            public static StructureVillagePieces.House1 createPiece(StructureVillagePieces.Start start, List p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_) {
      ...
      public static class Hall extends StructureVillagePieces.Village {
            ...
            public static StructureVillagePieces.Hall createPiece(StructureVillagePieces.Start start, List p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_) {
      ...
      public static class Field2 extends StructureVillagePieces.Village {
            ...
            public static StructureVillagePieces.Field2 createPiece(StructureVillagePieces.Start start, List p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_) {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
                  ...
                  int k1;
                  for(j1 = 1; j1 <= 7; ++j1) {
                        k1 = ((BlockCrops)this.cropTypeA).getMaxAge();
                        int k = k1 / 3;
      ...
      public static class Field1 extends StructureVillagePieces.Village {
            ...
            public static StructureVillagePieces.Field1 createPiece(StructureVillagePieces.Start start, List p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_) {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
                  ...
                  int k2;
                  for(j2 = 1; j2 <= 7; ++j2) {
                        k2 = ((BlockCrops)this.cropTypeA).getMaxAge();
                        int k = k2 / 3;
      ...
      public static class Church extends StructureVillagePieces.Village {
            ...
            public static StructureVillagePieces.Church createPiece(StructureVillagePieces.Start start, List p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_) {
