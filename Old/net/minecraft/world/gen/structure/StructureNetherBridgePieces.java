...
public class StructureNetherBridgePieces {
      ...
      private static StructureNetherBridgePieces.Piece findAndCreateBridgePieceFactory(StructureNetherBridgePieces.PieceWeight p_175887_0_, List p_175887_1_, Random p_175887_2_, int p_175887_3_, int p_175887_4_, int p_175887_5_, EnumFacing p_175887_6_, int p_175887_7_) {
      ...
      public static class Throne extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Throne createPiece(List p_175874_0_, Random p_175874_1_, int p_175874_2_, int p_175874_3_, int p_175874_4_, int p_175874_5_, EnumFacing p_175874_6_) {
      ...
      public static class Straight extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Straight createPiece(List p_175882_0_, Random p_175882_1_, int p_175882_2_, int p_175882_3_, int p_175882_4_, EnumFacing p_175882_5_, int p_175882_6_) {
      ...
      public static class Start extends StructureNetherBridgePieces.Crossing3 {
            ...
            public Start(Random p_i2059_1_, int p_i2059_2_, int p_i2059_3_) {
                  ...
                  StructureNetherBridgePieces.PieceWeight[] var4 = StructureNetherBridgePieces.PRIMARY_COMPONENTS;
                  int var5 = var4.length;

                  int var6;
                  StructureNetherBridgePieces.PieceWeight structurenetherbridgepieces$pieceweight1;
                  ...
                  var4 = StructureNetherBridgePieces.SECONDARY_COMPONENTS;
                  var5 = var4.length;
      ...
      public static class Stairs extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Stairs createPiece(List p_175872_0_, Random p_175872_1_, int p_175872_2_, int p_175872_3_, int p_175872_4_, int p_175872_5_, EnumFacing p_175872_6_) {
      ...
      abstract static class Piece extends StructureComponent {
            ...
            private int getTotalWeight(List p_74960_1_) {
                  ...
                  StructureNetherBridgePieces.PieceWeight structurenetherbridgepieces$pieceweight;
                  for(Iterator var4 = p_74960_1_.iterator(); var4.hasNext(); i += structurenetherbridgepieces$pieceweight.weight) {
                        structurenetherbridgepieces$pieceweight = (StructureNetherBridgePieces.PieceWeight)var4.next();
            ...
            private StructureNetherBridgePieces.Piece generatePiece(StructureNetherBridgePieces.Start p_175871_1_, List p_175871_2_, List p_175871_3_, Random p_175871_4_, int p_175871_5_, int p_175871_6_, int p_175871_7_, EnumFacing p_175871_8_, int p_175871_9_) {
                  ...
                  while(j < 5 && flag) {
                        ...
                        while(var14.hasNext()) {
                              StructureNetherBridgePieces.PieceWeight structurenetherbridgepieces$pieceweight = (StructureNetherBridgePieces.PieceWeight)var14.next();
            ...
            private StructureComponent generateAndAddPiece(StructureNetherBridgePieces.Start p_175870_1_, List p_175870_2_, Random p_175870_3_, int p_175870_4_, int p_175870_5_, int p_175870_6_, @Nullable EnumFacing p_175870_7_, int p_175870_8_, boolean p_175870_9_) {
      ...
      public static class NetherStalkRoom extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.NetherStalkRoom createPiece(List p_175875_0_, Random p_175875_1_, int p_175875_2_, int p_175875_3_, int p_175875_4_, EnumFacing p_175875_5_, int p_175875_6_) {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
                  ...
                  int j1;
                  for(j1 = 1; j1 <= 11; j1 += 2) {
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, j1, 10, 0, j1, 11, 0, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, j1, 10, 12, j1, 11, 12, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 10, j1, 0, 11, j1, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 12, 10, j1, 12, 11, j1, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), j1, 13, 0, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), j1, 13, 12, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), 0, 13, j1, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), 12, 13, j1, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), j1 + 1, 13, 0, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), j1 + 1, 13, 12, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), 0, 13, j1 + 1, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), 12, 13, j1 + 1, structureBoundingBoxIn);
                  }
                  ...
                  for(i2 = 4; i2 <= 8; ++i2) {
                        for(j2 = 0; j2 <= 2; ++j2) {
                              ...
                              this.replaceAirAndLiquidDownwards(worldIn, Blocks.NETHER_BRICK.getDefaultState(), i2, -1, 12 - j2, structureBoundingBoxIn);
                        }
                  }
      ...
      public static class Entrance extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Entrance createPiece(List p_175881_0_, Random p_175881_1_, int p_175881_2_, int p_175881_3_, int p_175881_4_, EnumFacing p_175881_5_, int p_175881_6_) {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
                  ...
                  int i1;
                  for(i1 = 1; i1 <= 11; i1 += 2) {
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, i1, 10, 0, i1, 11, 0, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, i1, 10, 12, i1, 11, 12, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 10, i1, 0, 11, i1, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 12, 10, i1, 12, 11, i1, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), i1, 13, 0, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), i1, 13, 12, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), 0, 13, i1, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), 12, 13, i1, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), i1 + 1, 13, 0, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), i1 + 1, 13, 12, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), 0, 13, i1 + 1, structureBoundingBoxIn);
                        this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), 12, 13, i1 + 1, structureBoundingBoxIn);
                  }
                  ...
                  for(i1 = 3; i1 <= 9; i1 += 2) {
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 7, i1, 1, 8, i1, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 7, i1, 11, 8, i1, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                  }
                  ...
                  for(i1 = 4; i1 <= 8; ++i1) {
                        for(j1 = 0; j1 <= 2; ++j1) {
                              ...
                              this.replaceAirAndLiquidDownwards(worldIn, Blocks.NETHER_BRICK.getDefaultState(), i1, -1, 12 - j1, structureBoundingBoxIn);
                        }
                  }
      ...
      public static class End extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.End createPiece(List p_175884_0_, Random p_175884_1_, int p_175884_2_, int p_175884_3_, int p_175884_4_, EnumFacing p_175884_5_, int p_175884_6_) {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
                  ...
                  for(i = 0; i <= 4; ++i) {
                        for(j1 = 3; j1 <= 4; ++j1) {
                              l1 = random.nextInt(8);
                              this.fillWithBlocks(worldIn, structureBoundingBoxIn, i, j1, 0, i, j1, l1, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
                        }
                  }

                  i = random.nextInt(8);
                  this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 0, 0, 5, i, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
                  i = random.nextInt(8);
                  this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 5, 0, 4, 5, i, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);

                  for(j1 = 0; j1 <= 4; ++j1) {
                        l1 = random.nextInt(5);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, j1, 2, 0, j1, 2, l1, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
                  }
      ...
      public static class Crossing3 extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Crossing3 createPiece(List p_175885_0_, Random p_175885_1_, int p_175885_2_, int p_175885_3_, int p_175885_4_, EnumFacing p_175885_5_, int p_175885_6_) {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
                  ...
                  for(k = 7; k <= 11; ++k) {
                        for(l = 0; l <= 2; ++l) {
                              ...
                              this.replaceAirAndLiquidDownwards(worldIn, Blocks.NETHER_BRICK.getDefaultState(), k, -1, 18 - l, structureBoundingBoxIn);
                        }
                  }
      ...
      public static class Crossing2 extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Crossing2 createPiece(List p_175878_0_, Random p_175878_1_, int p_175878_2_, int p_175878_3_, int p_175878_4_, EnumFacing p_175878_5_, int p_175878_6_) {
      ...
      public static class Crossing extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Crossing createPiece(List p_175873_0_, Random p_175873_1_, int p_175873_2_, int p_175873_3_, int p_175873_4_, EnumFacing p_175873_5_, int p_175873_6_) {
      ...
      public static class Corridor5 extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Corridor5 createPiece(List p_175877_0_, Random p_175877_1_, int p_175877_2_, int p_175877_3_, int p_175877_4_, EnumFacing p_175877_5_, int p_175877_6_) {
      ...
      public static class Corridor4 extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Corridor4 createPiece(List p_175880_0_, Random p_175880_1_, int p_175880_2_, int p_175880_3_, int p_175880_4_, EnumFacing p_175880_5_, int p_175880_6_) {
      ...
      public static class Corridor3 extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Corridor3 createPiece(List p_175883_0_, Random p_175883_1_, int p_175883_2_, int p_175883_3_, int p_175883_4_, EnumFacing p_175883_5_, int p_175883_6_) {
      ...
      public static class Corridor2 extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Corridor2 createPiece(List p_175876_0_, Random p_175876_1_, int p_175876_2_, int p_175876_3_, int p_175876_4_, EnumFacing p_175876_5_, int p_175876_6_) {
      ...
      public static class Corridor extends StructureNetherBridgePieces.Piece {
            ...
            public static StructureNetherBridgePieces.Corridor createPiece(List p_175879_0_, Random p_175879_1_, int p_175879_2_, int p_175879_3_, int p_175879_4_, EnumFacing p_175879_5_, int p_175879_6_) {
