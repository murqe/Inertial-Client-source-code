...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
      ...
      private final Map chunksToRemove = Maps.newConcurrentMap();
      private final Set field_193415_c = Collections.newSetFromMap(Maps.newConcurrentMap());
                        ...
                        if (compound.hasKey("Level", 10)) {
                              ...
                              if (nbttagcompound.hasKey("Entities", 9)) {
                                    ...
                                    for(j = 0; j < nbttaglist1.tagCount(); ++j) {
                                          nbttaglist1.set(j, fixer.process(FixTypes.ENTITY, (NBTTagCompound)nbttaglist1.get(j), versionIn));
                                    }
                              }
      ...
      private void writeChunkToNBT(Chunk chunkIn, World worldIn, NBTTagCompound compound) {
            ...
            while(var19.hasNext()) {
                  TileEntity tileentity = (TileEntity)var19.next();
            ...
            if (list != null) {
                  ...
                  while(var25.hasNext()) {
                        NextTickListEntry nextticklistentry = (NextTickListEntry)var25.next();
                        NBTTagCompound nbttagcompound1 = new NBTTagCompound();
