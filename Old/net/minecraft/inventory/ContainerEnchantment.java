...
public class ContainerEnchantment extends Container {
      ...
      public boolean enchantItem(EntityPlayer playerIn, int id) {
            ...
            if ((itemstack1.func_190926_b() || itemstack1.func_190916_E() < i) && !playerIn.capabilities.isCreativeMode) {
                  ...
                  if (!this.worldPointer.isRemote) {
                        List list = this.getEnchantmentList(itemstack, id, this.enchantLevels[id]);
                        if (!list.isEmpty()) {
      ...
      private List getEnchantmentList(ItemStack stack, int p_178148_2_, int p_178148_3_) {
            this.rand.setSeed((long)(this.xpSeed + p_178148_2_));
            List list = EnchantmentHelper.buildEnchantmentList(this.rand, stack, p_178148_3_, false);
