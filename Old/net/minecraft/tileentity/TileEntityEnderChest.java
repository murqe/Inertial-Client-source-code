...
public class TileEntityEnderChest extends TileEntity implements ITickable {
      ...
      public void update() {
            ...
            if (this.numPlayersUsing > 0 && this.lidAngle == 0.0F) {
                  ...
                  d3 = (double)k + 0.5D;
                  this.world.playSound((EntityPlayer)null, d0, (double)j + 0.5D, d3, SoundEvents.BLOCK_ENDERCHEST_OPEN, SoundCategory.BLOCKS, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
            }
