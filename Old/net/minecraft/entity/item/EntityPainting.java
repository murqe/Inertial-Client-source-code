...
public class EntityPainting extends EntityHanging {
      ...
      public EntityPainting(World worldIn, BlockPos pos, EnumFacing facing) {
            ...
            int i = 0;
            EntityPainting.EnumArt[] var6 = EntityPainting.EnumArt.values();
            int var7 = var6.length;

            for(int var8 = 0; var8 < var7; ++var8) {
                  EntityPainting.EnumArt entitypainting$enumart = var6[var8];
      ...
      public EntityPainting(World worldIn, BlockPos pos, EnumFacing facing, String title) {
            ...
            for(int var7 = 0; var7 < var6; ++var7) {
                  EntityPainting.EnumArt entitypainting$enumart = var5[var7];
      ...
      public void readEntityFromNBT(NBTTagCompound compound) {
            ...
            for(int var5 = 0; var5 < var4; ++var5) {
                  EntityPainting.EnumArt entitypainting$enumart = var3[var5];
