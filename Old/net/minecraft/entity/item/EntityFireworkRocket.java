...
public class EntityFireworkRocket extends Entity {
      private static final DataParameter FIREWORK_ITEM;
      private static final DataParameter field_191512_b;
      ...
      public void onUpdate() {
            ...
            if (this.func_191511_j()) {
                  if (this.field_191513_e == null) {
                        Entity entity = this.world.getEntityByID((Integer)this.dataManager.get(field_191512_b));
                  ...
                  if (this.field_191513_e != null) {
                        if (this.field_191513_e.isElytraFlying()) {
                              ...
                              var10000.motionX += vec3d.xCoord * 0.1D + (vec3d.xCoord * 1.5D - this.field_191513_e.motionX) * 0.5D;
                              var10000 = this.field_191513_e;
                              var10000.motionY += vec3d.yCoord * 0.1D + (vec3d.yCoord * 1.5D - this.field_191513_e.motionY) * 0.5D;
                              var10000 = this.field_191513_e;
                              var10000.motionZ += vec3d.zCoord * 0.1D + (vec3d.zCoord * 1.5D - this.field_191513_e.motionZ) * 0.5D;
                        }
      ...
      private void func_191510_k() {
            ...
            if (f > 0.0F) {
                  ...
                  Iterator var8 = this.world.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expandXyz(5.0D)).iterator();
                  ...
                  while(true) {
                        ...
                        do {
                              ...
                              } while(entitylivingbase == this.field_191513_e);
                        } while(this.getDistanceSqToEntity(entitylivingbase) > 25.0D);
      ...
      public boolean func_191511_j() {
            return (Integer)this.dataManager.get(field_191512_b) > 0;
      }
