...
public abstract class EntityLivingBase extends Entity {
      ...
      public final void setArrowCountInEntity(int count) {
            if (!Main.moduleManager.getModule(NoRender.class).isToggled() || !Main.settingsManager.getSettingByName(Main.moduleManager.getModule(NoRender.class), "NoArrowInPlayer").getValBoolean()) {
      ...
      public boolean canBePushed() {
            if (Main.moduleManager.getModule(NoPush.class).isToggled() && Main.settingsManager.getSettingByName("Players").getValBoolean()) {
                  return false;
            } else {
