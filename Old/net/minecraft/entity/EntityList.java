...
public class EntityList {
      ...
      public static final RegistryNamespaced field_191308_b = new RegistryNamespaced();
      ...
      @Nullable
      public static ResourceLocation func_191306_a(Class p_191306_0_) {
      ...
      @Nullable
      public static Class func_192839_a(String p_192839_0_) {
            return (Class)field_191308_b.getObject(new ResourceLocation(p_192839_0_));
      }

      @Nullable
      public static Entity func_191304_a(@Nullable Class p_191304_0_, World p_191304_1_) {
            if (p_191304_0_ == null) {
                  return null;
            } else {
                  try {
      ...
      public static Set getEntityNameList() {
      ...
      private static void func_191303_a(int p_191303_0_, String p_191303_1_, Class p_191303_2_, String p_191303_3_) {
            try {
