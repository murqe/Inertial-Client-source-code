...
public abstract class EntitySpellcasterIllager extends AbstractIllager {
      private static final DataParameter field_193088_c;
      ...
      public boolean func_193082_dl() {
            if (this.world.isRemote) {
                  return (Byte)this.dataManager.get(field_193088_c) > 0;
            } else {
      ...
      protected EntitySpellcasterIllager.SpellType func_193083_dm() {
            return !this.world.isRemote ? this.field_193089_bx : EntitySpellcasterIllager.SpellType.func_193337_a((Byte)this.dataManager.get(field_193088_c));
      }
      ...
      public static enum SpellType {
            ...
            public static EntitySpellcasterIllager.SpellType func_193337_a(int p_193337_0_) {
                  ...
                  for(int var3 = 0; var3 < var2; ++var3) {
                        EntitySpellcasterIllager.SpellType entityspellcasterillager$spelltype = var1[var3];
