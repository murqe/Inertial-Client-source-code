...
public class EntityGuardian extends EntityMob {
      private static final DataParameter field_190766_bz;
      private static final DataParameter TARGET_ENTITY;
      ...
      public boolean isMoving() {
            return (Boolean)this.dataManager.get(field_190766_bz);
      }
      ...
      static class GuardianMoveHelper extends EntityMoveHelper {
            ...
            public void onUpdateMoveHelper() {
                  if (this.action == EntityMoveHelper.Action.MOVE_TO && !this.entityGuardian.getNavigator().noPath()) {
                        ...
                        var10000 = this.entityGuardian;
                        var10000.motionY += d4 * (d6 + d5) * 0.25D;
                        var10000 = this.entityGuardian;
                        var10000.motionY += (double)this.entityGuardian.getAIMoveSpeed() * d1 * 0.1D;
