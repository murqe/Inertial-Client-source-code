...
public class EntityPolarBear extends EntityAnimal {
      private static final DataParameter IS_STANDING;
            ...
            public boolean shouldExecute() {
                  if (EntityPolarBear.this.isChild()) {
                        ...
                        if (super.shouldExecute()) {
                              Iterator var1 = EntityPolarBear.this.world.getEntitiesWithinAABB(EntityPolarBear.class, EntityPolarBear.this.getEntityBoundingBox().expand(8.0D, 4.0D, 8.0D)).iterator();

                              while(var1.hasNext()) {
                                    EntityPolarBear entitypolarbear = (EntityPolarBear)var1.next();
