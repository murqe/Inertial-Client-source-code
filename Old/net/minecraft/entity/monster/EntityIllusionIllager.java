      ...
      public void onLivingUpdate() {
            ...
            if (this.world.isRemote && this.isInvisible()) {
                  ...
                  if (this.hurtTime != 1 && this.ticksExisted % 1200 != 0) {
                        ...
                        int l;
                        for(l = 0; l < 4; ++l) {
                              this.field_193100_bx[0][l] = this.field_193100_bx[1][l];
                              this.field_193100_bx[1][l] = new Vec3d((double)(-6.0F + (float)this.rand.nextInt(13)) * 0.5D, (double)Math.max(0, this.rand.nextInt(6) - 4), (double)(-6.0F + (float)this.rand.nextInt(13)) * 0.5D);
                        }
      ...
      class AIBlindnessSpell extends EntitySpellcasterIllager.AIUseSpell {
            ...
            public boolean shouldExecute() {
                  if (!super.shouldExecute()) {
                        ...
                        return EntityIllusionIllager.this.getAttackTarget().getEntityId() == this.field_193325_b ? false : EntityIllusionIllager.this.world.getDifficultyForLocation(new BlockPos(EntityIllusionIllager.this)).func_193845_a((float)EnumDifficulty.NORMAL.ordinal());
                  }
            }
