...
public final class ProjectileHelper {
      public static RayTraceResult forwardsRaycast(Entity p_188802_0_, boolean includeEntities, boolean p_188802_2_, Entity excludedEntity) {
            ...
            if (includeEntities) {
                  ...
                  Entity entity = null;
                  List list = world.getEntitiesWithinAABBExcludingEntity(p_188802_0_, p_188802_0_.getEntityBoundingBox().addCoord(d3, d4, d5).expandXyz(1.0D));
                  double d6 = 0.0D;
      ...
      public static final void rotateTowardsMovement(Entity p_188803_0_, float p_188803_1_) {
            ...
            p_188803_0_.rotationYaw = (float)(MathHelper.atan2(d2, d0) * 57.29577951308232D) + 90.0F;

            for(p_188803_0_.rotationPitch = (float)(MathHelper.atan2((double)f, d1) * 57.29577951308232D) - 90.0F; p_188803_0_.rotationPitch - p_188803_0_.prevRotationPitch < -180.0F; p_188803_0_.prevRotationPitch -= 360.0F) {
            }
