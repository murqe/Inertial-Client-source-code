...
import me.rich.module.player.EventSafeWalk;
import me.rich.module.player.Scaffold;
...
public abstract class Entity implements ICommandSender {
      ...
      public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_) {
            if (this.noClip) {
                  ...
                  safeEvent.call();
                  if ((x == MoverType.SELF || x == MoverType.PLAYER) && this.onGround && this.isSneaking() && this instanceof EntityPlayer && !Scaffold.isSneaking || safeEvent.isCancelled() && this instanceof EntityPlayer) {
                        for(double var21 = 0.05D; p_70091_2_ != 0.0D && this.world.getCollisionBoxes(this, this.getEntityBoundingBox().offset(p_70091_2_, (double)(-this.stepHeight), 0.0D)).isEmpty(); d2 = p_70091_2_) {
                  ...
                  try {
                        ...
                        CrashReport crashreport = CrashReport.makeCrashReport(var59, "Checking entity block collision");
