...
public abstract class EntityPlayer extends EntityLivingBase {
      ...
      public void attackTargetEntityWithCurrentItem(Entity targetEntity) {
            if (targetEntity.canBeAttackedWithItem() && !targetEntity.hitByEntity(this)) {
                  ...
                  if ((f *= 0.2F + f2 * f2 * 0.8F) > 0.0F || f1 > 0.0F) {
                        ...
                        if (flag && !flag2 && !flag1 && this.onGround && d0 < (double)this.getAIMoveSpeed() && this.getHeldItem(EnumHand.MAIN_HAND).getItem() instanceof ItemSword) {
                              flag3 = true;
                        }
                        ...
                        if (flag5) {
                              ...
                              if (flag3) {
                                    ...
                                    Iterator var26 = this.world.getEntitiesWithinAABB(EntityLivingBase.class, targetEntity.getEntityBoundingBox().expand(1.0D, 0.25D, 1.0D)).iterator();

                                    while(var26.hasNext()) {
                                          EntityLivingBase entitylivingbase = (EntityLivingBase)var26.next();
      ...
      public boolean isPushedByWater() {
            if (Main.moduleManager.getModule(NoPush.class).isToggled() && Main.settingsManager.getSettingByName("Water").getValBoolean()) {
                  return false;
            } else {
                  return !this.capabilities.isFlying;
            }
