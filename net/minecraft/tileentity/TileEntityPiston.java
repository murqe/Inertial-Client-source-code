...
public class TileEntityPiston extends TileEntity implements ITickable {
      ...
      private static final ThreadLocal field_190613_i = new ThreadLocal() {
      ...
      private void moveCollidedEntities(float p_184322_1_) {
            ...
            if (!list.isEmpty()) {
                  ...
                  List list1 = this.world.getEntitiesWithinAABBExcludingEntity((Entity)null, this.func_190610_a(axisalignedbb, enumfacing, d0).union(axisalignedbb));
                  if (!list1.isEmpty()) {
      ...
      private AxisAlignedBB func_191515_a(List p_191515_1_) {
            double d0 = 0.0D;
            double d1 = 0.0D;
            double d2 = 0.0D;
            double d3 = 1.0D;
      ...
      public void func_190609_a(World p_190609_1_, BlockPos p_190609_2_, AxisAlignedBB p_190609_3_, List p_190609_4_, @Nullable Entity p_190609_5_) {
            if (!this.extending && this.shouldHeadBeRendered) {
