...
public abstract class TileEntity {
      ...
      private static final RegistryNamespaced field_190562_f = new RegistryNamespaced();
      ...
      private static void func_190560_a(String p_190560_0_, Class p_190560_1_) {
            field_190562_f.putObject(new ResourceLocation(p_190560_0_), p_190560_1_);
      }

      @Nullable
      public static ResourceLocation func_190559_a(Class p_190559_0_) {
      ...
      public static TileEntity create(World worldIn, NBTTagCompound compound) {
            ...
            try {
                  Class oclass = (Class)field_190562_f.getObject(new ResourceLocation(s));
                  if (oclass != null) {
