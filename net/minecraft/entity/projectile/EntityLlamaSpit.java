...
public class EntityLlamaSpit extends Entity implements IProjectile {
            ...
            while(true) {
                  ...
                  do {
                        ...
                        do {
                              ...
                              } while(entity1 == this.field_190539_a);
      ...
      private void func_190537_j() {
            if (this.field_190540_b != null && this.field_190540_b.hasUniqueId("OwnerUUID")) {
                  ...
                  Iterator var2 = this.world.getEntitiesWithinAABB(EntityLlama.class, this.getEntityBoundingBox().expandXyz(15.0D)).iterator();

                  while(var2.hasNext()) {
                        EntityLlama entityllama = (EntityLlama)var2.next();
