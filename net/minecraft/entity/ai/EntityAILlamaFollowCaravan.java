...
public class EntityAILlamaFollowCaravan extends EntityAIBase {
      ...
      public boolean shouldExecute() {
            if (!this.field_190859_a.getLeashed() && !this.field_190859_a.func_190718_dR()) {
                  List list = this.field_190859_a.world.getEntitiesWithinAABB(this.field_190859_a.getClass(), this.field_190859_a.getEntityBoundingBox().expand(9.0D, 4.0D, 9.0D));
                  ...
                  double d2;
                  while(var5.hasNext()) {
                        entityllama2 = (EntityLlama)var5.next();
                        if (entityllama2.func_190718_dR() && !entityllama2.func_190712_dQ()) {
                              d2 = this.field_190859_a.getDistanceSqToEntity(entityllama2);
                              if (d2 <= d0) {
                                    d0 = d2;
                                    entityllama = entityllama2;
                              }
