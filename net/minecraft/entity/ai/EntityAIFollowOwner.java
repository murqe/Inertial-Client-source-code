...
public class EntityAIFollowOwner extends EntityAIBase {
      ...
      public void updateTask() {
            ...
            if (!this.thePet.isSitting() && --this.timeToRecalcPath <= 0) {
                  ...
                  if (!this.petPathfinder.tryMoveToEntityLiving(this.theOwner, this.followSpeed) && !this.thePet.getLeashed() && !this.thePet.isRiding() && this.thePet.getDistanceSqToEntity(this.theOwner) >= 144.0D) {
