...
public class EntityEvoker extends EntitySpellcasterIllager {
      ...
      public class AIWololoSpell extends EntitySpellcasterIllager.AIUseSpell {
            final Predicate field_190879_a = new Predicate() {
            ...
            public boolean shouldExecute() {
                  if (EntityEvoker.this.getAttackTarget() != null) {
                        ...
                        List list = EntityEvoker.this.world.getEntitiesWithinAABB(EntitySheep.class, EntityEvoker.this.getEntityBoundingBox().expand(16.0D, 4.0D, 16.0D), this.field_190879_a);
                        if (list.isEmpty()) {
                              return false;
                        } else {
            ...
            protected void func_190868_j() {
                  ...
                  if (EntityEvoker.this.getDistanceSqToEntity(entitylivingbase) < 9.0D) {
                        ...
                        for(k = 0; k < 5; ++k) {
                              ...
                              this.func_190876_a(EntityEvoker.this.posX + (double)MathHelper.cos(f2) * 1.5D, EntityEvoker.this.posZ + (double)MathHelper.sin(f2) * 1.5D, d0, d1, f2, 0);
                        }
