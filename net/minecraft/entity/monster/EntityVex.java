...
public class EntityVex extends EntityMob {
      protected static final DataParameter field_190664_a;
      ...
      private boolean func_190656_b(int p_190656_1_) {
            int i = (Byte)this.dataManager.get(field_190664_a);
      ...
      private void func_190660_a(int p_190660_1_, boolean p_190660_2_) {
            ...
            this.dataManager.set(field_190664_a, (byte)(i & 255));
      }
            ...
            public void onUpdateMoveHelper() {
                  if (this.action == EntityMoveHelper.Action.MOVE_TO) {
                        ...
                        if (d3 < EntityVex.this.getEntityBoundingBox().getAverageEdgeLength()) {
                              ...
                              var10000 = EntityVex.this;
                              var10000.motionX += d0 / d3 * 0.05D * this.speed;
                              var10000 = EntityVex.this;
                              var10000.motionY += d1 / d3 * 0.05D * this.speed;
                              var10000 = EntityVex.this;
                              var10000.motionZ += d2 / d3 * 0.05D * this.speed;
                              if (EntityVex.this.getAttackTarget() == null) {
