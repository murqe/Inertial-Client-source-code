      ...
      public void doLocalUpdate() {
            if (this.attackTarget == null) {
                  ...
                  if (this.currentPath != null && this.currentPath.isFinished()) {
                        ...
                        double d5 = Math.min(0.4000000059604645D + d14 / 80.0D - 1.0D, 10.0D);
                        this.targetLocation = new Vec3d(d12, this.attackTarget.posY + d5, d13);
                  }

                  d12 = this.targetLocation == null ? 0.0D : this.targetLocation.squareDistanceTo(this.dragon.posX, this.dragon.posY, this.dragon.posZ);
                  ...
                  if (this.attackTarget.getDistanceSqToEntity(this.dragon) < 4096.0D) {
                        if (this.dragon.canEntityBeSeen(this.attackTarget)) {
                              ...
                              float f = (float)(Math.acos((double)f1) * 57.29577951308232D);
                              f += 0.5F;
