...
public class BlockModelRenderer {
      ...
      private void renderQuadsSmooth(IBlockAccess p_renderQuadsSmooth_1_, IBlockState p_renderQuadsSmooth_2_, BlockPos p_renderQuadsSmooth_3_, BufferBuilder p_renderQuadsSmooth_4_, List p_renderQuadsSmooth_5_, RenderEnv p_renderQuadsSmooth_6_) {
      ...
      private void renderQuadsFlat(IBlockAccess p_renderQuadsFlat_1_, IBlockState p_renderQuadsFlat_2_, BlockPos p_renderQuadsFlat_3_, int p_renderQuadsFlat_4_, boolean p_renderQuadsFlat_5_, BufferBuilder p_renderQuadsFlat_6_, List p_renderQuadsFlat_7_, RenderEnv p_renderQuadsFlat_8_) {
      ...
      private void renderModelBrightnessColorQuads(float brightness, float red, float green, float blue, List listQuads) {
      ...
      public static class AmbientOcclusionFace {
            ...
            public void updateVertexBrightness(IBlockAccess worldIn, IBlockState state, BlockPos centerPos, EnumFacing direction, float[] faceShape, BitSet shapeState) {
                  ...
                  boolean flag = worldIn.getBlockState(blockpos$pooledmutableblockpos.setPos((Vec3i)blockpos$pooledmutableblockpos1).move(direction)).isTranslucent();
                  boolean flag1 = worldIn.getBlockState(blockpos$pooledmutableblockpos.setPos((Vec3i)blockpos$pooledmutableblockpos2).move(direction)).isTranslucent();
                  boolean flag2 = worldIn.getBlockState(blockpos$pooledmutableblockpos.setPos((Vec3i)blockpos$pooledmutableblockpos3).move(direction)).isTranslucent();
                  boolean flag3 = worldIn.getBlockState(blockpos$pooledmutableblockpos.setPos((Vec3i)blockpos$pooledmutableblockpos4).move(direction)).isTranslucent();
                  int i1;
                  float f25;
                  if (!flag2 && !flag) {
                        f25 = f;
                        ...
                        BlockPos blockpos1 = blockpos$pooledmutableblockpos.setPos((Vec3i)blockpos$pooledmutableblockpos1).move(blockmodelrenderer$enumneighborinfo.corners[2]);
                  ...
                  if (!flag3 && !flag) {
                        ...
                        BlockPos blockpos2 = blockpos$pooledmutableblockpos.setPos((Vec3i)blockpos$pooledmutableblockpos1).move(blockmodelrenderer$enumneighborinfo.corners[3]);
                  ...
                  if (!flag2 && !flag1) {
                        ...
                        BlockPos blockpos3 = blockpos$pooledmutableblockpos.setPos((Vec3i)blockpos$pooledmutableblockpos2).move(blockmodelrenderer$enumneighborinfo.corners[2]);
                  ...
                  if (!flag3 && !flag1) {
                        ...
                        BlockPos blockpos4 = blockpos$pooledmutableblockpos.setPos((Vec3i)blockpos$pooledmutableblockpos2).move(blockmodelrenderer$enumneighborinfo.corners[3]);
                  ...
                  if (shapeState.get(1) && blockmodelrenderer$enumneighborinfo.doNonCubicWeight) {
                        ...
                        this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.vert0] = f5 * f9 + f6 * f10 + f7 * f11 + f8 * f12;
                        this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.vert1] = f5 * f13 + f6 * f14 + f7 * f15 + f8 * f16;
                        this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.vert2] = f5 * f17 + f6 * f18 + f7 * f19 + f8 * f20;
                        this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.vert3] = f5 * f21 + f6 * f22 + f7 * f23 + f8 * f24;
