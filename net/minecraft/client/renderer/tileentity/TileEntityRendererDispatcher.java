...
public class TileEntityRendererDispatcher {
      ...
      private TileEntityRendererDispatcher() {
            ...
            while(var1.hasNext()) {
                  TileEntitySpecialRenderer tileentityspecialrenderer = (TileEntitySpecialRenderer)var1.next();
      ...
      public void func_192854_a(TileEntity p_192854_1_, double p_192854_2_, double p_192854_4_, double p_192854_6_, float p_192854_8_, int p_192854_9_, float p_192854_10_) {
            TileEntitySpecialRenderer tileentityspecialrenderer = this.getSpecialRenderer(p_192854_1_);
