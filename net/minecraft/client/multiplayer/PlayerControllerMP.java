...
public class PlayerControllerMP {
      ...
      public boolean onPlayerDestroyBlock(BlockPos pos) {
            ...
            if (this.currentGameType.isCreative()) {
                  var10000 = this.mc;
                  if (!Minecraft.player.getHeldItemMainhand().func_190926_b()) {
                        var10000 = this.mc;
            ...
            if (!this.mc.world.getWorldBorder().contains(loc)) {
                  ...
                  if (this.currentGameType.isCreative()) {
                        ...
                        if (flag && this.curBlockDamageMP == 0.0F) {
                              Block var6 = iblockstate.getBlock();
                              Minecraft var10003 = this.mc;
                              var6.onBlockClicked(this.mc.world, loc, Minecraft.player);
                        }
                        ...
                        if (flag) {
                              ...
                              if (iblockstate.getPlayerRelativeBlockHardness(Minecraft.player, Minecraft.player.world, loc) >= 1.0F) {
      ...
      public void attackEntity(EntityPlayer playerIn, Entity targetEntity) {
            ...
            if (Minecraft.player.isHandActive()) {
                  var10000 = this.mc;
                  if (Minecraft.player.getHeldItemOffhand().getItem() instanceof ItemShield && Main.moduleManager.getModule(KillAura.class).isToggled() && Main.settingsManager.getSettingByName(Main.moduleManager.getModule(KillAura.class), "ShieldBlock").getValBoolean() && this.mc.gameSettings.keyBindUseItem.isKeyDown()) {
                        var10000 = this.mc;
                        if (Minecraft.player.getHeldItemOffhand().getItem() instanceof ItemShield) {
                              Minecraft var10001 = this.mc;
                              this.mc.playerController.onStoppedUsingItem(Minecraft.player);
                        }
                  }
            }
