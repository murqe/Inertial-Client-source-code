...
public class GuiRecipeOverlay extends Gui {
      ...
      private final List field_193972_f = Lists.newArrayList();
      ...
      public void func_191845_a(Minecraft p_191845_1_, RecipeList p_191845_2_, int p_191845_3_, int p_191845_4_, int p_191845_5_, int p_191845_6_, float p_191845_7_, RecipeBook p_191845_8_) {
            ...
            List list = p_191845_2_.func_194207_b(true);
      ...
      public boolean func_193968_a(int p_193968_1_, int p_193968_2_, int p_193968_3_) {
            if (p_193968_3_ != 0) {
                  ...
                  Iterator var4 = this.field_193972_f.iterator();

                  GuiRecipeOverlay.Button guirecipeoverlay$button;
                  do {
                        if (!var4.hasNext()) {
                              return false;
                        }

                        guirecipeoverlay$button = (GuiRecipeOverlay.Button)var4.next();
                  } while(!guirecipeoverlay$button.mousePressed(this.field_191853_k, p_193968_1_, p_193968_2_));
      ...
      public void func_191842_a(int p_191842_1_, int p_191842_2_, float p_191842_3_) {
            if (this.field_191850_h) {
                  ...
                  while(var11.hasNext()) {
                        GuiRecipeOverlay.Button guirecipeoverlay$button = (GuiRecipeOverlay.Button)var11.next();
