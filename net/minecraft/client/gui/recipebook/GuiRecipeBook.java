...
public class GuiRecipeBook extends Gui implements IRecipeUpdateListener {
      ...
      private final List field_193018_j;
      ...
      public GuiRecipeBook() {
            this.field_193018_j = Lists.newArrayList(new GuiButtonRecipeTab[]{new GuiButtonRecipeTab(0, CreativeTabs.SEARCH), new GuiButtonRecipeTab(0, CreativeTabs.TOOLS), new GuiButtonRecipeTab(0, CreativeTabs.BUILDING_BLOCKS), new GuiButtonRecipeTab(0, CreativeTabs.MISC), new GuiButtonRecipeTab(0, CreativeTabs.REDSTONE)});
            this.field_193963_r = "";
      ...
      public void func_194303_a(int p_194303_1_, int p_194303_2_, Minecraft p_194303_3_, boolean p_194303_4_, InventoryCrafting p_194303_5_) {
            ...
            this.field_193964_s = Minecraft.player.func_192035_E();
            this.field_193966_v = Minecraft.player.inventory.func_194015_p();
      ...
      public void func_193014_a(boolean p_193014_1_, InventoryCrafting p_193014_2_) {
            ...
            Minecraft var10000 = this.field_191888_F;
            Minecraft.player.inventory.func_194016_a(this.field_193965_u, false);
            p_193014_2_.func_194018_a(this.field_193965_u);
            Minecraft var10004 = this.field_191888_F;
            int var10005 = i + 25;
            int var10006 = j + 14;
            Minecraft var10008 = this.field_191888_F;
            this.field_193962_q = new GuiTextField(0, Minecraft.fontRendererObj, var10005, var10006, 80, Minecraft.fontRendererObj.FONT_HEIGHT + 5);
      ...
      private void func_193003_g(boolean p_193003_1_) {
            List list = (List)RecipeBookClient.field_194086_e.get(this.field_191913_x.func_191764_e());
            ...
            if (!s.isEmpty()) {
                  ObjectSet objectset = new ObjectLinkedOpenHashSet(this.field_191888_F.func_193987_a(SearchTreeManager.field_194012_b).func_194038_a(s.toLowerCase(Locale.ROOT)));
      ...
      public void func_193957_d() {
            if (this.func_191878_b()) {
                  Minecraft var10001 = this.field_191888_F;
                  if (this.field_193966_v != Minecraft.player.inventory.func_194015_p()) {
                        this.func_193942_g();
                        var10001 = this.field_191888_F;
                        this.field_193966_v = Minecraft.player.inventory.func_194015_p();
                  }
            }
                  ...
                  if (!Minecraft.player.isSpectator()) {
                        if (this.field_193022_s.func_194196_a(p_191862_1_, p_191862_2_, p_191862_3_, (this.field_191904_o - 147) / 2 - this.field_191903_n, (this.field_191905_p - 166) / 2, 147, 166)) {
                              ...
                              if (irecipe != null && recipelist != null) {
                                    ...
                                    this.field_191915_z.func_192682_a();
                                    PlayerControllerMP var9 = this.field_191888_F.playerController;
                                    Minecraft var10001 = this.field_191888_F;
                                    int var10 = Minecraft.player.openContainer.windowId;
                                    boolean var10003 = GuiScreen.isShiftKeyDown();
                                    Minecraft var10004 = this.field_191888_F;
                                    var9.func_194338_a(var10, irecipe, var10003, Minecraft.player);
                        ...
                        Iterator var4 = this.field_193018_j.iterator();
                        ...
                        } while(!guibuttonrecipetab.mousePressed(this.field_191888_F, p_191862_1_, p_191862_2_));
      ...
      private void func_193716_a(String p_193716_1_) {
            if ("excitedze".equals(p_193716_1_)) {
                  ...
                  var10000 = this.field_191888_F;
                  Minecraft.fontRendererObj.setBidiFlag(languagemanager.isCurrentLanguageBidirectional());
      ...
      public void func_193001_a(List p_193001_1_) {
            Iterator var2 = p_193001_1_.iterator();
      ...
      public void func_193951_a(IRecipe p_193951_1_, List p_193951_2_) {
            ItemStack itemstack = p_193951_1_.getRecipeOutput();
            this.field_191915_z.func_192685_a(p_193951_1_);
            this.field_191915_z.func_194187_a(Ingredient.func_193369_a(itemstack), ((Slot)p_193951_2_.get(0)).xDisplayPosition, ((Slot)p_193951_2_.get(0)).yDisplayPosition);
