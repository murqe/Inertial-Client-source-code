...
public class GuiBossOverlay extends Gui {
      ...
      public void renderBossHealth() {
            if (!this.mapBossInfos.isEmpty()) {
                  ...
                  while(var4.hasNext()) {
                        BossInfoClient bossinfoclient = (BossInfoClient)var4.next();
                        int k = i / 2 - 91;
                        ...
                        Minecraft.fontRendererObj.drawStringWithShadow(s, (float)(var10002 - Minecraft.fontRendererObj.getStringWidth(s) / 2), (float)(j - 9), 16777215);
                        Minecraft var8 = this.client;
                        j += 10 + Minecraft.fontRendererObj.FONT_HEIGHT;
