...
public class AdvancementToast implements IToast {
      ...
      public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
            ...
            if (displayinfo != null) {
                  ...
                  if (list.size() == 1) {
                        p_193653_1_.func_192989_b();
                        Minecraft.fontRendererObj.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30, 7, i | -16777216);
                        p_193653_1_.func_192989_b();
                        Minecraft.fontRendererObj.drawString(displayinfo.func_192297_a().getFormattedText(), 30, 18, -1);
                  } else {
                        int j = true;
                        float f = 300.0F;
                        int i1;
                        if (p_193653_2_ < 1500L) {
                              ...
                              p_193653_1_.func_192989_b();
                              Minecraft.fontRendererObj.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30, 11, i | i1);
                        } else {
                              ...
                              for(Iterator var11 = list.iterator(); var11.hasNext(); l += Minecraft.fontRendererObj.FONT_HEIGHT) {
                                    ...
                                    p_193653_1_.func_192989_b();
                                    Minecraft.fontRendererObj.drawString(s, 30, l, 16777215 | i1);
                                    p_193653_1_.func_192989_b();
                              }
                        }
                  }
