...
public class TutorialToast implements IToast {
      ...
      public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
            ...
            if (this.field_193673_e == null) {
                  ...
                  Minecraft.fontRendererObj.drawString(this.field_193672_d, 30, 12, -11534256);
            } else {
                  p_193653_1_.func_192989_b();
                  Minecraft.fontRendererObj.drawString(this.field_193672_d, 30, 7, -11534256);
                  p_193653_1_.func_192989_b();
                  Minecraft.fontRendererObj.drawString(this.field_193673_e, 30, 18, -16777216);
            }

            if (this.field_193678_j) {
                  Gui.drawRect(3.0D, 28.0D, 157.0D, 29.0D, -1);
                  ...
                  Gui.drawRect(3.0D, 28.0D, (double)((int)(3.0F + 154.0F * f)), 29.0D, i);
