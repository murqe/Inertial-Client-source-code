...
public class GuiCommandBlock extends GuiScreen implements ITabCompleter {
      ...
      public void drawScreen(int mouseX, int mouseY, float partialTicks) {
            ...
            drawCenteredString(this.fontRendererObj, I18n.format("advMode.setCommand"), this.width / 2, 20, 16777215);
            drawString(this.fontRendererObj, I18n.format("advMode.command"), this.width / 2 - 150, 40, 10526880);
            this.commandTextField.drawTextBox();
            int i = 75;
            int j = 0;
            FontRenderer var10000 = this.fontRendererObj;
            String var10001 = I18n.format("advMode.nearestPlayer");
            int var10002 = this.width / 2 - 140;
            int j = j + 1;
            drawString(var10000, var10001, var10002, i + j * this.fontRendererObj.FONT_HEIGHT, 10526880);
            drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer"), this.width / 2 - 140, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
            drawString(this.fontRendererObj, I18n.format("advMode.allPlayers"), this.width / 2 - 140, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
            drawString(this.fontRendererObj, I18n.format("advMode.allEntities"), this.width / 2 - 140, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
            drawString(this.fontRendererObj, I18n.format("advMode.self"), this.width / 2 - 140, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
            if (!this.previousOutputTextField.getText().isEmpty()) {
                  int i = i + j * this.fontRendererObj.FONT_HEIGHT + 1;
                  drawString(this.fontRendererObj, I18n.format("advMode.previousOutput"), this.width / 2 - 150, i + 4, 10526880);
