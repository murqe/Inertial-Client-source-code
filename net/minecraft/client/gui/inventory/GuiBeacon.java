...
public class GuiBeacon extends GuiContainer {
      ...
      public void updateScreen() {
            ...
            if (this.buttonsNotDrawn && i >= 0) {
                  ...
                  int j2;
                  Potion potion3;
                  GuiBeacon.PowerButton guibeacon$powerbutton2;
                  for(int k = 0; k <= 2; ++k) {
                        l1 = TileEntityBeacon.EFFECTS_LIST[k].length;
                        i2 = l1 * 22 + (l1 - 1) * 2;

                        for(j2 = 0; j2 < l1; ++j2) {
                              potion3 = TileEntityBeacon.EFFECTS_LIST[k][j2];
                              guibeacon$powerbutton2 = new GuiBeacon.PowerButton(j++, this.guiLeft + 76 + j2 * 24 - i2 / 2, this.guiTop + 22 + k * 25, potion3, k);
                  ...
                  int k1 = true;
                  l1 = TileEntityBeacon.EFFECTS_LIST[3].length + 1;
                  i2 = l1 * 22 + (l1 - 1) * 2;

                  for(j2 = 0; j2 < l1 - 1; ++j2) {
                        potion3 = TileEntityBeacon.EFFECTS_LIST[3][j2];
                        guibeacon$powerbutton2 = new GuiBeacon.PowerButton(j++, this.guiLeft + 167 + j2 * 24 - i2 / 2, this.guiTop + 47, potion3, 3);
                        this.buttonList.add(guibeacon$powerbutton2);
                        if (3 >= i) {
                              guibeacon$powerbutton2.enabled = false;
