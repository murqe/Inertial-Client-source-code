...
public class GuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry {
      ...
      public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_) {
            ...
            Minecraft.fontRendererObj.drawString(s, p_192634_2_ + 32 + 3, p_192634_3_ + 1, 16777215);
            var10000 = this.client;
            int var10002 = p_192634_2_ + 32 + 3;
            Minecraft var10004 = this.client;
            Minecraft.fontRendererObj.drawString(s1, var10002, p_192634_3_ + Minecraft.fontRendererObj.FONT_HEIGHT + 3, 8421504);
            var10000 = this.client;
            var10002 = p_192634_2_ + 32 + 3;
            var10004 = this.client;
            int var10003 = p_192634_3_ + Minecraft.fontRendererObj.FONT_HEIGHT;
            var10004 = this.client;
            Minecraft.fontRendererObj.drawString(s2, var10002, var10003 + Minecraft.fontRendererObj.FONT_HEIGHT + 3, 8421504);
            ...
            if (this.client.gameSettings.touchscreen || p_192634_8_) {
                  ...
                  int i = j < 32 ? 32 : 0;
                  if (this.worldSummary.markVersionInList()) {
                        Gui.drawModalRectWithCustomSizedTexture((float)p_192634_2_, (float)p_192634_3_, 32.0F, (float)i, 32, 32, 256.0F, 256.0F);
                        if (this.worldSummary.askToOpenWorld()) {
                              Gui.drawModalRectWithCustomSizedTexture((float)p_192634_2_, (float)p_192634_3_, 96.0F, (float)i, 32, 32, 256.0F, 256.0F);
                              if (j < 32) {
                              ...
                              Gui.drawModalRectWithCustomSizedTexture((float)p_192634_2_, (float)p_192634_3_, 64.0F, (float)i, 32, 32, 256.0F, 256.0F);
                              if (j < 32) {
                        ...
                        Gui.drawModalRectWithCustomSizedTexture((float)p_192634_2_, (float)p_192634_3_, 0.0F, (float)i, 32, 32, 256.0F, 256.0F);
                  }
            }
