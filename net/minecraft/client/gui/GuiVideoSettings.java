...
public class GuiVideoSettings extends GuiScreenOF {
      ...
      public void initGui() {
            ...
            this.buttonList.add(new GuiOptionButton(231, i1, i, Lang.get("of.options.shaders")));
            i1 = this.width / 2 - 155 + 160;
            this.buttonList.add(new GuiOptionButton(202, i1, i, Lang.get("of.options.quality")));
            i += 21;
            i1 = this.width / 2 - 155 + 0;
            this.buttonList.add(new GuiOptionButton(201, i1, i, Lang.get("of.options.details")));
            i1 = this.width / 2 - 155 + 160;
            this.buttonList.add(new GuiOptionButton(212, i1, i, Lang.get("of.options.performance")));
            i += 21;
            i1 = this.width / 2 - 155 + 0;
            this.buttonList.add(new GuiOptionButton(211, i1, i, Lang.get("of.options.animations")));
            i1 = this.width / 2 - 155 + 160;
            this.buttonList.add(new GuiOptionButton(222, i1, i, Lang.get("of.options.other")));
            i += 21;
