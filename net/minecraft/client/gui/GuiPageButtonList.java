...
public class GuiPageButtonList extends GuiListExtended {
      ...
      private void populateComponents() {
            GuiPageButtonList.GuiListEntry[][] var1 = this.pages;
            int var2 = var1.length;

            for(int var3 = 0; var3 < var2; ++var3) {
                  GuiPageButtonList.GuiListEntry[] aguipagebuttonlist$guilistentry = var1[var3];
      ...
      private void markVisibility(int p_178060_1_, int p_178060_2_) {
            GuiPageButtonList.GuiListEntry[] var3 = this.pages[p_178060_1_];
            int var4 = var3.length;

            int var5;
            GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry1;
            for(var5 = 0; var5 < var4; ++var5) {
                  guipagebuttonlist$guilistentry1 = var3[var5];
                  if (guipagebuttonlist$guilistentry1 != null) {
                        this.setComponentVisibility((Gui)this.componentMap.lookup(guipagebuttonlist$guilistentry1.getId()), false);
                  }
            }
      ...
      public void setActive(boolean p_181155_1_) {
            ...
            while(var2.hasNext()) {
                  GuiPageButtonList.GuiEntry guipagebuttonlist$guientry = (GuiPageButtonList.GuiEntry)var2.next();
      ...
      private GuiTextField createTextField(int p_178068_1_, int p_178068_2_, GuiPageButtonList.EditBoxEntry p_178068_3_) {
            int var10002 = p_178068_3_.getId();
            Minecraft var10003 = this.mc;
            GuiTextField guitextfield = new GuiTextField(var10002, Minecraft.fontRendererObj, p_178068_1_, p_178068_2_, 150, 20);
      ...
      private GuiLabel createLabel(int p_178063_1_, int p_178063_2_, GuiPageButtonList.GuiLabelEntry p_178063_3_, boolean p_178063_4_) {
            ...
            if (p_178063_4_) {
                  var10002 = this.mc;
                  guilabel = new GuiLabel(Minecraft.fontRendererObj, p_178063_3_.getId(), p_178063_1_, p_178063_2_, this.width - p_178063_1_ * 2, 20, -1);
            } else {
                  var10002 = this.mc;
                  guilabel = new GuiLabel(Minecraft.fontRendererObj, p_178063_3_.getId(), p_178063_1_, p_178063_2_, 150, 20, -1);
            }
      ...
      public static class GuiEntry implements GuiListExtended.IGuiListEntry {
            ...
            private void func_192635_a(GuiButton p_192635_1_, int p_192635_2_, int p_192635_3_, int p_192635_4_, boolean p_192635_5_, float p_192635_6_) {
                  ...
                  if (!p_192635_5_) {
                        p_192635_1_.func_191745_a(this.client, p_192635_3_, p_192635_4_, this.client.getRenderPartialTicks());
                  }
