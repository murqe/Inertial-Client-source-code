...
public class Gui {
      ...
      public static void drawRect(double x, double y, double d, double e, int color) {
            ...
            bufferbuilder.pos(x, e, 0.0D).endVertex();
            bufferbuilder.pos(d, e, 0.0D).endVertex();
            bufferbuilder.pos(d, y, 0.0D).endVertex();
      ...
      public static void drawModalRectWithCustomSizedTexture(float h, float g, float u, float v, int width, int height, float textureWidth, float textureHeight) {
            float f = 1.0F / textureWidth;
            float f1 = 1.0F / textureHeight;
            Tessellator tessellator = Tessellator.getInstance();
            BufferBuilder bufferbuilder = tessellator.getBuffer();
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
            bufferbuilder.pos((double)h, (double)(g + (float)height), 0.0D).tex((double)(u * f), (double)((v + (float)height) * f1)).endVertex();
            bufferbuilder.pos((double)(h + (float)width), (double)(g + (float)height), 0.0D).tex((double)((u + (float)width) * f), (double)((v + (float)height) * f1)).endVertex();
            bufferbuilder.pos((double)(h + (float)width), (double)g, 0.0D).tex((double)((u + (float)width) * f), (double)(v * f1)).endVertex();
            bufferbuilder.pos((double)h, (double)g, 0.0D).tex((double)(u * f), (double)(v * f1)).endVertex();
            tessellator.draw();
      }
