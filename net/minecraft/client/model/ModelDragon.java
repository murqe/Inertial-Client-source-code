...
public class ModelDragon extends ModelBase {
      ...
      public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
            ...
            this.jaw.rotateAngleX = (float)(Math.sin((double)(f * 6.2831855F)) + 1.0D) * 0.2F;
            ...
            for(int i = 0; i < 5; ++i) {
                  ...
                  this.spine.rotateAngleX = f11 + entitydragon.getHeadPartYOffset(i, adouble, adouble1) * 0.017453292F * 1.5F * 5.0F;
