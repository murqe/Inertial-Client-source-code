      ...
      private void trySpawnGolem(World worldIn, BlockPos pos) {
            ...
            if (blockpattern$patternhelper != null) {
                  for(j = 0; j < this.getSnowmanPattern().getThumbLength(); ++j) {
                        BlockWorldState blockworldstate = blockpattern$patternhelper.translateOffset(0, j, 0);
                  ...
                  var6 = worldIn.getEntitiesWithinAABB(EntityPlayerMP.class, entitysnowman.getEntityBoundingBox().expandXyz(5.0D)).iterator();

                  while(var6.hasNext()) {
                        entityplayermp1 = (EntityPlayerMP)var6.next();
                        CriteriaTriggers.field_192133_m.func_192229_a(entityplayermp1, entitysnowman);
                  }
                  ...
                  for(k1 = 0; k1 < this.getSnowmanPattern().getThumbLength(); ++k1) {
                        BlockWorldState blockworldstate2 = blockpattern$patternhelper.translateOffset(0, k1, 0);
                  ...
                  if (blockpattern$patternhelper != null) {
                        ...
                        var6 = worldIn.getEntitiesWithinAABB(EntityPlayerMP.class, entityirongolem.getEntityBoundingBox().expandXyz(5.0D)).iterator();
