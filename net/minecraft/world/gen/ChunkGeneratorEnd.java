            ...
            if (i > 4096L) {
                  ...
                  if (this.getIslandHeightValue(x, z, 1, 1) > 40.0F) {
                        ...
                        for(l1 = 0; l1 < j; ++l1) {
                              ...
                              k2 = this.worldObj.getHeight(blockpos.add(i2, 0, j2)).getY();
                              if (k2 > 0) {
                                    int k1 = k2 - 1;
                                    if (this.worldObj.isAirBlock(blockpos.add(i2, k1 + 1, j2)) && this.worldObj.getBlockState(blockpos.add(i2, k1, j2)).getBlock() == Blocks.END_STONE) {
                                          BlockChorusFlower.generatePlant(this.worldObj, blockpos.add(i2, k1 + 1, j2), this.rand, 8);
                                    }
                              }
                        }
                        ...
                        if (this.rand.nextInt(700) == 0) {
                              ...
                              i2 = this.rand.nextInt(16) + 8;
                              j2 = this.worldObj.getHeight(blockpos.add(l1, 0, i2)).getY();
                              if (j2 > 0) {
