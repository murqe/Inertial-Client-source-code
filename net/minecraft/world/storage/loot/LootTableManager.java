...
public class LootTableManager {
      ...
      public void reloadLootTables() {
            ...
            Iterator var1 = LootTableList.getAll().iterator();
                        ...
                        if (file1.exists()) {
                              if (file1.isFile()) {
                                    ...
                                    try {
                                          ...
                                          LootTableManager.LOGGER.warn("Couldn't load loot table {} from {}", resource, file1, var6);
                                          return LootTable.EMPTY_LOOT_TABLE;
                                    }
                                    ...
                                    try {
                                          ...
                                          LootTableManager.LOGGER.error("Couldn't load loot table {} from {}", resource, file1, var5);
                                          return LootTable.EMPTY_LOOT_TABLE;
                                    }
                              } else {
            ...
            private LootTable loadBuiltinLootTable(ResourceLocation resource) {
                  ...
                  if (url != null) {
                        ...
                        try {
                              ...
                              LootTableManager.LOGGER.warn("Couldn't load loot table {} from {}", resource, url, var6);
                              return LootTable.EMPTY_LOOT_TABLE;
                        }
                        ...
                        try {
                              ...
                              LootTableManager.LOGGER.error("Couldn't load loot table {} from {}", resource, url, var5);
                              return LootTable.EMPTY_LOOT_TABLE;
                        }
                  } else {
                        return null;
