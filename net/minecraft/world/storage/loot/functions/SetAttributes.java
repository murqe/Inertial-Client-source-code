...
public class SetAttributes extends LootFunction {
      ...
      public ItemStack apply(ItemStack stack, Random rand, LootContext context) {
            SetAttributes.Modifier[] var4 = this.modifiers;
            int var5 = var4.length;

            for(int var6 = 0; var6 < var5; ++var6) {
                  SetAttributes.Modifier setattributes$modifier = var4[var6];
      ...
      public static class Serializer extends LootFunction.Serializer {
            ...
            public void serialize(JsonObject object, SetAttributes functionClazz, JsonSerializationContext serializationContext) {
                  ...
                  SetAttributes.Modifier[] var5 = functionClazz.modifiers;
                  int var6 = var5.length;

                  for(int var7 = 0; var7 < var6; ++var7) {
                        SetAttributes.Modifier setattributes$modifier = var5[var7];
            ...
            public SetAttributes deserialize(JsonObject object, JsonDeserializationContext deserializationContext, LootCondition[] conditionsIn) {
                  ...
                  for(Iterator var7 = jsonarray.iterator(); var7.hasNext(); asetattributes$modifier[i++] = SetAttributes.Modifier.deserialize(JsonUtils.getJsonObject(jsonelement, "modifier"), deserializationContext)) {
