...
public class LootEntryItem extends LootEntry {
      ...
      public void addLoot(Collection stacks, Random rand, LootContext context) {
            ...
            LootFunction[] var5 = this.functions;
            int var6 = var5.length;

            for(int var7 = 0; var7 < var6; ++var7) {
                  LootFunction lootfunction = var5[var7];
      ...
      public static LootEntryItem deserialize(JsonObject object, JsonDeserializationContext deserializationContext, int weightIn, int qualityIn, LootCondition[] conditionsIn) {
            ...
            if (object.has("functions")) {
                  alootfunction = (LootFunction[])((LootFunction[])JsonUtils.deserializeClass(object, "functions", deserializationContext, LootFunction[].class));
            } else {
