...
public class MathHelper {
      ...
      public static float clamp_float(float p_clamp_float0, float p_clamp_float1, float p_clamp_float2) {
            if (p_clamp_float0 < p_clamp_float1) {
                  return p_clamp_float1;
            } else {
                  return p_clamp_float0 > p_clamp_float2 ? p_clamp_float2 : p_clamp_float0;
            }
      }
