...
public class ItemBoat extends Item {
      ...
      public ActionResult onItemRightClick(World itemStackIn, EntityPlayer worldIn, EnumHand playerIn) {
            ...
            if (raytraceresult == null) {
                  ...
                  boolean flag = false;
                  List list = itemStackIn.getEntitiesWithinAABBExcludingEntity(worldIn, worldIn.getEntityBoundingBox().addCoord(vec3d2.xCoord * 5.0D, vec3d2.yCoord * 5.0D, vec3d2.zCoord * 5.0D).expandXyz(1.0D));
