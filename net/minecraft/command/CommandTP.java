...
public class CommandTP extends CommandBase {
            ...
            if (args.length < 1) {
                  ...
                  if (args.length != 1 && args.length != 2) {
                        ...
                        if (((Entity)entity).world != null) {
                              ...
                              CommandBase.CoordinateArg commandbase$coordinatearg1 = parseCoordinate(((Entity)entity).posY, args[k++], -4096, 4096, false);
                              CommandBase.CoordinateArg commandbase$coordinatearg2 = parseCoordinate(((Entity)entity).posZ, args[k++], true);
                              CommandBase.CoordinateArg commandbase$coordinatearg3 = parseCoordinate((double)((Entity)entity).rotationYaw, args.length > k ? args[k++] : "~", false);
                              CommandBase.CoordinateArg commandbase$coordinatearg4 = parseCoordinate((double)((Entity)entity).rotationPitch, args.length > k ? args[k] : "~", false);
                              teleportEntityToCoordinates((Entity)entity, commandbase$coordinatearg, commandbase$coordinatearg1, commandbase$coordinatearg2, commandbase$coordinatearg3, commandbase$coordinatearg4);
                              notifyCommandListener(sender, this, "commands.tp.success.coordinates", new Object[]{((Entity)entity).getName(), commandbase$coordinatearg.getResult(), commandbase$coordinatearg1.getResult(), commandbase$coordinatearg2.getResult()});
                        }
                  } else {
                        Entity entity1 = getEntity(server, sender, args[args.length - 1]);
                        if (entity1.world != ((Entity)entity).world) {
                        ...
                        notifyCommandListener(sender, this, "commands.tp.success", new Object[]{((Entity)entity).getName(), entity1.getName()});
                  }
      ...
      private static void teleportEntityToCoordinates(Entity p_189863_0_, CommandBase.CoordinateArg p_189863_1_, CommandBase.CoordinateArg p_189863_2_, CommandBase.CoordinateArg p_189863_3_, CommandBase.CoordinateArg p_189863_4_, CommandBase.CoordinateArg p_189863_5_) {
            ...
            if (p_189863_0_ instanceof EntityPlayerMP) {
                  ...
                  f = (float)MathHelper.wrapDegrees(p_189863_5_.getResult());
                  f = MathHelper.clamp(f, -90.0F, 90.0F);
                  p_189863_0_.setLocationAndAngles(p_189863_1_.getResult(), p_189863_2_.getResult(), p_189863_3_.getResult(), f2, f);
