...
public class CommandSpreadPlayers extends CommandBase {
      ...
      public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
            if (args.length < 6) {
                  ...
                  int i = i + 1;
                  double d0 = parseDouble(var10000, args[i], true);
      ...
      private void spread(ICommandSender sender, List p_110669_2_, CommandSpreadPlayers.Position pos, double spreadDistance, double maxRange, World worldIn, boolean respectTeams) throws CommandException {
      ...
      private int getNumberOfTeams(List p_110667_1_) {
      ...
      private int spreadPositions(CommandSpreadPlayers.Position p_110668_1_, double p_110668_2_, World worldIn, Random random, double minX, double minZ, double maxX, double maxZ, CommandSpreadPlayers.Position[] p_110668_14_, boolean respectTeams) throws CommandException {
            ...
            for(i = 0; i < 10000 && flag; ++i) {
                  ...
                  int k;
                  CommandSpreadPlayers.Position commandspreadplayers$position3;
                  for(int j = 0; j < p_110668_14_.length; ++j) {
                        CommandSpreadPlayers.Position commandspreadplayers$position = p_110668_14_[j];
                        k = 0;
                        commandspreadplayers$position3 = new CommandSpreadPlayers.Position();
      ...
      private double setPlayerPositions(List p_110671_1_, World worldIn, CommandSpreadPlayers.Position[] p_110671_3_, boolean p_110671_4_) {
            double d0 = 0.0D;
            int i = 0;
            ...
            for(int j = 0; j < p_110671_1_.size(); ++j) {
                  ...
                  CommandSpreadPlayers.Position[] var14 = p_110671_3_;
                  int var15 = p_110671_3_.length;

                  for(int var16 = 0; var16 < var15; ++var16) {
                        CommandSpreadPlayers.Position commandspreadplayers$position1 = var14[var16];
      ...
      static class Position {
            ...
            public int getSpawnY(World worldIn) {
                  ...
                  } while(worldIn.getBlockState(blockpos).getMaterial() == Material.AIR);
