...
public class FunctionObject {
      ...
      public static FunctionObject func_193527_a(FunctionManager p_193527_0_, List p_193527_1_) {
            List list = Lists.newArrayListWithCapacity(p_193527_1_.size());
            Iterator var3 = p_193527_1_.iterator();
            ...
            return new FunctionObject((FunctionObject.Entry[])((FunctionObject.Entry[])list.toArray(new FunctionObject.Entry[list.size()])));
      }
      ...
      public static class FunctionEntry implements FunctionObject.Entry {
            ...
            public void func_194145_a(FunctionManager p_194145_1_, ICommandSender p_194145_2_, ArrayDeque p_194145_3_, int p_194145_4_) {
      ...
      public interface Entry {
            void func_194145_a(FunctionManager var1, ICommandSender var2, ArrayDeque var3, int var4);
      }
