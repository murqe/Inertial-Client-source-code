...
public class ServerCommandManager extends CommandHandler implements ICommandListener {
      ...
      public void notifyListener(ICommandSender sender, ICommand command, int flags, String translationKey, Object... translationArgs) {
            ...
            if (flag) {
                  Iterator var9 = minecraftserver.getPlayerList().getPlayerList().iterator();
                  ...
                  while(true) {
                        ...
                        do {
                              do {
                                    do {
                                          do {
                                                ...
                                                entityplayer = (EntityPlayer)var9.next();
                              ...
                              flag1 = sender instanceof MinecraftServer && this.server.shouldBroadcastConsoleToOps();
                              flag2 = sender instanceof RConConsoleSource && this.server.shouldBroadcastRconToOps();
                        } while(!flag1 && !flag2 && (sender instanceof RConConsoleSource || sender instanceof MinecraftServer));
