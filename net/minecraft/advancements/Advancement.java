...
public class Advancement {
      ...
      private final Map field_192080_e;
      private final String[][] field_192081_f;
      private final Set field_192082_g = Sets.newLinkedHashSet();
      private final ITextComponent field_193125_h;

      public Advancement(ResourceLocation p_i47472_1_, @Nullable Advancement p_i47472_2_, @Nullable DisplayInfo p_i47472_3_, AdvancementRewards p_i47472_4_, Map p_i47472_5_, String[][] p_i47472_6_) {
      ...
      public Iterable func_192069_e() {
            return this.field_192082_g;
      }

      public Map func_192073_f() {
      ...
      public static class Builder {
            ...
            private final Map field_192065_e;
            private final String[][] field_192066_f;

            Builder(@Nullable ResourceLocation p_i47414_1_, @Nullable DisplayInfo p_i47414_2_, AdvancementRewards p_i47414_3_, Map p_i47414_4_, String[][] p_i47414_5_) {
            ...
            public boolean func_192058_a(Function p_192058_1_) {
            ...
            public static Advancement.Builder func_192059_a(JsonObject p_192059_0_, JsonDeserializationContext p_192059_1_) {
                  ...
                  Map map = Criterion.func_192144_b(JsonUtils.getJsonObject(p_192059_0_, "criteria"), p_192059_1_);
                  if (map.isEmpty()) {
            ...
            public static Advancement.Builder func_192060_b(PacketBuffer p_192060_0_) throws IOException {
                  ...
                  Map map = Criterion.func_192142_c(p_192060_0_);
