...
public class FunctionManager implements ITickable {
      ...
      private final Map field_193070_d = Maps.newHashMap();
      private String field_193071_e = "-";
      private FunctionObject field_193072_f;
      private final ArrayDeque field_194020_g = new ArrayDeque();
      ...
      private void func_193061_h() {
            if (this.field_193068_b != null) {
                  ...
                  Iterator var1 = FileUtils.listFiles(this.field_193068_b, new String[]{"mcfunction"}, true).iterator();
                  ...
                  while(var1.hasNext()) {
                        ...
                        if (astring.length == 2) {
                              ...
                              try {
                                    ...
                                    field_193067_a.error("Couldn't read custom function " + resourcelocation + " from " + file1, var7);
                              }
                        }
                  }
      ...
      public static class QueuedCommand {
            ...
            public void func_194222_a(ArrayDeque p_194222_1_, int p_194222_2_) {
