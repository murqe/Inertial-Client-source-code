...
public class EntityHurtPlayerTrigger implements ICriterionTrigger {
      private static final ResourceLocation field_192201_a = new ResourceLocation("entity_hurt_player");
      private final Map field_192202_b = Maps.newHashMap();
      ...
      static class Listeners {
            ...
            private final Set field_192480_b = Sets.newHashSet();
            ...
            public void func_192477_a(ICriterionTrigger.Listener p_192477_1_) {
                  this.field_192480_b.add(p_192477_1_);
            }

            public void func_192475_b(ICriterionTrigger.Listener p_192475_1_) {
            ...
            public void func_192478_a(EntityPlayerMP p_192478_1_, DamageSource p_192478_2_, float p_192478_3_, float p_192478_4_, boolean p_192478_5_) {
                  ...
                  while(var7.hasNext()) {
                        ...
                        if (((EntityHurtPlayerTrigger.Instance)listener1.func_192158_a()).func_192263_a(p_192478_1_, p_192478_2_, p_192478_3_, p_192478_4_, p_192478_5_)) {
                              if (list == null) {
