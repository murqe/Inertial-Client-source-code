...
public class DamageSourcePredicate {
      ...
      public boolean func_193418_a(EntityPlayerMP p_193418_1_, DamageSource p_193418_2_) {
            if (this == field_192449_a) {
                  return true;
            } else if (this.field_192450_b != null && this.field_192450_b != p_193418_2_.isProjectile()) {
                  return false;
            } else if (this.field_192451_c != null && this.field_192451_c != p_193418_2_.isExplosion()) {
                  return false;
            } else if (this.field_192452_d != null && this.field_192452_d != p_193418_2_.isUnblockable()) {
                  return false;
            } else if (this.field_192453_e != null && this.field_192453_e != p_193418_2_.canHarmInCreative()) {
                  return false;
            } else if (this.field_192454_f != null && this.field_192454_f != p_193418_2_.isDamageAbsolute()) {
                  return false;
            } else if (this.field_192455_g != null && this.field_192455_g != p_193418_2_.isFireDamage()) {
                  return false;
            } else if (this.field_192456_h != null && this.field_192456_h != p_193418_2_.isMagicDamage()) {
                  return false;
            } else {
                  return !this.field_193419_i.func_192482_a(p_193418_1_, p_193418_2_.getSourceOfDamage()) ? false : this.field_193420_j.func_192482_a(p_193418_1_, p_193418_2_.getEntity());
            }
      }
