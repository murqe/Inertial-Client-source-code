...
public class PlayerHurtEntityTrigger implements ICriterionTrigger {
      private static final ResourceLocation field_192222_a = new ResourceLocation("player_hurt_entity");
      private final Map field_192223_b = Maps.newHashMap();
      ...
      static class Listeners {
            ...
            private final Set field_192524_b = Sets.newHashSet();
            ...
            public void func_192522_a(ICriterionTrigger.Listener p_192522_1_) {
                  this.field_192524_b.add(p_192522_1_);
            }

            public void func_192519_b(ICriterionTrigger.Listener p_192519_1_) {
            ...
            public void func_192521_a(EntityPlayerMP p_192521_1_, Entity p_192521_2_, DamageSource p_192521_3_, float p_192521_4_, float p_192521_5_, boolean p_192521_6_) {
                  ...
                  while(var8.hasNext()) {
                        ...
                        if (((PlayerHurtEntityTrigger.Instance)listener1.func_192158_a()).func_192278_a(p_192521_1_, p_192521_2_, p_192521_3_, p_192521_4_, p_192521_5_, p_192521_6_)) {
                              if (list == null) {
      ...
      public static class Instance extends AbstractCriterionInstance {
            ...
            public boolean func_192278_a(EntityPlayerMP p_192278_1_, Entity p_192278_2_, DamageSource p_192278_3_, float p_192278_4_, float p_192278_5_, boolean p_192278_6_) {
                  return !this.field_192279_a.func_192365_a(p_192278_1_, p_192278_3_, p_192278_4_, p_192278_5_, p_192278_6_) ? false : this.field_192280_b.func_192482_a(p_192278_1_, p_192278_2_);
            }
      }
}
